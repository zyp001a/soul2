...
ast2objx = &(ast Astx, def Objx, local Objx, global Objx, name Str)Objx{
 ...
 //TODO
  ...
  @return objInitx(ctrlreturnc, @Dicx{
   ctrlArg: arg
  })
 }@elif(t == "itemsget"){
