...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp25830 := _o;
  for _tmp25837 := uint(0); _tmp25837 < uint(len((*_tmp25830))); _tmp25837 ++ {
    _e = (*_tmp25830)[_tmp25837]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp26888 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp26888))); _i ++ {
    _x = (*_tmp26888)[_i]
    if(_i != 0 && _x != ""){
      _r += "\n"
      _r += __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp28827 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp28834 := uint(0); _tmp28834 < uint(len((*_tmp28827))); _tmp28834 ++ {
    _k = (*_tmp28827)[_tmp28834]
    if(_o._dic[_k] == nil){
  ...
  _tmp29309 := _c._arr;
  for _tmp29316 := uint(0); _tmp29316 < uint(len((*_tmp29309))); _tmp29316 ++ {
    _v = (*_tmp29309)[_tmp29316]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp29883 := _parentarr;
    for _tmp29890 := uint(0); _tmp29890 < uint(len((*_tmp29883))); _tmp29890 ++ {
      _e = (*_tmp29883)[_tmp29890]
      if(_e._id == ""){
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_Path_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp37337 := _arr;
    for _tmp37344 := uint(0); _tmp37344 < uint(len((*_tmp37337))); _tmp37344 ++ {
      _v = (*_tmp37337)[_tmp37344]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp39954 := _scope._arr;
  for _tmp39961 := uint(0); _tmp39961 < uint(len((*_tmp39954))); _tmp39961 ++ {
    _v = (*_tmp39954)[_tmp39961]
    _k = _v._id
    if(_cache[_k] != nil){
      continue
    }
...
func subMethodGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp41518 := _v._arr;
  for _tmp41525 := uint(0); _tmp41525 < uint(len((*_tmp41518))); _tmp41525 ++ {
    _vv = (*_tmp41518)[_tmp41525]
...
func methodGetx(_scope *Cptx, _func *Cptx) *Cptx{
  ...
  _p = _o._arr
  _tmp42102 := _p;
  for _tmp42109 := uint(0); _tmp42109 < uint(len((*_tmp42102))); _tmp42109 ++ {
    _v = (*_tmp42102)[_tmp42109]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp49606 := _types;
  for _tmp49613 := uint(0); _tmp49613 < uint(len((*_tmp49606))); _tmp49613 ++ {
    _v = (*_tmp49606)[_tmp49613]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp59269 := _argtypes;
  for _tmp59276 := uint(0); _tmp59276 < uint(len((*_tmp59269))); _tmp59276 ++ {
    _v = (*_tmp59269)[_tmp59276]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp63921 := _c._arr;
  for _tmp63928 := uint(0); _tmp63928 < uint(len((*_tmp63921))); _tmp63928 ++ {
    _v = (*_tmp63921)[_tmp63928]
...
func getParentx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp70864 := _o._arr;
  for _tmp70871 := uint(0); _tmp70871 < uint(len((*_tmp70864))); _tmp70871 ++ {
    _v = (*_tmp70864)[_tmp70871]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(len((*_a)) > 1){
    _s += "\n"
    _tmp77319 := _a;
    for _tmp77326 := uint(0); _tmp77326 < uint(len((*_tmp77319))); _tmp77326 ++ {
      _v = (*_tmp77319)[_tmp77326]
      _s += indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp77526 := _a;
    for _tmp77533 := uint(0); _tmp77533 < uint(len((*_tmp77526))); _tmp77533 ++ {
      _v = (*_tmp77526)[_tmp77533]
      _s += strx(_v, _i + 1)
    }
  }
  return _s + "]"
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp77857 := _d;
  for _tmp77864 := uint(0); _tmp77864 < uint(len((*_tmp77857))); _tmp77864 ++ {
    _v = (*_tmp77857)[_tmp77864]
    if(_v._name != ""){
      _s += _v._name + " "
    }else{
      _s += "~" + _v._id + " "
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _nstate._int = 2
  _tmp81142 := _args;
  for _i = uint(0); _i < uint(len((*_tmp81142))); _i ++ {
    _v = (*_tmp81142)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp83138 := _args;
    for _i = uint(0); _i < uint(len((*_tmp83138))); _i ++ {
      _arg = (*_tmp83138)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp85091 := _c._arr;
    for _tmp85098 := uint(0); _tmp85098 < uint(len((*_tmp85091))); _tmp85098 ++ {
      _v = (*_tmp85091)[_tmp85098]
      if(_cache[_v._id] != nil){
        return nil
      }
      _cache[_v._id] = 1
...
func blockExecx(_o *Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _b = _o._dic["blockVal"]
  _tmp86412 := _b._arr;
  for _i = uint(0); _i < uint(len((*_tmp86412))); _i ++ {
    _v = (*_tmp86412)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp91276 := _args;
  for _tmp91283 := uint(0); _tmp91283 < uint(len(_tmp91276)); _tmp91283 ++ {
    _arg = _tmp91276[_tmp91283]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp94585 := _parents;
    for _tmp94592 := uint(0); _tmp94592 < uint(len(_tmp94585)); _tmp94592 ++ {
      _e = _tmp94585[_tmp94592]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp98546 := _arr;
  for _i = uint(0); _i < uint(len(_tmp98546)); _i ++ {
    _v = _tmp98546[_i]
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp123421 := _ast;
  for _i = uint(0); _i < uint(len(_tmp123421)); _i ++ {
    _e = _tmp123421[_i]
    _ee = _e.([]interface{})
  ...
  _tmp123762 := _ast;
  for _i = uint(0); _i < uint(len(_tmp123762)); _i ++ {
    _e = _tmp123762[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp124628 := _ast;
  for _tmp124635 := uint(0); _tmp124635 < uint(len(_tmp124628)); _tmp124635 ++ {
    _e = _tmp124628[_tmp124635]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp126331 := _asts;
  for _tmp126338 := uint(0); _tmp126338 < uint(len(_tmp126331)); _tmp126338 ++ {
    _e = _tmp126331[_tmp126338]
  ...
  if(!_callable){
    _tmp126742 := _arrx;
    for _i = uint(0); _i < uint(len((*_tmp126742))); _i ++ {
      _v = (*_tmp126742)[_i]
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp127705 := _asts;
  for _tmp127712 := uint(0); _tmp127712 < uint(len(_tmp127705)); _tmp127712 ++ {
    _eo = _tmp127705[_tmp127712]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp136589 := _o._arr;
  for _tmp136596 := uint(0); _tmp136596 < uint(len((*_tmp136589))); _tmp136596 ++ {
    _k = (*_tmp136589)[_tmp136596]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp179280 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp179280))); _i ++ {
      _argdef = (*_tmp179280)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp179660 := _args;
    for _tmp179667 := uint(0); _tmp179667 < uint(len((*_tmp179660))); _tmp179667 ++ {
      _arg = (*_tmp179660)[_tmp179667]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp180300 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp180300))); _i ++ {
      _argdef = (*_tmp180300)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp180644 := _args;
    for _tmp180651 := uint(0); _tmp180651 < uint(len((*_tmp180644))); _tmp180651 ++ {
      _arg = (*_tmp180644)[_tmp180651]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func main(){
  ...
  funcDefx(_defmain, "osArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp138063 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp138063))); _i ++ {
        _v = (*_tmp138063)[_i]
        if(_i == 0){
          continue
        }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp157147 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp157154 := uint(0); _tmp157154 < uint(len((*_tmp157147))); _tmp157154 ++ {
      _k = (*_tmp157147)[_tmp157154]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp157659 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp157666 := uint(0); _tmp157666 < uint(len((*_tmp157659))); _tmp157666 ++ {
      _k = (*_tmp157659)[_tmp157666]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
    return dicNewx(_dicc, _o._dic, _arrx)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp159153 := _xx;
    for _tmp159160 := uint(0); _tmp159160 < uint(len((*_tmp159153))); _tmp159160 ++ {
      _v = (*_tmp159153)[_tmp159160]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp164901 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp164901))); _i ++ {
      _v = (*_tmp164901)[_i]
      if(_i != 0){
        _s += _sep._str
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp184245 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp184245))); _i ++ {
        _v = (*_tmp184245)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp187896 := _da._arr;
      for _tmp187903 := uint(0); _tmp187903 < uint(len((*_tmp187896))); _tmp187903 ++ {
        _kc = (*_tmp187896)[_tmp187903]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
      ...
      _tmp188731 := _da._arr;
      for _i = uint(0); _i < uint(len((*_tmp188731))); _i ++ {
        _v = (*_tmp188731)[_i]
        if(_key != ""){
