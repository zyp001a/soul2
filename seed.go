...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp44672 := _o;
  for _tmp44675 := uint(0); _tmp44675 < uint(len((*_tmp44672))); _tmp44675 ++ {
    _e = (*_tmp44672)[_tmp44675]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp45217 := _o;
  for _i = uint(0); _i < uint(len(_tmp45217)); _i ++ {
    _e = _tmp45217[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp46149 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp46149))); _i ++ {
    _x = (*_tmp46149)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp47214 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp47217 := uint(0); _tmp47217 < uint(len(_tmp47214)); _tmp47217 ++ {
    _k = _tmp47214[_tmp47217]
    if(_o._dic[_k] == nil){
  ...
  _tmp47720 := _c._arr;
  for _tmp47723 := uint(0); _tmp47723 < uint(len((*_tmp47720))); _tmp47723 ++ {
    _v = (*_tmp47720)[_tmp47723]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp48327 := _parentarr;
    for _tmp48330 := uint(0); _tmp48330 < uint(len((*_tmp48327))); _tmp48330 ++ {
      _e = (*_tmp48327)[_tmp48330]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp52213 := _o._arr;
  for _tmp52216 := uint(0); _tmp52216 < uint(len((*_tmp52213))); _tmp52216 ++ {
    _k = (*_tmp52213)[_tmp52216]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(inClassx(classx(_f), _funcvarsc, nil)){
    ...
    _tmp53091 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp53091))); _i ++ {
      _argdef = (*_tmp53091)[_i]
    ...
    _tmp53494 := _args;
    for _tmp53497 := uint(0); _tmp53497 < uint(len((*_tmp53494))); _tmp53497 ++ {
      _arg = (*_tmp53494)[_tmp53497]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp61426 := _argtypes;
  for _tmp61429 := uint(0); _tmp61429 < uint(len((*_tmp61426))); _tmp61429 ++ {
    _v = (*_tmp61426)[_tmp61429]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp63662 := _x._arr;
  for _tmp63665 := uint(0); _tmp63665 < uint(len((*_tmp63662))); _tmp63665 ++ {
    _v = (*_tmp63662)[_tmp63665]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp64828 := _c._arr;
  for _tmp64831 := uint(0); _tmp64831 < uint(len((*_tmp64828))); _tmp64831 ++ {
    _v = (*_tmp64828)[_tmp64831]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp66996 := _types;
  for _tmp66999 := uint(0); _tmp66999 < uint(len((*_tmp66996))); _tmp66999 ++ {
    _v = (*_tmp66996)[_tmp66999]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp70557 := _arr;
    for _tmp70560 := uint(0); _tmp70560 < uint(len((*_tmp70557))); _tmp70560 ++ {
      _v = (*_tmp70557)[_tmp70560]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp73890 := _scope._arr;
  for _tmp73893 := uint(0); _tmp73893 < uint(len((*_tmp73890))); _tmp73893 ++ {
    _v = (*_tmp73890)[_tmp73893]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp75854 := _v._arr;
  for _tmp75857 := uint(0); _tmp75857 < uint(len((*_tmp75854))); _tmp75857 ++ {
    _vv = (*_tmp75854)[_tmp75857]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp76942 := _p;
  for _tmp76945 := uint(0); _tmp76945 < uint(len((*_tmp76942))); _tmp76945 ++ {
    _v = (*_tmp76942)[_tmp76945]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp79736 := _c._arr;
  for _tmp79739 := uint(0); _tmp79739 < uint(len((*_tmp79736))); _tmp79739 ++ {
    _v = (*_tmp79736)[_tmp79739]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp80459 := _o._arr;
  for _tmp80462 := uint(0); _tmp80462 < uint(len((*_tmp80459))); _tmp80462 ++ {
    _v = (*_tmp80459)[_tmp80462]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp98580 := _a;
    for _tmp98583 := uint(0); _tmp98583 < uint(len((*_tmp98580))); _tmp98583 ++ {
      _v = (*_tmp98580)[_tmp98583]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp98815 := _a;
    for _tmp98818 := uint(0); _tmp98818 < uint(len((*_tmp98815))); _tmp98818 ++ {
      _v = (*_tmp98815)[_tmp98818]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp99140 := _d;
  for _tmp99143 := uint(0); _tmp99143 < uint(len((*_tmp99140))); _tmp99143 ++ {
    _v = (*_tmp99140)[_tmp99143]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp109308 := _c._arr;
    for _tmp109311 := uint(0); _tmp109311 < uint(len((*_tmp109308))); _tmp109311 ++ {
      _v = (*_tmp109308)[_tmp109311]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp110998 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp110998))); _i ++ {
    _v = (*_tmp110998)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp117949 := _env._dic["envStack"]._arr;
  for _tmp117952 := uint(0); _tmp117952 < uint(len((*_tmp117949))); _tmp117952 ++ {
    _v = (*_tmp117949)[_tmp117952]
...
func id2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    ...
    if(_varts != nil){
      _tmp119223 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp119223))); _i ++ {
        _stro = (*_tmp119223)[_i]
        if(_id == _stro._str){
...
func idlocal2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    _varts = getx(_func, "funcVars")
    if(_varts != nil){
      _tmp122142 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp122142))); _i ++ {
        _stro = (*_tmp122142)[_i]
        if(_id == _stro._str){
          _r = idNewx(_local, _stro._str, _idargc)
          _r._int = int(_i)
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp125132 := _args;
  for _tmp125135 := uint(0); _tmp125135 < uint(len(_tmp125132)); _tmp125135 ++ {
    _arg = _tmp125132[_tmp125135]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    _arr = &[]*Cptx{}
    _tmp130951 := _parents;
    for _tmp130954 := uint(0); _tmp130954 < uint(len(_tmp130951)); _tmp130954 ++ {
      _e = _tmp130951[_tmp130954]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp135310 := _arr;
  for _i = uint(0); _i < uint(len(_tmp135310)); _i ++ {
    _v = _tmp135310[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _tmp162565 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp162565)); _i ++ {
    _e = _tmp162565[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp164478 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp164478)); _i ++ {
    _e = _tmp164478[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp165551 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165551)); _i ++ {
    _e = _tmp165551[_i]
    _ee = _e.([]interface{})
  ...
  _tmp165936 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165936)); _i ++ {
    _e = _tmp165936[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp166321 := _ast;
  for _i = uint(0); _i < uint(len(_tmp166321)); _i ++ {
    _e = _tmp166321[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp167254 := _ast;
  for _tmp167257 := uint(0); _tmp167257 < uint(len(_tmp167254)); _tmp167257 ++ {
    _e = _tmp167254[_tmp167257]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp169445 := _asts;
  for _i = uint(0); _i < uint(len(_tmp169445)); _i ++ {
    _e = _tmp169445[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp169899 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp169899)); _i ++ {
      _v = _tmp169899[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp170944 := _asts;
  for _tmp170947 := uint(0); _tmp170947 < uint(len(_tmp170944)); _tmp170947 ++ {
    _eo = _tmp170944[_tmp170947]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp172552 := _asts;
  for _tmp172555 := uint(0); _tmp172555 < uint(len(_tmp172552)); _tmp172555 ++ {
    _eo = _tmp172552[_tmp172555]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func main(){
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp206777 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp206780 := uint(0); _tmp206780 < uint(len(_tmp206777)); _tmp206780 ++ {
      _k = _tmp206777[_tmp206780]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp208194 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp208197 := uint(0); _tmp208197 < uint(len(_tmp208194)); _tmp208197 ++ {
      _k = _tmp208194[_tmp208197]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp214782 := _xx;
    for _tmp214785 := uint(0); _tmp214785 < uint(len((*_tmp214782))); _tmp214785 ++ {
      _v = (*_tmp214782)[_tmp214785]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp222257 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp222257))); _i ++ {
      _v = (*_tmp222257)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp239052 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp239052))); _i ++ {
        _v = (*_tmp239052)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp241116 := _c._arr;
    for _tmp241119 := uint(0); _tmp241119 < uint(len((*_tmp241116))); _tmp241119 ++ {
      _v = (*_tmp241116)[_tmp241119]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp243828 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp243828))); _i ++ {
        _v = (*_tmp243828)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp248761 := _da._arr;
      for _tmp248764 := uint(0); _tmp248764 < uint(len((*_tmp248761))); _tmp248764 ++ {
        _kc = (*_tmp248761)[_tmp248764]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
