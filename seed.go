...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp38634 := _o;
  for _tmp38637 := uint(0); _tmp38637 < uint(len((*_tmp38634))); _tmp38637 ++ {
    _e = (*_tmp38634)[_tmp38637]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp39115 := _o;
  for _i = uint(0); _i < uint(len(_tmp39115)); _i ++ {
    _e = _tmp39115[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp39884 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp39884))); _i ++ {
    _x = (*_tmp39884)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp40770 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp40773 := uint(0); _tmp40773 < uint(len(_tmp40770)); _tmp40773 ++ {
    _k = _tmp40770[_tmp40773]
    if(_o._dic[_k] == nil){
  ...
  _tmp41211 := _c._arr;
  for _tmp41214 := uint(0); _tmp41214 < uint(len((*_tmp41211))); _tmp41214 ++ {
    _v = (*_tmp41211)[_tmp41214]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp41718 := _parentarr;
    for _tmp41721 := uint(0); _tmp41721 < uint(len((*_tmp41718))); _tmp41721 ++ {
      _e = (*_tmp41718)[_tmp41721]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp44054 := _o._arr;
  for _tmp44057 := uint(0); _tmp44057 < uint(len((*_tmp44054))); _tmp44057 ++ {
    _k = (*_tmp44054)[_tmp44057]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp44806 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp44806))); _i ++ {
      _argdef = (*_tmp44806)[_i]
    ...
    _tmp45155 := _args;
    for _tmp45158 := uint(0); _tmp45158 < uint(len((*_tmp45155))); _tmp45158 ++ {
      _arg = (*_tmp45155)[_tmp45158]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp45705 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp45705))); _i ++ {
      _argdef = (*_tmp45705)[_i]
      if(_i < uint(len((*_args)))){
    ...
    _tmp45997 := _args;
    for _tmp46000 := uint(0); _tmp46000 < uint(len((*_tmp45997))); _tmp46000 ++ {
      _arg = (*_tmp45997)[_tmp46000]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp52605 := _argtypes;
  for _tmp52608 := uint(0); _tmp52608 < uint(len((*_tmp52605))); _tmp52608 ++ {
    _v = (*_tmp52605)[_tmp52608]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp54502 := _x._arr;
  for _tmp54505 := uint(0); _tmp54505 < uint(len((*_tmp54502))); _tmp54505 ++ {
    _v = (*_tmp54502)[_tmp54505]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp55476 := _c._arr;
  for _tmp55479 := uint(0); _tmp55479 < uint(len((*_tmp55476))); _tmp55479 ++ {
    _v = (*_tmp55476)[_tmp55479]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp57261 := _types;
  for _tmp57264 := uint(0); _tmp57264 < uint(len((*_tmp57261))); _tmp57264 ++ {
    _v = (*_tmp57261)[_tmp57264]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp60335 := _arr;
    for _tmp60338 := uint(0); _tmp60338 < uint(len((*_tmp60335))); _tmp60338 ++ {
      _v = (*_tmp60335)[_tmp60338]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp63065 := _scope._arr;
  for _tmp63068 := uint(0); _tmp63068 < uint(len((*_tmp63065))); _tmp63068 ++ {
    _v = (*_tmp63065)[_tmp63068]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp64732 := _v._arr;
  for _tmp64735 := uint(0); _tmp64735 < uint(len((*_tmp64732))); _tmp64735 ++ {
    _vv = (*_tmp64732)[_tmp64735]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp65661 := _p;
  for _tmp65664 := uint(0); _tmp65664 < uint(len((*_tmp65661))); _tmp65664 ++ {
    _v = (*_tmp65661)[_tmp65664]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp68042 := _c._arr;
  for _tmp68045 := uint(0); _tmp68045 < uint(len((*_tmp68042))); _tmp68045 ++ {
    _v = (*_tmp68042)[_tmp68045]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp68652 := _o._arr;
  for _tmp68655 := uint(0); _tmp68655 < uint(len((*_tmp68652))); _tmp68655 ++ {
    _v = (*_tmp68652)[_tmp68655]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp83483 := _a;
    for _tmp83486 := uint(0); _tmp83486 < uint(len((*_tmp83483))); _tmp83486 ++ {
      _v = (*_tmp83483)[_tmp83486]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp83686 := _a;
    for _tmp83689 := uint(0); _tmp83689 < uint(len((*_tmp83686))); _tmp83689 ++ {
      _v = (*_tmp83686)[_tmp83689]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp83956 := _d;
  for _tmp83959 := uint(0); _tmp83959 < uint(len((*_tmp83956))); _tmp83959 ++ {
    _v = (*_tmp83956)[_tmp83959]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _tmp87259 := _args;
  for _i = uint(0); _i < uint(len((*_tmp87259))); _i ++ {
    _v = (*_tmp87259)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp90020 := _args;
    for _i = uint(0); _i < uint(len((*_tmp90020))); _i ++ {
      _arg = (*_tmp90020)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp91917 := _c._arr;
    for _tmp91920 := uint(0); _tmp91920 < uint(len((*_tmp91917))); _tmp91920 ++ {
      _v = (*_tmp91917)[_tmp91920]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp93350 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp93350))); _i ++ {
    _v = (*_tmp93350)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp99249 := _env._dic["envStack"]._arr;
  for _tmp99252 := uint(0); _tmp99252 < uint(len((*_tmp99249))); _tmp99252 ++ {
    _v = (*_tmp99249)[_tmp99252]
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp102169 := _args;
  for _tmp102172 := uint(0); _tmp102172 < uint(len(_tmp102169)); _tmp102172 ++ {
    _arg = _tmp102169[_tmp102172]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp105710 := _parents;
    for _tmp105713 := uint(0); _tmp105713 < uint(len(_tmp105710)); _tmp105713 ++ {
      _e = _tmp105710[_tmp105713]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp109395 := _arr;
  for _i = uint(0); _i < uint(len(_tmp109395)); _i ++ {
    _v = _tmp109395[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp131718 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp131718)); _i ++ {
    _e = _tmp131718[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp133324 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp133324)); _i ++ {
    _e = _tmp133324[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp134229 := _ast;
  for _i = uint(0); _i < uint(len(_tmp134229)); _i ++ {
    _e = _tmp134229[_i]
    _ee = _e.([]interface{})
  ...
  _tmp134553 := _ast;
  for _i = uint(0); _i < uint(len(_tmp134553)); _i ++ {
    _e = _tmp134553[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp134877 := _ast;
  for _i = uint(0); _i < uint(len(_tmp134877)); _i ++ {
    _e = _tmp134877[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp135665 := _ast;
  for _tmp135668 := uint(0); _tmp135668 < uint(len(_tmp135665)); _tmp135668 ++ {
    _e = _tmp135665[_tmp135668]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp137507 := _asts;
  for _i = uint(0); _i < uint(len(_tmp137507)); _i ++ {
    _e = _tmp137507[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp137893 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp137893)); _i ++ {
      _v = _tmp137893[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp138780 := _asts;
  for _tmp138783 := uint(0); _tmp138783 < uint(len(_tmp138780)); _tmp138783 ++ {
    _eo = _tmp138780[_tmp138783]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp140136 := _asts;
  for _tmp140139 := uint(0); _tmp140139 < uint(len(_tmp140136)); _tmp140139 ++ {
    _eo = _tmp140136[_tmp140139]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func main(){
  ...
  _handlerc = classDefx(_defmain, "Handler", &[]*Cptx{_funcc}, map[string]*Cptx{
    "funcAst": _jsonarrc,
    "funcBlock": _blockc,
  })
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp169336 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp169339 := uint(0); _tmp169339 < uint(len(_tmp169336)); _tmp169339 ++ {
      _k = _tmp169336[_tmp169339]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp170513 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp170516 := uint(0); _tmp170516 < uint(len(_tmp170513)); _tmp170516 ++ {
      _k = _tmp170513[_tmp170516]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp176018 := _xx;
    for _tmp176021 := uint(0); _tmp176021 < uint(len((*_tmp176018))); _tmp176021 ++ {
      _v = (*_tmp176018)[_tmp176021]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp181981 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp181981))); _i ++ {
      _v = (*_tmp181981)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp194106 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp194106))); _i ++ {
        _v = (*_tmp194106)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp195837 := _c._arr;
    for _tmp195840 := uint(0); _tmp195840 < uint(len((*_tmp195837))); _tmp195840 ++ {
      _v = (*_tmp195837)[_tmp195840]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp198519 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp198519))); _i ++ {
        _v = (*_tmp198519)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp202658 := _da._arr;
      for _tmp202661 := uint(0); _tmp202661 < uint(len((*_tmp202658))); _tmp202661 ++ {
        _kc = (*_tmp202658)[_tmp202661]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
