...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp47906 := _o;
  for _tmp47907 := uint(0); _tmp47907 < uint(len((*_tmp47906))); _tmp47907 ++ {
    _e = (*_tmp47906)[_tmp47907]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp57982 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp57982))); _i ++ {
    _x = (*_tmp57982)[_i]
    if(_i != 0 && _x != ""){
      _r += "\n"
      _r += __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp75173 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp75174 := uint(0); _tmp75174 < uint(len((*_tmp75173))); _tmp75174 ++ {
    _k = (*_tmp75173)[_tmp75174]
    if(_o._dic[_k] == nil){
  ...
  _tmp80170 := _c._arr;
  for _tmp80171 := uint(0); _tmp80171 < uint(len((*_tmp80170))); _tmp80171 ++ {
    _v = (*_tmp80170)[_tmp80171]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp88024 := _parentarr;
    for _tmp88025 := uint(0); _tmp88025 < uint(len((*_tmp88024))); _tmp88025 ++ {
      _e = (*_tmp88024)[_tmp88025]
      if(_e._id == ""){
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_Path_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp171112 := _arr;
    for _tmp171113 := uint(0); _tmp171113 < uint(len((*_tmp171112))); _tmp171113 ++ {
      _v = (*_tmp171112)[_tmp171113]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp204696 := _scope._arr;
  for _tmp204697 := uint(0); _tmp204697 < uint(len((*_tmp204696))); _tmp204697 ++ {
    _v = (*_tmp204696)[_tmp204697]
    _k = _v._id
    if(_cache[_k] != nil){
      continue
    }
...
func subMethodGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp225612 := _v._arr;
  for _tmp225613 := uint(0); _tmp225613 < uint(len((*_tmp225612))); _tmp225613 ++ {
    _vv = (*_tmp225612)[_tmp225613]
...
func methodGetx(_scope *Cptx, _func *Cptx) *Cptx{
  ...
  _p = _o._arr
  _tmp233242 := _p;
  for _tmp233243 := uint(0); _tmp233243 < uint(len((*_tmp233242))); _tmp233243 ++ {
    _v = (*_tmp233242)[_tmp233243]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp330112 := _types;
  for _tmp330113 := uint(0); _tmp330113 < uint(len((*_tmp330112))); _tmp330113 ++ {
    _v = (*_tmp330112)[_tmp330113]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp464987 := _argtypes;
  for _tmp464988 := uint(0); _tmp464988 < uint(len((*_tmp464987))); _tmp464988 ++ {
    _v = (*_tmp464987)[_tmp464988]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp522310 := _c._arr;
  for _tmp522311 := uint(0); _tmp522311 < uint(len((*_tmp522310))); _tmp522311 ++ {
    _v = (*_tmp522310)[_tmp522311]
...
func getParentx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp605364 := _o._arr;
  for _tmp605365 := uint(0); _tmp605365 < uint(len((*_tmp605364))); _tmp605365 ++ {
    _v = (*_tmp605364)[_tmp605365]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(len((*_a)) > 1){
    _s += "\n"
    _tmp687035 := _a;
    for _tmp687036 := uint(0); _tmp687036 < uint(len((*_tmp687035))); _tmp687036 ++ {
      _v = (*_tmp687035)[_tmp687036]
      _s += indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp689305 := _a;
    for _tmp689306 := uint(0); _tmp689306 < uint(len((*_tmp689305))); _tmp689306 ++ {
      _v = (*_tmp689305)[_tmp689306]
      _s += strx(_v, _i + 1)
    }
  }
  return _s + "]"
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp693889 := _d;
  for _tmp693890 := uint(0); _tmp693890 < uint(len((*_tmp693889))); _tmp693890 ++ {
    _v = (*_tmp693889)[_tmp693890]
    if(_v._name != ""){
      _s += _v._name + " "
    }else{
      _s += "~" + _v._id + " "
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _tmp736556 := _args;
  for _i = uint(0); _i < uint(len((*_tmp736556))); _i ++ {
    _v = (*_tmp736556)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp765579 := _args;
    for _i = uint(0); _i < uint(len((*_tmp765579))); _i ++ {
      _arg = (*_tmp765579)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp791661 := _c._arr;
    for _tmp791662 := uint(0); _tmp791662 < uint(len((*_tmp791661))); _tmp791662 ++ {
      _v = (*_tmp791661)[_tmp791662]
      if(_cache[_v._id] != nil){
        return nil
      }
      _cache[_v._id] = 1
...
func blockExecx(_o *Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _b = _o._dic["blockVal"]
  _tmp809130 := _b._arr;
  for _i = uint(0); _i < uint(len((*_tmp809130))); _i ++ {
    _v = (*_tmp809130)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp877078 := _args;
  for _tmp877079 := uint(0); _tmp877079 < uint(len(_tmp877078)); _tmp877079 ++ {
    _arg = _tmp877078[_tmp877079]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp926886 := _parents;
    for _tmp926887 := uint(0); _tmp926887 < uint(len(_tmp926886)); _tmp926887 ++ {
      _e = _tmp926886[_tmp926887]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp980693 := _arr;
  for _i = uint(0); _i < uint(len(_tmp980693)); _i ++ {
    _v = _tmp980693[_i]
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp1329680 := _ast;
  for _i = uint(0); _i < uint(len(_tmp1329680)); _i ++ {
    _e = _tmp1329680[_i]
    _ee = _e.([]interface{})
  ...
  _tmp1335071 := _ast;
  for _i = uint(0); _i < uint(len(_tmp1335071)); _i ++ {
    _e = _tmp1335071[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _i = 0
  _tmp1347696 := _ast;
  for _tmp1347697 := uint(0); _tmp1347697 < uint(len(_tmp1347696)); _tmp1347697 ++ {
    _e = _tmp1347696[_tmp1347697]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp1374270 := _asts;
  for _tmp1374271 := uint(0); _tmp1374271 < uint(len(_tmp1374270)); _tmp1374271 ++ {
    _e = _tmp1374270[_tmp1374271]
  ...
  if(!_callable){
    _tmp1379298 := _arrx;
    for _i = uint(0); _i < uint(len((*_tmp1379298))); _i ++ {
      _v = (*_tmp1379298)[_i]
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp1393012 := _asts;
  for _tmp1393013 := uint(0); _tmp1393013 < uint(len(_tmp1393012)); _tmp1393013 ++ {
    _eo = _tmp1393012[_tmp1393013]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp1502591 := _o._arr;
  for _tmp1502592 := uint(0); _tmp1502592 < uint(len((*_tmp1502591))); _tmp1502592 ++ {
    _k = (*_tmp1502591)[_tmp1502592]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp2141516 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp2141516))); _i ++ {
      _argdef = (*_tmp2141516)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp2146064 := _args;
    for _tmp2146065 := uint(0); _tmp2146065 < uint(len((*_tmp2146064))); _tmp2146065 ++ {
      _arg = (*_tmp2146064)[_tmp2146065]
...
func main(){
  ...
  funcDefx(_defmain, "osArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp1523754 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp1523754))); _i ++ {
        _v = (*_tmp1523754)[_i]
        if(_i == 0){
          continue
        }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp1801352 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp1801353 := uint(0); _tmp1801353 < uint(len((*_tmp1801352))); _tmp1801353 ++ {
      _k = (*_tmp1801352)[_tmp1801353]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp1808982 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp1808983 := uint(0); _tmp1808983 < uint(len((*_tmp1808982))); _tmp1808983 ++ {
      _k = (*_tmp1808982)[_tmp1808983]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
    return dicNewx(_dicc, _o._dic, _arrx)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp1831928 := _xx;
    for _tmp1831929 := uint(0); _tmp1831929 < uint(len((*_tmp1831928))); _tmp1831929 ++ {
      _v = (*_tmp1831928)[_tmp1831929]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp1918026 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp1918026))); _i ++ {
      _v = (*_tmp1918026)[_i]
      if(_i != 0){
        _s += _sep._str
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp2188310 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp2188310))); _i ++ {
        _v = (*_tmp2188310)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp2239443 := _da._arr;
      for _tmp2239444 := uint(0); _tmp2239444 < uint(len((*_tmp2239443))); _tmp2239444 ++ {
        _kc = (*_tmp2239443)[_tmp2239444]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
      ...
      _tmp2249425 := _da._arr;
      for _i = uint(0); _i < uint(len((*_tmp2249425))); _i ++ {
        _v = (*_tmp2249425)[_i]
        if(_key != ""){
