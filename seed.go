...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp44412 := _o;
  for _tmp44415 := uint(0); _tmp44415 < uint(len((*_tmp44412))); _tmp44415 ++ {
    _e = (*_tmp44412)[_tmp44415]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp44960 := _o;
  for _i = uint(0); _i < uint(len(_tmp44960)); _i ++ {
    _e = _tmp44960[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp45893 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp45893))); _i ++ {
    _x = (*_tmp45893)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp46958 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp46961 := uint(0); _tmp46961 < uint(len(_tmp46958)); _tmp46961 ++ {
    _k = _tmp46958[_tmp46961]
    if(_o._dic[_k] == nil){
  ...
  _tmp47465 := _c._arr;
  for _tmp47468 := uint(0); _tmp47468 < uint(len((*_tmp47465))); _tmp47468 ++ {
    _v = (*_tmp47465)[_tmp47468]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp48072 := _parentarr;
    for _tmp48075 := uint(0); _tmp48075 < uint(len((*_tmp48072))); _tmp48075 ++ {
      _e = (*_tmp48072)[_tmp48075]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp51959 := _o._arr;
  for _tmp51962 := uint(0); _tmp51962 < uint(len((*_tmp51959))); _tmp51962 ++ {
    _k = (*_tmp51959)[_tmp51962]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(inClassx(classx(_f), _funcvarsc, nil)){
    ...
    _tmp52837 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp52837))); _i ++ {
      _argdef = (*_tmp52837)[_i]
    ...
    _tmp53240 := _args;
    for _tmp53243 := uint(0); _tmp53243 < uint(len((*_tmp53240))); _tmp53243 ++ {
      _arg = (*_tmp53240)[_tmp53243]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp61028 := _argtypes;
  for _tmp61031 := uint(0); _tmp61031 < uint(len((*_tmp61028))); _tmp61031 ++ {
    _v = (*_tmp61028)[_tmp61031]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp63264 := _x._arr;
  for _tmp63267 := uint(0); _tmp63267 < uint(len((*_tmp63264))); _tmp63267 ++ {
    _v = (*_tmp63264)[_tmp63267]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp64430 := _c._arr;
  for _tmp64433 := uint(0); _tmp64433 < uint(len((*_tmp64430))); _tmp64433 ++ {
    _v = (*_tmp64430)[_tmp64433]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp66538 := _types;
  for _tmp66541 := uint(0); _tmp66541 < uint(len((*_tmp66538))); _tmp66541 ++ {
    _v = (*_tmp66538)[_tmp66541]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp70104 := _arr;
    for _tmp70107 := uint(0); _tmp70107 < uint(len((*_tmp70104))); _tmp70107 ++ {
      _v = (*_tmp70104)[_tmp70107]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp73369 := _scope._arr;
  for _tmp73372 := uint(0); _tmp73372 < uint(len((*_tmp73369))); _tmp73372 ++ {
    _v = (*_tmp73369)[_tmp73372]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp75333 := _v._arr;
  for _tmp75336 := uint(0); _tmp75336 < uint(len((*_tmp75333))); _tmp75336 ++ {
    _vv = (*_tmp75333)[_tmp75336]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp76421 := _p;
  for _tmp76424 := uint(0); _tmp76424 < uint(len((*_tmp76421))); _tmp76424 ++ {
    _v = (*_tmp76421)[_tmp76424]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp79215 := _c._arr;
  for _tmp79218 := uint(0); _tmp79218 < uint(len((*_tmp79215))); _tmp79218 ++ {
    _v = (*_tmp79215)[_tmp79218]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp79938 := _o._arr;
  for _tmp79941 := uint(0); _tmp79941 < uint(len((*_tmp79938))); _tmp79941 ++ {
    _v = (*_tmp79938)[_tmp79941]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp98041 := _a;
    for _tmp98044 := uint(0); _tmp98044 < uint(len((*_tmp98041))); _tmp98044 ++ {
      _v = (*_tmp98041)[_tmp98044]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp98276 := _a;
    for _tmp98279 := uint(0); _tmp98279 < uint(len((*_tmp98276))); _tmp98279 ++ {
      _v = (*_tmp98276)[_tmp98279]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp98601 := _d;
  for _tmp98604 := uint(0); _tmp98604 < uint(len((*_tmp98601))); _tmp98604 ++ {
    _v = (*_tmp98601)[_tmp98604]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp108770 := _c._arr;
    for _tmp108773 := uint(0); _tmp108773 < uint(len((*_tmp108770))); _tmp108773 ++ {
      _v = (*_tmp108770)[_tmp108773]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp110460 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp110460))); _i ++ {
    _v = (*_tmp110460)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp117412 := _env._dic["envStack"]._arr;
  for _tmp117415 := uint(0); _tmp117415 < uint(len((*_tmp117412))); _tmp117415 ++ {
    _v = (*_tmp117412)[_tmp117415]
...
func id2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    ...
    if(_varts != nil){
      _tmp118686 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp118686))); _i ++ {
        _stro = (*_tmp118686)[_i]
        if(_id == _stro._str){
...
func idlocal2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    _varts = getx(_func, "funcVars")
    if(_varts != nil){
      _tmp121606 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp121606))); _i ++ {
        _stro = (*_tmp121606)[_i]
        if(_id == _stro._str){
          _r = idNewx(_local, _stro._str, _idargc)
          _r._int = int(_i)
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp124596 := _args;
  for _tmp124599 := uint(0); _tmp124599 < uint(len(_tmp124596)); _tmp124599 ++ {
    _arg = _tmp124596[_tmp124599]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    _arr = &[]*Cptx{}
    _tmp130415 := _parents;
    for _tmp130418 := uint(0); _tmp130418 < uint(len(_tmp130415)); _tmp130418 ++ {
      _e = _tmp130415[_tmp130418]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp134774 := _arr;
  for _i = uint(0); _i < uint(len(_tmp134774)); _i ++ {
    _v = _tmp134774[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp161835 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp161835)); _i ++ {
    _e = _tmp161835[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp163748 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp163748)); _i ++ {
    _e = _tmp163748[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp164821 := _ast;
  for _i = uint(0); _i < uint(len(_tmp164821)); _i ++ {
    _e = _tmp164821[_i]
    _ee = _e.([]interface{})
  ...
  _tmp165206 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165206)); _i ++ {
    _e = _tmp165206[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp165591 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165591)); _i ++ {
    _e = _tmp165591[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp166524 := _ast;
  for _tmp166527 := uint(0); _tmp166527 < uint(len(_tmp166524)); _tmp166527 ++ {
    _e = _tmp166524[_tmp166527]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp168715 := _asts;
  for _i = uint(0); _i < uint(len(_tmp168715)); _i ++ {
    _e = _tmp168715[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp169169 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp169169)); _i ++ {
      _v = _tmp169169[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp170214 := _asts;
  for _tmp170217 := uint(0); _tmp170217 < uint(len(_tmp170214)); _tmp170217 ++ {
    _eo = _tmp170214[_tmp170217]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp171822 := _asts;
  for _tmp171825 := uint(0); _tmp171825 < uint(len(_tmp171822)); _tmp171825 ++ {
    _eo = _tmp171822[_tmp171825]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func main(){
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp206012 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp206015 := uint(0); _tmp206015 < uint(len(_tmp206012)); _tmp206015 ++ {
      _k = _tmp206012[_tmp206015]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp207429 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp207432 := uint(0); _tmp207432 < uint(len(_tmp207429)); _tmp207432 ++ {
      _k = _tmp207429[_tmp207432]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp214017 := _xx;
    for _tmp214020 := uint(0); _tmp214020 < uint(len((*_tmp214017))); _tmp214020 ++ {
      _v = (*_tmp214017)[_tmp214020]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp221204 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp221204))); _i ++ {
      _v = (*_tmp221204)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp237854 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp237854))); _i ++ {
        _v = (*_tmp237854)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp239918 := _c._arr;
    for _tmp239921 := uint(0); _tmp239921 < uint(len((*_tmp239918))); _tmp239921 ++ {
      _v = (*_tmp239918)[_tmp239921]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp242630 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp242630))); _i ++ {
        _v = (*_tmp242630)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp247563 := _da._arr;
      for _tmp247566 := uint(0); _tmp247566 < uint(len((*_tmp247563))); _tmp247566 ++ {
        _kc = (*_tmp247563)[_tmp247566]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
