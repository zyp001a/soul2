...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp40686 := _o;
  for _tmp40689 := uint(0); _tmp40689 < uint(len((*_tmp40686))); _tmp40689 ++ {
    _e = (*_tmp40686)[_tmp40689]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp41990 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp41990))); _i ++ {
    _x = (*_tmp41990)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp42902 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp42905 := uint(0); _tmp42905 < uint(len(_tmp42902)); _tmp42905 ++ {
    _k = _tmp42902[_tmp42905]
    if(_o._dic[_k] == nil){
  ...
  _tmp43370 := _c._arr;
  for _tmp43373 := uint(0); _tmp43373 < uint(len((*_tmp43370))); _tmp43373 ++ {
    _v = (*_tmp43370)[_tmp43373]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp43876 := _parentarr;
    for _tmp43879 := uint(0); _tmp43879 < uint(len((*_tmp43876))); _tmp43879 ++ {
      _e = (*_tmp43876)[_tmp43879]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp46245 := _o._arr;
  for _tmp46248 := uint(0); _tmp46248 < uint(len((*_tmp46245))); _tmp46248 ++ {
    _k = (*_tmp46245)[_tmp46248]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp47002 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp47002))); _i ++ {
      _argdef = (*_tmp47002)[_i]
    ...
    _tmp47358 := _args;
    for _tmp47361 := uint(0); _tmp47361 < uint(len((*_tmp47358))); _tmp47361 ++ {
      _arg = (*_tmp47358)[_tmp47361]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp47908 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp47908))); _i ++ {
      _argdef = (*_tmp47908)[_i]
      if(_i < uint(len((*_args)))){
    ...
    _tmp48200 := _args;
    for _tmp48203 := uint(0); _tmp48203 < uint(len((*_tmp48200))); _tmp48203 ++ {
      _arg = (*_tmp48200)[_tmp48203]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp54619 := _argtypes;
  for _tmp54622 := uint(0); _tmp54622 < uint(len((*_tmp54619))); _tmp54622 ++ {
    _v = (*_tmp54619)[_tmp54622]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp56479 := _x._arr;
  for _tmp56482 := uint(0); _tmp56482 < uint(len((*_tmp56479))); _tmp56482 ++ {
    _v = (*_tmp56479)[_tmp56482]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp57453 := _c._arr;
  for _tmp57456 := uint(0); _tmp57456 < uint(len((*_tmp57453))); _tmp57456 ++ {
    _v = (*_tmp57453)[_tmp57456]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp59239 := _types;
  for _tmp59242 := uint(0); _tmp59242 < uint(len((*_tmp59239))); _tmp59242 ++ {
    _v = (*_tmp59239)[_tmp59242]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp62364 := _arr;
    for _tmp62367 := uint(0); _tmp62367 < uint(len((*_tmp62364))); _tmp62367 ++ {
      _v = (*_tmp62364)[_tmp62367]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp65141 := _scope._arr;
  for _tmp65144 := uint(0); _tmp65144 < uint(len((*_tmp65141))); _tmp65144 ++ {
    _v = (*_tmp65141)[_tmp65144]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp66606 := _v._arr;
  for _tmp66609 := uint(0); _tmp66609 < uint(len((*_tmp66606))); _tmp66609 ++ {
    _vv = (*_tmp66606)[_tmp66609]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp67463 := _p;
  for _tmp67466 := uint(0); _tmp67466 < uint(len((*_tmp67463))); _tmp67466 ++ {
    _v = (*_tmp67463)[_tmp67466]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp69844 := _c._arr;
  for _tmp69847 := uint(0); _tmp69847 < uint(len((*_tmp69844))); _tmp69847 ++ {
    _v = (*_tmp69844)[_tmp69847]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp70454 := _o._arr;
  for _tmp70457 := uint(0); _tmp70457 < uint(len((*_tmp70454))); _tmp70457 ++ {
    _v = (*_tmp70454)[_tmp70457]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp85220 := _a;
    for _tmp85223 := uint(0); _tmp85223 < uint(len((*_tmp85220))); _tmp85223 ++ {
      _v = (*_tmp85220)[_tmp85223]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp85423 := _a;
    for _tmp85426 := uint(0); _tmp85426 < uint(len((*_tmp85423))); _tmp85426 ++ {
      _v = (*_tmp85423)[_tmp85426]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp85693 := _d;
  for _tmp85696 := uint(0); _tmp85696 < uint(len((*_tmp85693))); _tmp85696 ++ {
    _v = (*_tmp85693)[_tmp85696]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _tmp89003 := _args;
  for _i = uint(0); _i < uint(len((*_tmp89003))); _i ++ {
    _v = (*_tmp89003)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp91797 := _args;
    for _i = uint(0); _i < uint(len((*_tmp91797))); _i ++ {
      _arg = (*_tmp91797)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp93694 := _c._arr;
    for _tmp93697 := uint(0); _tmp93697 < uint(len((*_tmp93694))); _tmp93697 ++ {
      _v = (*_tmp93694)[_tmp93697]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp95127 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp95127))); _i ++ {
    _v = (*_tmp95127)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp100696 := _env._dic["envStack"]._arr;
  for _tmp100699 := uint(0); _tmp100699 < uint(len((*_tmp100696))); _tmp100699 ++ {
    _v = (*_tmp100696)[_tmp100699]
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp103614 := _args;
  for _tmp103617 := uint(0); _tmp103617 < uint(len(_tmp103614)); _tmp103617 ++ {
    _arg = _tmp103614[_tmp103617]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp107155 := _parents;
    for _tmp107158 := uint(0); _tmp107158 < uint(len(_tmp107155)); _tmp107158 ++ {
      _e = _tmp107155[_tmp107158]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp110837 := _arr;
  for _i = uint(0); _i < uint(len(_tmp110837)); _i ++ {
    _v = _tmp110837[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp132618 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp132618)); _i ++ {
    _e = _tmp132618[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp134224 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp134224)); _i ++ {
    _e = _tmp134224[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp135076 := _ast;
  for _i = uint(0); _i < uint(len(_tmp135076)); _i ++ {
    _e = _tmp135076[_i]
    _ee = _e.([]interface{})
  ...
  _tmp135400 := _ast;
  for _i = uint(0); _i < uint(len(_tmp135400)); _i ++ {
    _e = _tmp135400[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp136189 := _ast;
  for _tmp136192 := uint(0); _tmp136192 < uint(len(_tmp136189)); _tmp136192 ++ {
    _e = _tmp136189[_tmp136192]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp138175 := _asts;
  for _i = uint(0); _i < uint(len(_tmp138175)); _i ++ {
    _e = _tmp138175[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp138561 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp138561)); _i ++ {
      _v = _tmp138561[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp139448 := _asts;
  for _tmp139451 := uint(0); _tmp139451 < uint(len(_tmp139448)); _tmp139451 ++ {
    _eo = _tmp139448[_tmp139451]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func main(){
  ...
  funcDefx(_defmain, "send", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _tmp156040 := _arr;
    for _tmp156043 := uint(0); _tmp156043 < uint(len((*_tmp156040))); _tmp156043 ++ {
      _v = (*_tmp156040)[_tmp156043]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp168993 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp168996 := uint(0); _tmp168996 < uint(len(_tmp168993)); _tmp168996 ++ {
      _k = _tmp168993[_tmp168996]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp169866 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp169869 := uint(0); _tmp169869 < uint(len(_tmp169866)); _tmp169869 ++ {
      _k = _tmp169866[_tmp169869]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp175406 := _xx;
    for _tmp175409 := uint(0); _tmp175409 < uint(len((*_tmp175406))); _tmp175409 ++ {
      _v = (*_tmp175406)[_tmp175409]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp181369 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp181369))); _i ++ {
      _v = (*_tmp181369)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_bufferc, "writeStr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    var _o *Cptx
    var _s *Cptx
    _o = (*_x)[0]
    _s = (*_x)[1]
    _o._val.(*bytes.Buffer).WriteString(_s._str)
    return _nullv
  }, &[]*Cptx{_strc}, nil)
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp192119 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp192119))); _i ++ {
        _v = (*_tmp192119)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp193850 := _c._arr;
    for _tmp193853 := uint(0); _tmp193853 < uint(len((*_tmp193850))); _tmp193853 ++ {
      _v = (*_tmp193850)[_tmp193853]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp196532 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp196532))); _i ++ {
        _v = (*_tmp196532)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp199945 := _da._arr;
      for _tmp199948 := uint(0); _tmp199948 < uint(len((*_tmp199945))); _tmp199948 ++ {
        _kc = (*_tmp199945)[_tmp199948]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
