...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp44614 := _o;
  for _tmp44617 := uint(0); _tmp44617 < uint(len((*_tmp44614))); _tmp44617 ++ {
    _e = (*_tmp44614)[_tmp44617]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp45159 := _o;
  for _i = uint(0); _i < uint(len(_tmp45159)); _i ++ {
    _e = _tmp45159[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp46091 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp46091))); _i ++ {
    _x = (*_tmp46091)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp47156 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp47159 := uint(0); _tmp47159 < uint(len(_tmp47156)); _tmp47159 ++ {
    _k = _tmp47156[_tmp47159]
    if(_o._dic[_k] == nil){
  ...
  _tmp47662 := _c._arr;
  for _tmp47665 := uint(0); _tmp47665 < uint(len((*_tmp47662))); _tmp47665 ++ {
    _v = (*_tmp47662)[_tmp47665]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp48269 := _parentarr;
    for _tmp48272 := uint(0); _tmp48272 < uint(len((*_tmp48269))); _tmp48272 ++ {
      _e = (*_tmp48269)[_tmp48272]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp52155 := _o._arr;
  for _tmp52158 := uint(0); _tmp52158 < uint(len((*_tmp52155))); _tmp52158 ++ {
    _k = (*_tmp52155)[_tmp52158]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(inClassx(classx(_f), _funcvarsc, nil)){
    ...
    _tmp53033 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp53033))); _i ++ {
      _argdef = (*_tmp53033)[_i]
    ...
    _tmp53436 := _args;
    for _tmp53439 := uint(0); _tmp53439 < uint(len((*_tmp53436))); _tmp53439 ++ {
      _arg = (*_tmp53436)[_tmp53439]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp61368 := _argtypes;
  for _tmp61371 := uint(0); _tmp61371 < uint(len((*_tmp61368))); _tmp61371 ++ {
    _v = (*_tmp61368)[_tmp61371]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp63604 := _x._arr;
  for _tmp63607 := uint(0); _tmp63607 < uint(len((*_tmp63604))); _tmp63607 ++ {
    _v = (*_tmp63604)[_tmp63607]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp64770 := _c._arr;
  for _tmp64773 := uint(0); _tmp64773 < uint(len((*_tmp64770))); _tmp64773 ++ {
    _v = (*_tmp64770)[_tmp64773]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp66938 := _types;
  for _tmp66941 := uint(0); _tmp66941 < uint(len((*_tmp66938))); _tmp66941 ++ {
    _v = (*_tmp66938)[_tmp66941]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp70499 := _arr;
    for _tmp70502 := uint(0); _tmp70502 < uint(len((*_tmp70499))); _tmp70502 ++ {
      _v = (*_tmp70499)[_tmp70502]
...
func dbGetx(_scope *Cptx, _key string) *Cptx{
  ...
  if(_f != nil){
    ...
    if(_f["timeMod"] > _fcache["timeMod"]){
      ...
      _checkErr(_dir_set(_fstr + ".cache", []byte(_jstr)), nil)
    }else{
    ...
    if(_f2["timeMod"] > _f2cache["timeMod"]){
      _jstr = _osCmd(os.Getenv("HOME") + "/soul2/sl-reader", _key + " := " + _str)
      _checkErr(_dir_set(_fstr + "t.cache", []byte(_jstr)), nil)
    }else{
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp73861 := _scope._arr;
  for _tmp73864 := uint(0); _tmp73864 < uint(len((*_tmp73861))); _tmp73864 ++ {
    _v = (*_tmp73861)[_tmp73864]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp75825 := _v._arr;
  for _tmp75828 := uint(0); _tmp75828 < uint(len((*_tmp75825))); _tmp75828 ++ {
    _vv = (*_tmp75825)[_tmp75828]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp76913 := _p;
  for _tmp76916 := uint(0); _tmp76916 < uint(len((*_tmp76913))); _tmp76916 ++ {
    _v = (*_tmp76913)[_tmp76916]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp79707 := _c._arr;
  for _tmp79710 := uint(0); _tmp79710 < uint(len((*_tmp79707))); _tmp79710 ++ {
    _v = (*_tmp79707)[_tmp79710]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp80430 := _o._arr;
  for _tmp80433 := uint(0); _tmp80433 < uint(len((*_tmp80430))); _tmp80433 ++ {
    _v = (*_tmp80430)[_tmp80433]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp98551 := _a;
    for _tmp98554 := uint(0); _tmp98554 < uint(len((*_tmp98551))); _tmp98554 ++ {
      _v = (*_tmp98551)[_tmp98554]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp98786 := _a;
    for _tmp98789 := uint(0); _tmp98789 < uint(len((*_tmp98786))); _tmp98789 ++ {
      _v = (*_tmp98786)[_tmp98789]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp99111 := _d;
  for _tmp99114 := uint(0); _tmp99114 < uint(len((*_tmp99111))); _tmp99114 ++ {
    _v = (*_tmp99111)[_tmp99114]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp109279 := _c._arr;
    for _tmp109282 := uint(0); _tmp109282 < uint(len((*_tmp109279))); _tmp109282 ++ {
      _v = (*_tmp109279)[_tmp109282]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp110969 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp110969))); _i ++ {
    _v = (*_tmp110969)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp117920 := _env._dic["envStack"]._arr;
  for _tmp117923 := uint(0); _tmp117923 < uint(len((*_tmp117920))); _tmp117923 ++ {
    _v = (*_tmp117920)[_tmp117923]
...
func id2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    ...
    if(_varts != nil){
      _tmp119194 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp119194))); _i ++ {
        _stro = (*_tmp119194)[_i]
        if(_id == _stro._str){
...
func idlocal2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    _varts = getx(_func, "funcVars")
    if(_varts != nil){
      _tmp122113 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp122113))); _i ++ {
        _stro = (*_tmp122113)[_i]
        if(_id == _stro._str){
          _r = idNewx(_local, _stro._str, _idargc)
          _r._int = int(_i)
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp125103 := _args;
  for _tmp125106 := uint(0); _tmp125106 < uint(len(_tmp125103)); _tmp125106 ++ {
    _arg = _tmp125103[_tmp125106]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    _arr = &[]*Cptx{}
    _tmp130922 := _parents;
    for _tmp130925 := uint(0); _tmp130925 < uint(len(_tmp130922)); _tmp130925 ++ {
      _e = _tmp130922[_tmp130925]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp135281 := _arr;
  for _i = uint(0); _i < uint(len(_tmp135281)); _i ++ {
    _v = _tmp135281[_i]
...
func itemsget2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _v *Cptx) *Cptx{
  ...
  if(inClassx(classx(_items), _idstatec, nil)){
    ...
    if(_predt._id != _unknownc._id && _predt._id != _cptc._id && !inClassx(_predt, _itemsc, nil)){
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _tmp162610 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp162610)); _i ++ {
    _e = _tmp162610[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp164523 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp164523)); _i ++ {
    _e = _tmp164523[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp165596 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165596)); _i ++ {
    _e = _tmp165596[_i]
    _ee = _e.([]interface{})
  ...
  _tmp165981 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165981)); _i ++ {
    _e = _tmp165981[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp166366 := _ast;
  for _i = uint(0); _i < uint(len(_tmp166366)); _i ++ {
    _e = _tmp166366[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp167299 := _ast;
  for _tmp167302 := uint(0); _tmp167302 < uint(len(_tmp167299)); _tmp167302 ++ {
    _e = _tmp167299[_tmp167302]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp169490 := _asts;
  for _i = uint(0); _i < uint(len(_tmp169490)); _i ++ {
    _e = _tmp169490[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp169944 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp169944)); _i ++ {
      _v = _tmp169944[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp170989 := _asts;
  for _tmp170992 := uint(0); _tmp170992 < uint(len(_tmp170989)); _tmp170992 ++ {
    _eo = _tmp170989[_tmp170992]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp172597 := _asts;
  for _tmp172600 := uint(0); _tmp172600 < uint(len(_tmp172597)); _tmp172600 ++ {
    _eo = _tmp172597[_tmp172600]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func main(){
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp207259 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp207262 := uint(0); _tmp207262 < uint(len(_tmp207259)); _tmp207262 ++ {
      _k = _tmp207259[_tmp207262]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp208676 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp208679 := uint(0); _tmp208679 < uint(len(_tmp208676)); _tmp208679 ++ {
      _k = _tmp208676[_tmp208679]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp215264 := _xx;
    for _tmp215267 := uint(0); _tmp215267 < uint(len((*_tmp215264))); _tmp215267 ++ {
      _v = (*_tmp215264)[_tmp215267]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp222739 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp222739))); _i ++ {
      _v = (*_tmp222739)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_dirc, "set", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = (*_x)[1]
    _v = (*_x)[2]
    _checkErr(_dir_set(_o._dic["routerPath"]._str + _s._str, _v._bytes), nil)
    return _v
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp238560 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp238560))); _i ++ {
        _v = (*_tmp238560)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp240624 := _c._arr;
    for _tmp240627 := uint(0); _tmp240627 < uint(len((*_tmp240624))); _tmp240627 ++ {
      _v = (*_tmp240624)[_tmp240627]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp243336 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp243336))); _i ++ {
        _v = (*_tmp243336)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp248269 := _da._arr;
      for _tmp248272 := uint(0); _tmp248272 < uint(len((*_tmp248269))); _tmp248272 ++ {
        _kc = (*_tmp248269)[_tmp248272]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
