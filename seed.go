...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp25868 := _o;
  for _tmp25875 := uint(0); _tmp25875 < uint(len((*_tmp25868))); _tmp25875 ++ {
    _e = (*_tmp25868)[_tmp25875]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp26927 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp26927))); _i ++ {
    _x = (*_tmp26927)[_i]
    if(_i != 0 && _x != ""){
      _r += "\n"
      _r += __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp28869 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp28876 := uint(0); _tmp28876 < uint(len((*_tmp28869))); _tmp28876 ++ {
    _k = (*_tmp28869)[_tmp28876]
    if(_o._dic[_k] == nil){
  ...
  _tmp29351 := _c._arr;
  for _tmp29358 := uint(0); _tmp29358 < uint(len((*_tmp29351))); _tmp29358 ++ {
    _v = (*_tmp29351)[_tmp29358]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp29927 := _parentarr;
    for _tmp29934 := uint(0); _tmp29934 < uint(len((*_tmp29927))); _tmp29934 ++ {
      _e = (*_tmp29927)[_tmp29934]
      if(_e._id == ""){
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_Path_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp37406 := _arr;
    for _tmp37413 := uint(0); _tmp37413 < uint(len((*_tmp37406))); _tmp37413 ++ {
      _v = (*_tmp37406)[_tmp37413]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp40023 := _scope._arr;
  for _tmp40030 := uint(0); _tmp40030 < uint(len((*_tmp40023))); _tmp40030 ++ {
    _v = (*_tmp40023)[_tmp40030]
    _k = _v._id
    if(_cache[_k] != nil){
      continue
    }
...
func subMethodGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp41595 := _v._arr;
  for _tmp41602 := uint(0); _tmp41602 < uint(len((*_tmp41595))); _tmp41602 ++ {
    _vv = (*_tmp41595)[_tmp41602]
...
func methodGetx(_scope *Cptx, _func *Cptx) *Cptx{
  ...
  _p = _o._arr
  _tmp42182 := _p;
  for _tmp42189 := uint(0); _tmp42189 < uint(len((*_tmp42182))); _tmp42189 ++ {
    _v = (*_tmp42182)[_tmp42189]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp49702 := _types;
  for _tmp49709 := uint(0); _tmp49709 < uint(len((*_tmp49702))); _tmp49709 ++ {
    _v = (*_tmp49702)[_tmp49709]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp59411 := _argtypes;
  for _tmp59418 := uint(0); _tmp59418 < uint(len((*_tmp59411))); _tmp59418 ++ {
    _v = (*_tmp59411)[_tmp59418]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp64087 := _c._arr;
  for _tmp64094 := uint(0); _tmp64094 < uint(len((*_tmp64087))); _tmp64094 ++ {
    _v = (*_tmp64087)[_tmp64094]
...
func getParentx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp71035 := _o._arr;
  for _tmp71042 := uint(0); _tmp71042 < uint(len((*_tmp71035))); _tmp71042 ++ {
    _v = (*_tmp71035)[_tmp71042]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(len((*_a)) > 1){
    _s += "\n"
    _tmp77498 := _a;
    for _tmp77505 := uint(0); _tmp77505 < uint(len((*_tmp77498))); _tmp77505 ++ {
      _v = (*_tmp77498)[_tmp77505]
      _s += indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp77705 := _a;
    for _tmp77712 := uint(0); _tmp77712 < uint(len((*_tmp77705))); _tmp77712 ++ {
      _v = (*_tmp77705)[_tmp77712]
      _s += strx(_v, _i + 1)
    }
  }
  return _s + "]"
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp78037 := _d;
  for _tmp78044 := uint(0); _tmp78044 < uint(len((*_tmp78037))); _tmp78044 ++ {
    _v = (*_tmp78037)[_tmp78044]
    if(_v._name != ""){
      _s += _v._name + " "
    }else{
      _s += "~" + _v._id + " "
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _nstate._int = 2
  _tmp81322 := _args;
  for _i = uint(0); _i < uint(len((*_tmp81322))); _i ++ {
    _v = (*_tmp81322)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp83320 := _args;
    for _i = uint(0); _i < uint(len((*_tmp83320))); _i ++ {
      _arg = (*_tmp83320)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp85275 := _c._arr;
    for _tmp85282 := uint(0); _tmp85282 < uint(len((*_tmp85275))); _tmp85282 ++ {
      _v = (*_tmp85275)[_tmp85282]
      if(_cache[_v._id] != nil){
        return nil
      }
      _cache[_v._id] = 1
...
func blockExecx(_o *Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _b = _o._dic["blockVal"]
  _tmp86601 := _b._arr;
  for _i = uint(0); _i < uint(len((*_tmp86601))); _i ++ {
    _v = (*_tmp86601)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp91486 := _args;
  for _tmp91493 := uint(0); _tmp91493 < uint(len(_tmp91486)); _tmp91493 ++ {
    _arg = _tmp91486[_tmp91493]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp94805 := _parents;
    for _tmp94812 := uint(0); _tmp94812 < uint(len(_tmp94805)); _tmp94812 ++ {
      _e = _tmp94805[_tmp94812]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp98777 := _arr;
  for _i = uint(0); _i < uint(len(_tmp98777)); _i ++ {
    _v = _tmp98777[_i]
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp123721 := _ast;
  for _i = uint(0); _i < uint(len(_tmp123721)); _i ++ {
    _e = _tmp123721[_i]
    _ee = _e.([]interface{})
  ...
  _tmp124062 := _ast;
  for _i = uint(0); _i < uint(len(_tmp124062)); _i ++ {
    _e = _tmp124062[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp124930 := _ast;
  for _tmp124937 := uint(0); _tmp124937 < uint(len(_tmp124930)); _tmp124937 ++ {
    _e = _tmp124930[_tmp124937]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp126636 := _asts;
  for _tmp126643 := uint(0); _tmp126643 < uint(len(_tmp126636)); _tmp126643 ++ {
    _e = _tmp126636[_tmp126643]
  ...
  if(!_callable){
    _tmp127047 := _arrx;
    for _i = uint(0); _i < uint(len((*_tmp127047))); _i ++ {
      _v = (*_tmp127047)[_i]
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp128014 := _asts;
  for _tmp128021 := uint(0); _tmp128021 < uint(len(_tmp128014)); _tmp128021 ++ {
    _eo = _tmp128014[_tmp128021]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp136913 := _o._arr;
  for _tmp136920 := uint(0); _tmp136920 < uint(len((*_tmp136913))); _tmp136920 ++ {
    _k = (*_tmp136913)[_tmp136920]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp179826 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp179826))); _i ++ {
      _argdef = (*_tmp179826)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp180206 := _args;
    for _tmp180213 := uint(0); _tmp180213 < uint(len((*_tmp180206))); _tmp180213 ++ {
      _arg = (*_tmp180206)[_tmp180213]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp180848 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp180848))); _i ++ {
      _argdef = (*_tmp180848)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp181192 := _args;
    for _tmp181199 := uint(0); _tmp181199 < uint(len((*_tmp181192))); _tmp181199 ++ {
      _arg = (*_tmp181192)[_tmp181199]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func main(){
  ...
  _intc = classDefx(_defmain, "Int", &[]*Cptx{_numc}, nil)
  _intc._ctype = TINT
  _uintc = classDefx(_defmain, "Uint", &[]*Cptx{_intc}, nil)
  _floatc = classDefx(_defmain, "Float", &[]*Cptx{_numc}, nil)
  ...
  _emptyreturnc._fstatic = true
  _emptyreturnv._fstatic = true
  ...
  funcDefx(_defmain, "osArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp138394 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp138394))); _i ++ {
        _v = (*_tmp138394)[_i]
        if(_i == 0){
          continue
        }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp157581 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp157588 := uint(0); _tmp157588 < uint(len((*_tmp157581))); _tmp157588 ++ {
      _k = (*_tmp157581)[_tmp157588]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp158094 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp158101 := uint(0); _tmp158101 < uint(len((*_tmp158094))); _tmp158101 ++ {
      _k = (*_tmp158094)[_tmp158101]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
    return dicNewx(_dicc, _o._dic, _arrx)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp159595 := _xx;
    for _tmp159602 := uint(0); _tmp159602 < uint(len((*_tmp159595))); _tmp159602 ++ {
      _v = (*_tmp159595)[_tmp159602]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp165378 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp165378))); _i ++ {
      _v = (*_tmp165378)[_i]
      if(_i != 0){
        _s += _sep._str
      }
  ...
  opDefx(_idlocalc, "assign", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _str = _l._dic["idStr"]
    _local._dic[_str._str] = dynEnsure(_v)
    return _v
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp184810 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp184810))); _i ++ {
        _v = (*_tmp184810)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp188471 := _da._arr;
      for _tmp188478 := uint(0); _tmp188478 < uint(len((*_tmp188471))); _tmp188478 ++ {
        _kc = (*_tmp188471)[_tmp188478]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
      ...
      _tmp189306 := _da._arr;
      for _i = uint(0); _i < uint(len((*_tmp189306))); _i ++ {
        _v = (*_tmp189306)[_i]
        if(_key != ""){
