...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp40640 := _o;
  for _tmp40643 := uint(0); _tmp40643 < uint(len((*_tmp40640))); _tmp40643 ++ {
    _e = (*_tmp40640)[_tmp40643]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp41151 := _o;
  for _i = uint(0); _i < uint(len(_tmp41151)); _i ++ {
    _e = _tmp41151[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp41944 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp41944))); _i ++ {
    _x = (*_tmp41944)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp42856 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp42859 := uint(0); _tmp42859 < uint(len(_tmp42856)); _tmp42859 ++ {
    _k = _tmp42856[_tmp42859]
    if(_o._dic[_k] == nil){
  ...
  _tmp43324 := _c._arr;
  for _tmp43327 := uint(0); _tmp43327 < uint(len((*_tmp43324))); _tmp43327 ++ {
    _v = (*_tmp43324)[_tmp43327]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp43830 := _parentarr;
    for _tmp43833 := uint(0); _tmp43833 < uint(len((*_tmp43830))); _tmp43833 ++ {
      _e = (*_tmp43830)[_tmp43833]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp46199 := _o._arr;
  for _tmp46202 := uint(0); _tmp46202 < uint(len((*_tmp46199))); _tmp46202 ++ {
    _k = (*_tmp46199)[_tmp46202]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp46956 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp46956))); _i ++ {
      _argdef = (*_tmp46956)[_i]
    ...
    _tmp47312 := _args;
    for _tmp47315 := uint(0); _tmp47315 < uint(len((*_tmp47312))); _tmp47315 ++ {
      _arg = (*_tmp47312)[_tmp47315]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp47862 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp47862))); _i ++ {
      _argdef = (*_tmp47862)[_i]
      if(_i < uint(len((*_args)))){
    ...
    _tmp48154 := _args;
    for _tmp48157 := uint(0); _tmp48157 < uint(len((*_tmp48154))); _tmp48157 ++ {
      _arg = (*_tmp48154)[_tmp48157]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp54573 := _argtypes;
  for _tmp54576 := uint(0); _tmp54576 < uint(len((*_tmp54573))); _tmp54576 ++ {
    _v = (*_tmp54573)[_tmp54576]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp56433 := _x._arr;
  for _tmp56436 := uint(0); _tmp56436 < uint(len((*_tmp56433))); _tmp56436 ++ {
    _v = (*_tmp56433)[_tmp56436]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp57407 := _c._arr;
  for _tmp57410 := uint(0); _tmp57410 < uint(len((*_tmp57407))); _tmp57410 ++ {
    _v = (*_tmp57407)[_tmp57410]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp59193 := _types;
  for _tmp59196 := uint(0); _tmp59196 < uint(len((*_tmp59193))); _tmp59196 ++ {
    _v = (*_tmp59193)[_tmp59196]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp62318 := _arr;
    for _tmp62321 := uint(0); _tmp62321 < uint(len((*_tmp62318))); _tmp62321 ++ {
      _v = (*_tmp62318)[_tmp62321]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp65095 := _scope._arr;
  for _tmp65098 := uint(0); _tmp65098 < uint(len((*_tmp65095))); _tmp65098 ++ {
    _v = (*_tmp65095)[_tmp65098]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp66560 := _v._arr;
  for _tmp66563 := uint(0); _tmp66563 < uint(len((*_tmp66560))); _tmp66563 ++ {
    _vv = (*_tmp66560)[_tmp66563]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp67417 := _p;
  for _tmp67420 := uint(0); _tmp67420 < uint(len((*_tmp67417))); _tmp67420 ++ {
    _v = (*_tmp67417)[_tmp67420]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp69798 := _c._arr;
  for _tmp69801 := uint(0); _tmp69801 < uint(len((*_tmp69798))); _tmp69801 ++ {
    _v = (*_tmp69798)[_tmp69801]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp70408 := _o._arr;
  for _tmp70411 := uint(0); _tmp70411 < uint(len((*_tmp70408))); _tmp70411 ++ {
    _v = (*_tmp70408)[_tmp70411]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func defx(_class *Cptx, _dic map[string]*Cptx) *Cptx{
  ...
  if(_class._ctype == TCPT){
    ...
    if(inClassx(_class, _nativec, nil)){
      if(inClassx(_class, _bufferc, nil)){
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp85354 := _a;
    for _tmp85357 := uint(0); _tmp85357 < uint(len((*_tmp85354))); _tmp85357 ++ {
      _v = (*_tmp85354)[_tmp85357]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp85557 := _a;
    for _tmp85560 := uint(0); _tmp85560 < uint(len((*_tmp85557))); _tmp85560 ++ {
      _v = (*_tmp85557)[_tmp85560]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp85827 := _d;
  for _tmp85830 := uint(0); _tmp85830 < uint(len((*_tmp85827))); _tmp85830 ++ {
    _v = (*_tmp85827)[_tmp85830]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _tmp89137 := _args;
  for _i = uint(0); _i < uint(len((*_tmp89137))); _i ++ {
    _v = (*_tmp89137)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp91931 := _args;
    for _i = uint(0); _i < uint(len((*_tmp91931))); _i ++ {
      _arg = (*_tmp91931)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp93828 := _c._arr;
    for _tmp93831 := uint(0); _tmp93831 < uint(len((*_tmp93828))); _tmp93831 ++ {
      _v = (*_tmp93828)[_tmp93831]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp95261 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp95261))); _i ++ {
    _v = (*_tmp95261)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp100830 := _env._dic["envStack"]._arr;
  for _tmp100833 := uint(0); _tmp100833 < uint(len((*_tmp100830))); _tmp100833 ++ {
    _v = (*_tmp100830)[_tmp100833]
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp103748 := _args;
  for _tmp103751 := uint(0); _tmp103751 < uint(len(_tmp103748)); _tmp103751 ++ {
    _arg = _tmp103748[_tmp103751]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp107289 := _parents;
    for _tmp107292 := uint(0); _tmp107292 < uint(len(_tmp107289)); _tmp107292 ++ {
      _e = _tmp107289[_tmp107292]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp110971 := _arr;
  for _i = uint(0); _i < uint(len(_tmp110971)); _i ++ {
    _v = _tmp110971[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp132598 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp132598)); _i ++ {
    _e = _tmp132598[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp134204 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp134204)); _i ++ {
    _e = _tmp134204[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp135056 := _ast;
  for _i = uint(0); _i < uint(len(_tmp135056)); _i ++ {
    _e = _tmp135056[_i]
    _ee = _e.([]interface{})
  ...
  _tmp135380 := _ast;
  for _i = uint(0); _i < uint(len(_tmp135380)); _i ++ {
    _e = _tmp135380[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp136169 := _ast;
  for _tmp136172 := uint(0); _tmp136172 < uint(len(_tmp136169)); _tmp136172 ++ {
    _e = _tmp136169[_tmp136172]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp138155 := _asts;
  for _i = uint(0); _i < uint(len(_tmp138155)); _i ++ {
    _e = _tmp138155[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp138541 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp138541)); _i ++ {
      _v = _tmp138541[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp139428 := _asts;
  for _tmp139431 := uint(0); _tmp139431 < uint(len(_tmp139428)); _tmp139431 ++ {
    _eo = _tmp139428[_tmp139431]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func main(){
  ...
  funcDefx(_defmain, "send", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _tmp156020 := _arr;
    for _tmp156023 := uint(0); _tmp156023 < uint(len((*_tmp156020))); _tmp156023 ++ {
      _v = (*_tmp156020)[_tmp156023]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp168973 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp168976 := uint(0); _tmp168976 < uint(len(_tmp168973)); _tmp168976 ++ {
      _k = _tmp168973[_tmp168976]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp169846 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp169849 := uint(0); _tmp169849 < uint(len(_tmp169846)); _tmp169849 ++ {
      _k = _tmp169846[_tmp169849]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp175386 := _xx;
    for _tmp175389 := uint(0); _tmp175389 < uint(len((*_tmp175386))); _tmp175389 ++ {
      _v = (*_tmp175386)[_tmp175389]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp181349 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp181349))); _i ++ {
      _v = (*_tmp181349)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp191752 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp191752))); _i ++ {
        _v = (*_tmp191752)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp193483 := _c._arr;
    for _tmp193486 := uint(0); _tmp193486 < uint(len((*_tmp193483))); _tmp193486 ++ {
      _v = (*_tmp193483)[_tmp193486]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp196165 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp196165))); _i ++ {
        _v = (*_tmp196165)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp199578 := _da._arr;
      for _tmp199581 := uint(0); _tmp199581 < uint(len((*_tmp199578))); _tmp199581 ++ {
        _kc = (*_tmp199578)[_tmp199581]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
