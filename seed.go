...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp40713 := _o;
  for _tmp40716 := uint(0); _tmp40716 < uint(len((*_tmp40713))); _tmp40716 ++ {
    _e = (*_tmp40713)[_tmp40716]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp41208 := _o;
  for _i = uint(0); _i < uint(len(_tmp41208)); _i ++ {
    _e = _tmp41208[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp42013 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp42013))); _i ++ {
    _x = (*_tmp42013)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp42941 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp42944 := uint(0); _tmp42944 < uint(len(_tmp42941)); _tmp42944 ++ {
    _k = _tmp42941[_tmp42944]
    if(_o._dic[_k] == nil){
  ...
  _tmp43382 := _c._arr;
  for _tmp43385 := uint(0); _tmp43385 < uint(len((*_tmp43382))); _tmp43385 ++ {
    _v = (*_tmp43382)[_tmp43385]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp43913 := _parentarr;
    for _tmp43916 := uint(0); _tmp43916 < uint(len((*_tmp43913))); _tmp43916 ++ {
      _e = (*_tmp43913)[_tmp43916]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp47385 := _o._arr;
  for _tmp47388 := uint(0); _tmp47388 < uint(len((*_tmp47385))); _tmp47388 ++ {
    _k = (*_tmp47385)[_tmp47388]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(inClassx(classx(_f), _funcvarsc, nil)){
    ...
    _tmp48133 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp48133))); _i ++ {
      _argdef = (*_tmp48133)[_i]
    ...
    _tmp48482 := _args;
    for _tmp48485 := uint(0); _tmp48485 < uint(len((*_tmp48482))); _tmp48485 ++ {
      _arg = (*_tmp48482)[_tmp48485]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp55330 := _argtypes;
  for _tmp55333 := uint(0); _tmp55333 < uint(len((*_tmp55330))); _tmp55333 ++ {
    _v = (*_tmp55330)[_tmp55333]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp57333 := _x._arr;
  for _tmp57336 := uint(0); _tmp57336 < uint(len((*_tmp57333))); _tmp57336 ++ {
    _v = (*_tmp57333)[_tmp57336]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp58343 := _c._arr;
  for _tmp58346 := uint(0); _tmp58346 < uint(len((*_tmp58343))); _tmp58346 ++ {
    _v = (*_tmp58343)[_tmp58346]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp60168 := _types;
  for _tmp60171 := uint(0); _tmp60171 < uint(len((*_tmp60168))); _tmp60171 ++ {
    _v = (*_tmp60168)[_tmp60171]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp63416 := _arr;
    for _tmp63419 := uint(0); _tmp63419 < uint(len((*_tmp63416))); _tmp63419 ++ {
      _v = (*_tmp63416)[_tmp63419]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp66222 := _scope._arr;
  for _tmp66225 := uint(0); _tmp66225 < uint(len((*_tmp66222))); _tmp66225 ++ {
    _v = (*_tmp66222)[_tmp66225]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp67947 := _v._arr;
  for _tmp67950 := uint(0); _tmp67950 < uint(len((*_tmp67947))); _tmp67950 ++ {
    _vv = (*_tmp67947)[_tmp67950]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp68916 := _p;
  for _tmp68919 := uint(0); _tmp68919 < uint(len((*_tmp68916))); _tmp68919 ++ {
    _v = (*_tmp68916)[_tmp68919]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp71329 := _c._arr;
  for _tmp71332 := uint(0); _tmp71332 < uint(len((*_tmp71329))); _tmp71332 ++ {
    _v = (*_tmp71329)[_tmp71332]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp71969 := _o._arr;
  for _tmp71972 := uint(0); _tmp71972 < uint(len((*_tmp71969))); _tmp71972 ++ {
    _v = (*_tmp71969)[_tmp71972]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp87049 := _a;
    for _tmp87052 := uint(0); _tmp87052 < uint(len((*_tmp87049))); _tmp87052 ++ {
      _v = (*_tmp87049)[_tmp87052]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp87252 := _a;
    for _tmp87255 := uint(0); _tmp87255 < uint(len((*_tmp87252))); _tmp87255 ++ {
      _v = (*_tmp87252)[_tmp87255]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp87540 := _d;
  for _tmp87543 := uint(0); _tmp87543 < uint(len((*_tmp87540))); _tmp87543 ++ {
    _v = (*_tmp87540)[_tmp87543]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _tmp90882 := _args;
  for _i = uint(0); _i < uint(len((*_tmp90882))); _i ++ {
    _v = (*_tmp90882)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _env._dic["envLocal"] = _nstate
    if(inClassx(_func._obj, _handlerc, nil)){
      _tmp93701 := _args;
      for _i = uint(0); _i < uint(len((*_tmp93701))); _i ++ {
        _arg = (*_tmp93701)[_i]
        _nstate._dic[strconv.FormatUint(uint64(_i), 10)] = _arg
      }
    }else{
      _vars = _func._dic["funcVars"]._arr
      _tmp93895 := _args;
      for _i = uint(0); _i < uint(len((*_tmp93895))); _i ++ {
        _arg = (*_tmp93895)[_i]
...
func autoReturnx(_bl *Cptx, _x *Cptx) {
  ...
  if(classx((*_arr)[uint(len((*_arr))) - 1])._id != _ctrlreturnc._id){
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp96480 := _c._arr;
    for _tmp96483 := uint(0); _tmp96483 < uint(len((*_tmp96480))); _tmp96483 ++ {
      _v = (*_tmp96480)[_tmp96483]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp97979 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp97979))); _i ++ {
    _v = (*_tmp97979)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp103986 := _env._dic["envStack"]._arr;
  for _tmp103989 := uint(0); _tmp103989 < uint(len((*_tmp103986))); _tmp103989 ++ {
    _v = (*_tmp103986)[_tmp103989]
...
func idlocal2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_Str_isInt(_id)){
    if(_func == nil){
      fmt.Println("idarg not in func " + _id);debug.PrintStack();os.Exit(1)
    }
    if(inClassx(classx(_func), _funcstdc, nil)){
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp108797 := _args;
  for _tmp108800 := uint(0); _tmp108800 < uint(len(_tmp108797)); _tmp108800 ++ {
    _arg = _tmp108797[_tmp108800]
...
func func2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_v[4] != nil){
    _ab = preExecx(ast2cptx(_v[4].([]interface{}), _def, _nlocal, _x, ""))
...
func subHandler2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  var _c *Cptx
  var _t string
  var _tt *Cptx
  var _v []interface{}
  ...
  _t = _v[1].(string)
  if(_t != ""){
    _tt = mustGetx(_def, _t)
    if(!inClassx(_tt, _funcprotoc, nil)){
      fmt.Println("handler bind something other than func proto");debug.PrintStack();os.Exit(1)
    }
    _c = handlerDefx(_tt)
  }else{
    _c = _handlerc
...
func handler2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  var _ab *Cptx
  var _b []interface{}
  var _bl *Cptx
  var _cname string
  ...
  if(_name != ""){
    _x = preGetx(_def, _name, _cname)
    if(_x == nil){
      _x = subHandler2cptx(_ast, _def, _local, _func)
      preSetx(_x, _def, _name, _cname)
    }
  }else{
    if(_cname != ""){
  ...
  _nlocal = classNewx(&[]*Cptx{_local}, nil)
  _bl = ast2blockx(_b, _def, _nlocal, _x, nil)
  _x._dic["funcBlock"] = _bl
  if(_v[3] != nil){
    _ab = preExecx(ast2cptx(_v[3].([]interface{}), _def, _nlocal, _x, ""))
    _x._dic["funcErrFunc"] = _ab
  }else if(_func != nil){
    _x._dic["funcErrFunc"] = _func._dic["funcErrFunc"]
  }else{
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    _arr = &[]*Cptx{}
    _tmp115418 := _parents;
    for _tmp115421 := uint(0); _tmp115421 < uint(len(_tmp115418)); _tmp115421 ++ {
      _e = _tmp115418[_tmp115421]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp119255 := _arr;
  for _i = uint(0); _i < uint(len(_tmp119255)); _i ++ {
    _v = _tmp119255[_i]
...
func def2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _pre int) *Cptx{
  ...
  if(_pre == 2){
    if(_c == "class"){
      ...
      _dfd = _def._dic[_id]
      if(_dfd != nil){
        fmt.Println("handler def twice " + _id);debug.PrintStack();os.Exit(1)
      }
      return handler2cptx(_v, _def, _local, _func, _name, _pre)
  ...
  if(_c == "handler"){
    return handler2cptx(_v, _def, _local, _func, _name, 0)
  }
  _dfd = _def._dic[_id]
  if(_dfd != nil){
    return _dfd
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp143119 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp143119)); _i ++ {
    _e = _tmp143119[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp144775 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp144775)); _i ++ {
    _e = _tmp144775[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp145734 := _ast;
  for _i = uint(0); _i < uint(len(_tmp145734)); _i ++ {
    _e = _tmp145734[_i]
    _ee = _e.([]interface{})
  ...
  _tmp146058 := _ast;
  for _i = uint(0); _i < uint(len(_tmp146058)); _i ++ {
    _e = _tmp146058[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp146382 := _ast;
  for _i = uint(0); _i < uint(len(_tmp146382)); _i ++ {
    _e = _tmp146382[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp147208 := _ast;
  for _tmp147211 := uint(0); _tmp147211 < uint(len(_tmp147208)); _tmp147211 ++ {
    _e = _tmp147208[_tmp147211]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp149104 := _asts;
  for _i = uint(0); _i < uint(len(_tmp149104)); _i ++ {
    _e = _tmp149104[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp149490 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp149490)); _i ++ {
      _v = _tmp149490[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp150439 := _asts;
  for _tmp150442 := uint(0); _tmp150442 < uint(len(_tmp150439)); _tmp150442 ++ {
    _eo = _tmp150439[_tmp150442]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp151861 := _asts;
  for _tmp151864 := uint(0); _tmp151864 < uint(len(_tmp151861)); _tmp151864 ++ {
    _eo = _tmp151861[_tmp151864]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func subAst2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string) *Cptx{
  ...
  if(_t == "env"){
    ...
    return handler2cptx(_ast, _def, _local, _func, _name, 0)
  }else if(_t == "op"){
...
func main(){
  ...
  _funcvarsc = classDefx(_defmain, "FuncProto", &[]*Cptx{_funcprotoc}, map[string]*Cptx{
    "funcVars": _arrstrc,
  })
  ...
  _handlerc = classDefx(_defmain, "Handler", &[]*Cptx{_funcblockc, _funcerrc}, nil)
  ...
  _worldc = classDefx(_defmain, "World", &[]*Cptx{_souldicc}, nil)
  _worldv = defx(_worldc, nil)
  ...
  _idargc = curryDefx(_defmain, "IdArg", _idlocalc, nil)
  _idclassc = classDefx(_defmain, "IdClass", &[]*Cptx{_idstrc}, map[string]*Cptx{
    "idVal": _cptc,
  })
  _idcondc = classDefx(_defmain, "IdCond", &[]*Cptx{_idstrc}, nil)
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp181782 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp181785 := uint(0); _tmp181785 < uint(len(_tmp181782)); _tmp181785 ++ {
      _k = _tmp181782[_tmp181785]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp183027 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp183030 := uint(0); _tmp183030 < uint(len(_tmp183027)); _tmp183030 ++ {
      _k = _tmp183027[_tmp183030]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp188797 := _xx;
    for _tmp188800 := uint(0); _tmp188800 < uint(len((*_tmp188797))); _tmp188800 ++ {
      _v = (*_tmp188797)[_tmp188800]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp195092 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp195092))); _i ++ {
      _v = (*_tmp195092)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_dirc, "sub", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = (*_x)[1]
    if([]byte(_s._str)[uint(len(_s._str)) - 1] != '/'){
      _s._str = _s._str + "/"
    }
  ...
  methodDefx(_builderstrc, "new", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    var _r *Cptx
    _r = objNewx(_builderstrc, nil)
    _r._val = new(strings.Builder)
    return _r
  }, nil, _builderstrc)
  methodDefx(_builderstrc, "writeStr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    var _o *Cptx
    var _s *Cptx
    _o = (*_x)[0]
    _s = (*_x)[1]
    _o._val.(*strings.Builder).WriteString(_s._str)
    return _nullv
  }, &[]*Cptx{_strc}, nil)
  methodDefx(_builderstrc, "toStr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    var _r *Cptx
    _r = objNewx(_builderstrc, nil)
    _r._val = new(strings.Builder)
    return _r
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp208140 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp208140))); _i ++ {
        _v = (*_tmp208140)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp209943 := _c._arr;
    for _tmp209946 := uint(0); _tmp209946 < uint(len((*_tmp209943))); _tmp209946 ++ {
      _v = (*_tmp209943)[_tmp209946]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp212357 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp212357))); _i ++ {
        _v = (*_tmp212357)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp216650 := _da._arr;
      for _tmp216653 := uint(0); _tmp216653 < uint(len((*_tmp216650))); _tmp216653 ++ {
        _kc = (*_tmp216650)[_tmp216653]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
