...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp41098 := _o;
  for _tmp41105 := uint(0); _tmp41105 < uint(len((*_tmp41098))); _tmp41105 ++ {
    _e = (*_tmp41098)[_tmp41105]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp41979 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp41979))); _i ++ {
    _x = (*_tmp41979)[_i]
    if(_i != 0 && _x != ""){
      _r += "\n"
      _r += __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp43704 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp43711 := uint(0); _tmp43711 < uint(len(_tmp43704)); _tmp43711 ++ {
    _k = _tmp43704[_tmp43711]
    if(_o._dic[_k] == nil){
  ...
  _tmp44177 := _c._arr;
  for _tmp44184 := uint(0); _tmp44184 < uint(len((*_tmp44177))); _tmp44184 ++ {
    _v = (*_tmp44177)[_tmp44184]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp44797 := _parentarr;
    for _tmp44804 := uint(0); _tmp44804 < uint(len((*_tmp44797))); _tmp44804 ++ {
      _e = (*_tmp44797)[_tmp44804]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp47623 := _o._arr;
  for _tmp47630 := uint(0); _tmp47630 < uint(len((*_tmp47623))); _tmp47630 ++ {
    _k = (*_tmp47623)[_tmp47630]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp48479 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp48479))); _i ++ {
      _argdef = (*_tmp48479)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp48934 := _args;
    for _tmp48941 := uint(0); _tmp48941 < uint(len((*_tmp48934))); _tmp48941 ++ {
      _arg = (*_tmp48934)[_tmp48941]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp49601 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp49601))); _i ++ {
      _argdef = (*_tmp49601)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp49960 := _args;
    for _tmp49967 := uint(0); _tmp49967 < uint(len((*_tmp49960))); _tmp49967 ++ {
      _arg = (*_tmp49960)[_tmp49967]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp56566 := _argtypes;
  for _tmp56573 := uint(0); _tmp56573 < uint(len((*_tmp56566))); _tmp56573 ++ {
    _v = (*_tmp56566)[_tmp56573]
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp59098 := _c._arr;
  for _tmp59105 := uint(0); _tmp59105 < uint(len((*_tmp59098))); _tmp59105 ++ {
    _v = (*_tmp59098)[_tmp59105]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp60463 := _types;
  for _tmp60470 := uint(0); _tmp60470 < uint(len((*_tmp60463))); _tmp60470 ++ {
    _v = (*_tmp60463)[_tmp60470]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_Path_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp63724 := _arr;
    for _tmp63731 := uint(0); _tmp63731 < uint(len((*_tmp63724))); _tmp63731 ++ {
      _v = (*_tmp63724)[_tmp63731]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp66383 := _scope._arr;
  for _tmp66390 := uint(0); _tmp66390 < uint(len((*_tmp66383))); _tmp66390 ++ {
    _v = (*_tmp66383)[_tmp66390]
...
func subMethodGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp68067 := _v._arr;
  for _tmp68074 := uint(0); _tmp68074 < uint(len((*_tmp68067))); _tmp68074 ++ {
    _vv = (*_tmp68067)[_tmp68074]
...
func methodGetx(_scope *Cptx, _func *Cptx) *Cptx{
  ...
  _p = _o._arr
  _tmp68684 := _p;
  for _tmp68691 := uint(0); _tmp68691 < uint(len((*_tmp68684))); _tmp68691 ++ {
    _v = (*_tmp68684)[_tmp68691]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp71420 := _c._arr;
  for _tmp71427 := uint(0); _tmp71427 < uint(len((*_tmp71420))); _tmp71427 ++ {
    _v = (*_tmp71420)[_tmp71427]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp72121 := _o._arr;
  for _tmp72128 := uint(0); _tmp72128 < uint(len((*_tmp72121))); _tmp72128 ++ {
    _v = (*_tmp72121)[_tmp72128]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(len((*_a)) > 1){
    _s += "\n"
    _tmp86152 := _a;
    for _tmp86159 := uint(0); _tmp86159 < uint(len((*_tmp86152))); _tmp86159 ++ {
      _v = (*_tmp86152)[_tmp86159]
      _s += indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp86366 := _a;
    for _tmp86373 := uint(0); _tmp86373 < uint(len((*_tmp86366))); _tmp86373 ++ {
      _v = (*_tmp86366)[_tmp86373]
      _s += strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp86701 := _d;
  for _tmp86708 := uint(0); _tmp86708 < uint(len((*_tmp86701))); _tmp86708 ++ {
    _v = (*_tmp86701)[_tmp86708]
    if(_v._name != ""){
      _s += _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _nstate._int = 2
  _tmp90044 := _args;
  for _i = uint(0); _i < uint(len((*_tmp90044))); _i ++ {
    _v = (*_tmp90044)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp92087 := _args;
    for _i = uint(0); _i < uint(len((*_tmp92087))); _i ++ {
      _arg = (*_tmp92087)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp94127 := _c._arr;
    for _tmp94134 := uint(0); _tmp94134 < uint(len((*_tmp94127))); _tmp94134 ++ {
      _v = (*_tmp94127)[_tmp94134]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  var _v *Cptx
  _tmp95745 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp95745))); _i ++ {
    _v = (*_tmp95745)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp103029 := _args;
  for _tmp103036 := uint(0); _tmp103036 < uint(len(_tmp103029)); _tmp103036 ++ {
    _arg = _tmp103029[_tmp103036]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp106483 := _parents;
    for _tmp106490 := uint(0); _tmp106490 < uint(len(_tmp106483)); _tmp106490 ++ {
      _e = _tmp106483[_tmp106490]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp110633 := _arr;
  for _i = uint(0); _i < uint(len(_tmp110633)); _i ++ {
    _v = _tmp110633[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp138491 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp138491)); _i ++ {
    _e = _tmp138491[_i]
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp140420 := _ast;
  for _i = uint(0); _i < uint(len(_tmp140420)); _i ++ {
    _e = _tmp140420[_i]
    _ee = _e.([]interface{})
  ...
  _tmp140780 := _ast;
  for _i = uint(0); _i < uint(len(_tmp140780)); _i ++ {
    _e = _tmp140780[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp141700 := _ast;
  for _tmp141707 := uint(0); _tmp141707 < uint(len(_tmp141700)); _tmp141707 ++ {
    _e = _tmp141700[_tmp141707]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp143696 := _asts;
  for _tmp143703 := uint(0); _tmp143703 < uint(len(_tmp143696)); _tmp143703 ++ {
    _e = _tmp143696[_tmp143703]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
    }
  ...
  if(!_callable){
    _tmp144125 := _arrx;
    for _i = uint(0); _i < uint(len((*_tmp144125))); _i ++ {
      _v = (*_tmp144125)[_i]
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp145199 := _asts;
  for _tmp145206 := uint(0); _tmp145206 < uint(len(_tmp145199)); _tmp145206 ++ {
    _eo = _tmp145199[_tmp145206]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func main(){
  ...
  funcDefx(_defmain, "osArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp155509 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp155509))); _i ++ {
        _v = (*_tmp155509)[_i]
        if(_i == 0){
          continue
        }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp176096 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp176103 := uint(0); _tmp176103 < uint(len(_tmp176096)); _tmp176103 ++ {
      _k = _tmp176096[_tmp176103]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp176628 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp176635 := uint(0); _tmp176635 < uint(len(_tmp176628)); _tmp176635 ++ {
      _k = _tmp176628[_tmp176635]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_dicc, _o._dic, _arrx)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp178207 := _xx;
    for _tmp178214 := uint(0); _tmp178214 < uint(len((*_tmp178207))); _tmp178214 ++ {
      _v = (*_tmp178207)[_tmp178214]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp185921 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp185921))); _i ++ {
      _v = (*_tmp185921)[_i]
      if(_i != 0){
        _s += _sep._str
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp204183 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp204183))); _i ++ {
        _v = (*_tmp204183)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp208006 := _da._arr;
      for _tmp208013 := uint(0); _tmp208013 < uint(len((*_tmp208006))); _tmp208013 ++ {
        _kc = (*_tmp208006)[_tmp208013]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
      ...
      _tmp208879 := _da._arr;
      for _i = uint(0); _i < uint(len((*_tmp208879))); _i ++ {
        _v = (*_tmp208879)[_i]
        if(_key != ""){
