...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp38091 := _o;
  for _tmp38094 := uint(0); _tmp38094 < uint(len((*_tmp38091))); _tmp38094 ++ {
    _e = (*_tmp38091)[_tmp38094]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp38559 := _o;
  for _i = uint(0); _i < uint(len(_tmp38559)); _i ++ {
    _e = _tmp38559[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp39327 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp39327))); _i ++ {
    _x = (*_tmp39327)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp40210 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp40213 := uint(0); _tmp40213 < uint(len(_tmp40210)); _tmp40213 ++ {
    _k = _tmp40210[_tmp40213]
    if(_o._dic[_k] == nil){
  ...
  _tmp40649 := _c._arr;
  for _tmp40652 := uint(0); _tmp40652 < uint(len((*_tmp40649))); _tmp40652 ++ {
    _v = (*_tmp40649)[_tmp40652]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp41155 := _parentarr;
    for _tmp41158 := uint(0); _tmp41158 < uint(len((*_tmp41155))); _tmp41158 ++ {
      _e = (*_tmp41155)[_tmp41158]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp43494 := _o._arr;
  for _tmp43497 := uint(0); _tmp43497 < uint(len((*_tmp43494))); _tmp43497 ++ {
    _k = (*_tmp43494)[_tmp43497]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp44246 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp44246))); _i ++ {
      _argdef = (*_tmp44246)[_i]
    ...
    _tmp44595 := _args;
    for _tmp44598 := uint(0); _tmp44598 < uint(len((*_tmp44595))); _tmp44598 ++ {
      _arg = (*_tmp44595)[_tmp44598]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp45145 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp45145))); _i ++ {
      _argdef = (*_tmp45145)[_i]
      if(_i < uint(len((*_args)))){
    ...
    _tmp45437 := _args;
    for _tmp45440 := uint(0); _tmp45440 < uint(len((*_tmp45437))); _tmp45440 ++ {
      _arg = (*_tmp45437)[_tmp45440]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp52032 := _argtypes;
  for _tmp52035 := uint(0); _tmp52035 < uint(len((*_tmp52032))); _tmp52035 ++ {
    _v = (*_tmp52032)[_tmp52035]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp53926 := _x._arr;
  for _tmp53929 := uint(0); _tmp53929 < uint(len((*_tmp53926))); _tmp53929 ++ {
    _v = (*_tmp53926)[_tmp53929]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp54900 := _c._arr;
  for _tmp54903 := uint(0); _tmp54903 < uint(len((*_tmp54900))); _tmp54903 ++ {
    _v = (*_tmp54900)[_tmp54903]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp56679 := _types;
  for _tmp56682 := uint(0); _tmp56682 < uint(len((*_tmp56679))); _tmp56682 ++ {
    _v = (*_tmp56679)[_tmp56682]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp59747 := _arr;
    for _tmp59750 := uint(0); _tmp59750 < uint(len((*_tmp59747))); _tmp59750 ++ {
      _v = (*_tmp59747)[_tmp59750]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp62450 := _scope._arr;
  for _tmp62453 := uint(0); _tmp62453 < uint(len((*_tmp62450))); _tmp62453 ++ {
    _v = (*_tmp62450)[_tmp62453]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp64114 := _v._arr;
  for _tmp64117 := uint(0); _tmp64117 < uint(len((*_tmp64114))); _tmp64117 ++ {
    _vv = (*_tmp64114)[_tmp64117]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp64971 := _p;
  for _tmp64974 := uint(0); _tmp64974 < uint(len((*_tmp64971))); _tmp64974 ++ {
    _v = (*_tmp64971)[_tmp64974]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp67352 := _c._arr;
  for _tmp67355 := uint(0); _tmp67355 < uint(len((*_tmp67352))); _tmp67355 ++ {
    _v = (*_tmp67352)[_tmp67355]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp67962 := _o._arr;
  for _tmp67965 := uint(0); _tmp67965 < uint(len((*_tmp67962))); _tmp67965 ++ {
    _v = (*_tmp67962)[_tmp67965]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp82792 := _a;
    for _tmp82795 := uint(0); _tmp82795 < uint(len((*_tmp82792))); _tmp82795 ++ {
      _v = (*_tmp82792)[_tmp82795]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp82995 := _a;
    for _tmp82998 := uint(0); _tmp82998 < uint(len((*_tmp82995))); _tmp82998 ++ {
      _v = (*_tmp82995)[_tmp82998]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp83265 := _d;
  for _tmp83268 := uint(0); _tmp83268 < uint(len((*_tmp83265))); _tmp83268 ++ {
    _v = (*_tmp83265)[_tmp83268]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _tmp86568 := _args;
  for _i = uint(0); _i < uint(len((*_tmp86568))); _i ++ {
    _v = (*_tmp86568)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp89329 := _args;
    for _i = uint(0); _i < uint(len((*_tmp89329))); _i ++ {
      _arg = (*_tmp89329)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp91226 := _c._arr;
    for _tmp91229 := uint(0); _tmp91229 < uint(len((*_tmp91226))); _tmp91229 ++ {
      _v = (*_tmp91226)[_tmp91229]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp92659 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp92659))); _i ++ {
    _v = (*_tmp92659)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp98343 := _env._dic["envStack"]._arr;
  for _tmp98346 := uint(0); _tmp98346 < uint(len((*_tmp98343))); _tmp98346 ++ {
    _v = (*_tmp98343)[_tmp98346]
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp101291 := _args;
  for _tmp101294 := uint(0); _tmp101294 < uint(len(_tmp101291)); _tmp101294 ++ {
    _arg = _tmp101291[_tmp101294]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp104832 := _parents;
    for _tmp104835 := uint(0); _tmp104835 < uint(len(_tmp104832)); _tmp104835 ++ {
      _e = _tmp104832[_tmp104835]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp108514 := _arr;
  for _i = uint(0); _i < uint(len(_tmp108514)); _i ++ {
    _v = _tmp108514[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp130290 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp130290)); _i ++ {
    _e = _tmp130290[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp131896 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp131896)); _i ++ {
    _e = _tmp131896[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp132743 := _ast;
  for _i = uint(0); _i < uint(len(_tmp132743)); _i ++ {
    _e = _tmp132743[_i]
    _ee = _e.([]interface{})
  ...
  _tmp133067 := _ast;
  for _i = uint(0); _i < uint(len(_tmp133067)); _i ++ {
    _e = _tmp133067[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp133856 := _ast;
  for _tmp133859 := uint(0); _tmp133859 < uint(len(_tmp133856)); _tmp133859 ++ {
    _e = _tmp133856[_tmp133859]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp135842 := _asts;
  for _i = uint(0); _i < uint(len(_tmp135842)); _i ++ {
    _e = _tmp135842[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp136228 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp136228)); _i ++ {
      _v = _tmp136228[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp137115 := _asts;
  for _tmp137118 := uint(0); _tmp137118 < uint(len(_tmp137115)); _tmp137118 ++ {
    _eo = _tmp137115[_tmp137118]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func main(){
  ...
  _handlerc = fpDefx(&[]*Cptx{defx(_reqc, nil), defx(_respc, nil)}, nil)
  ...
  funcDefx(_defmain, "send", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _tmp153782 := _arr;
    for _tmp153785 := uint(0); _tmp153785 < uint(len((*_tmp153782))); _tmp153785 ++ {
      _v = (*_tmp153782)[_tmp153785]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp166417 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp166420 := uint(0); _tmp166420 < uint(len(_tmp166417)); _tmp166420 ++ {
      _k = _tmp166417[_tmp166420]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp167594 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp167597 := uint(0); _tmp167597 < uint(len(_tmp167594)); _tmp167597 ++ {
      _k = _tmp167594[_tmp167597]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp173099 := _xx;
    for _tmp173102 := uint(0); _tmp173102 < uint(len((*_tmp173099))); _tmp173102 ++ {
      _v = (*_tmp173099)[_tmp173102]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp179062 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp179062))); _i ++ {
      _v = (*_tmp179062)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp191300 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp191300))); _i ++ {
        _v = (*_tmp191300)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp193031 := _c._arr;
    for _tmp193034 := uint(0); _tmp193034 < uint(len((*_tmp193031))); _tmp193034 ++ {
      _v = (*_tmp193031)[_tmp193034]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp195713 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp195713))); _i ++ {
        _v = (*_tmp195713)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp199123 := _da._arr;
      for _tmp199126 := uint(0); _tmp199126 < uint(len((*_tmp199123))); _tmp199126 ++ {
        _kc = (*_tmp199123)[_tmp199126]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
