...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp44648 := _o;
  for _tmp44651 := uint(0); _tmp44651 < uint(len((*_tmp44648))); _tmp44651 ++ {
    _e = (*_tmp44648)[_tmp44651]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp45196 := _o;
  for _i = uint(0); _i < uint(len(_tmp45196)); _i ++ {
    _e = _tmp45196[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp46129 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp46129))); _i ++ {
    _x = (*_tmp46129)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp47194 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp47197 := uint(0); _tmp47197 < uint(len(_tmp47194)); _tmp47197 ++ {
    _k = _tmp47194[_tmp47197]
    if(_o._dic[_k] == nil){
  ...
  _tmp47701 := _c._arr;
  for _tmp47704 := uint(0); _tmp47704 < uint(len((*_tmp47701))); _tmp47704 ++ {
    _v = (*_tmp47701)[_tmp47704]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp48308 := _parentarr;
    for _tmp48311 := uint(0); _tmp48311 < uint(len((*_tmp48308))); _tmp48311 ++ {
      _e = (*_tmp48308)[_tmp48311]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp52195 := _o._arr;
  for _tmp52198 := uint(0); _tmp52198 < uint(len((*_tmp52195))); _tmp52198 ++ {
    _k = (*_tmp52195)[_tmp52198]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(inClassx(classx(_f), _funcvarsc, nil)){
    ...
    _tmp53073 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp53073))); _i ++ {
      _argdef = (*_tmp53073)[_i]
    ...
    _tmp53476 := _args;
    for _tmp53479 := uint(0); _tmp53479 < uint(len((*_tmp53476))); _tmp53479 ++ {
      _arg = (*_tmp53476)[_tmp53479]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp61409 := _argtypes;
  for _tmp61412 := uint(0); _tmp61412 < uint(len((*_tmp61409))); _tmp61412 ++ {
    _v = (*_tmp61409)[_tmp61412]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp63645 := _x._arr;
  for _tmp63648 := uint(0); _tmp63648 < uint(len((*_tmp63645))); _tmp63648 ++ {
    _v = (*_tmp63645)[_tmp63648]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp64811 := _c._arr;
  for _tmp64814 := uint(0); _tmp64814 < uint(len((*_tmp64811))); _tmp64814 ++ {
    _v = (*_tmp64811)[_tmp64814]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp66919 := _types;
  for _tmp66922 := uint(0); _tmp66922 < uint(len((*_tmp66919))); _tmp66922 ++ {
    _v = (*_tmp66919)[_tmp66922]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp70485 := _arr;
    for _tmp70488 := uint(0); _tmp70488 < uint(len((*_tmp70485))); _tmp70488 ++ {
      _v = (*_tmp70485)[_tmp70488]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp73822 := _scope._arr;
  for _tmp73825 := uint(0); _tmp73825 < uint(len((*_tmp73822))); _tmp73825 ++ {
    _v = (*_tmp73822)[_tmp73825]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp75786 := _v._arr;
  for _tmp75789 := uint(0); _tmp75789 < uint(len((*_tmp75786))); _tmp75789 ++ {
    _vv = (*_tmp75786)[_tmp75789]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp76874 := _p;
  for _tmp76877 := uint(0); _tmp76877 < uint(len((*_tmp76874))); _tmp76877 ++ {
    _v = (*_tmp76874)[_tmp76877]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp79668 := _c._arr;
  for _tmp79671 := uint(0); _tmp79671 < uint(len((*_tmp79668))); _tmp79671 ++ {
    _v = (*_tmp79668)[_tmp79671]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp80391 := _o._arr;
  for _tmp80394 := uint(0); _tmp80394 < uint(len((*_tmp80391))); _tmp80394 ++ {
    _v = (*_tmp80391)[_tmp80394]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp98512 := _a;
    for _tmp98515 := uint(0); _tmp98515 < uint(len((*_tmp98512))); _tmp98515 ++ {
      _v = (*_tmp98512)[_tmp98515]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp98747 := _a;
    for _tmp98750 := uint(0); _tmp98750 < uint(len((*_tmp98747))); _tmp98750 ++ {
      _v = (*_tmp98747)[_tmp98750]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp99072 := _d;
  for _tmp99075 := uint(0); _tmp99075 < uint(len((*_tmp99072))); _tmp99075 ++ {
    _v = (*_tmp99072)[_tmp99075]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp109241 := _c._arr;
    for _tmp109244 := uint(0); _tmp109244 < uint(len((*_tmp109241))); _tmp109244 ++ {
      _v = (*_tmp109241)[_tmp109244]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp110931 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp110931))); _i ++ {
    _v = (*_tmp110931)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp117883 := _env._dic["envStack"]._arr;
  for _tmp117886 := uint(0); _tmp117886 < uint(len((*_tmp117883))); _tmp117886 ++ {
    _v = (*_tmp117883)[_tmp117886]
...
func id2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    ...
    if(_varts != nil){
      _tmp119157 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp119157))); _i ++ {
        _stro = (*_tmp119157)[_i]
        if(_id == _stro._str){
...
func idlocal2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    _varts = getx(_func, "funcVars")
    if(_varts != nil){
      _tmp122077 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp122077))); _i ++ {
        _stro = (*_tmp122077)[_i]
        if(_id == _stro._str){
          _r = idNewx(_local, _stro._str, _idargc)
          _r._int = int(_i)
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp125067 := _args;
  for _tmp125070 := uint(0); _tmp125070 < uint(len(_tmp125067)); _tmp125070 ++ {
    _arg = _tmp125067[_tmp125070]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    _arr = &[]*Cptx{}
    _tmp130886 := _parents;
    for _tmp130889 := uint(0); _tmp130889 < uint(len(_tmp130886)); _tmp130889 ++ {
      _e = _tmp130886[_tmp130889]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp135245 := _arr;
  for _i = uint(0); _i < uint(len(_tmp135245)); _i ++ {
    _v = _tmp135245[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp162280 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp162280)); _i ++ {
    _e = _tmp162280[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp164193 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp164193)); _i ++ {
    _e = _tmp164193[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp165266 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165266)); _i ++ {
    _e = _tmp165266[_i]
    _ee = _e.([]interface{})
  ...
  _tmp165651 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165651)); _i ++ {
    _e = _tmp165651[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp166036 := _ast;
  for _i = uint(0); _i < uint(len(_tmp166036)); _i ++ {
    _e = _tmp166036[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp166969 := _ast;
  for _tmp166972 := uint(0); _tmp166972 < uint(len(_tmp166969)); _tmp166972 ++ {
    _e = _tmp166969[_tmp166972]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp169160 := _asts;
  for _i = uint(0); _i < uint(len(_tmp169160)); _i ++ {
    _e = _tmp169160[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp169614 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp169614)); _i ++ {
      _v = _tmp169614[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp170659 := _asts;
  for _tmp170662 := uint(0); _tmp170662 < uint(len(_tmp170659)); _tmp170662 ++ {
    _eo = _tmp170659[_tmp170662]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp172267 := _asts;
  for _tmp172270 := uint(0); _tmp172270 < uint(len(_tmp172267)); _tmp172270 ++ {
    _eo = _tmp172267[_tmp172270]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func main(){
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp206493 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp206496 := uint(0); _tmp206496 < uint(len(_tmp206493)); _tmp206496 ++ {
      _k = _tmp206493[_tmp206496]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp207910 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp207913 := uint(0); _tmp207913 < uint(len(_tmp207910)); _tmp207913 ++ {
      _k = _tmp207910[_tmp207913]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp214498 := _xx;
    for _tmp214501 := uint(0); _tmp214501 < uint(len((*_tmp214498))); _tmp214501 ++ {
      _v = (*_tmp214498)[_tmp214501]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp221685 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp221685))); _i ++ {
      _v = (*_tmp221685)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp238487 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp238487))); _i ++ {
        _v = (*_tmp238487)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp240551 := _c._arr;
    for _tmp240554 := uint(0); _tmp240554 < uint(len((*_tmp240551))); _tmp240554 ++ {
      _v = (*_tmp240551)[_tmp240554]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp243263 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp243263))); _i ++ {
        _v = (*_tmp243263)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp248196 := _da._arr;
      for _tmp248199 := uint(0); _tmp248199 < uint(len((*_tmp248196))); _tmp248199 ++ {
        _kc = (*_tmp248196)[_tmp248199]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
