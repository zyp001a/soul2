...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp40556 := _o;
  for _tmp40559 := uint(0); _tmp40559 < uint(len((*_tmp40556))); _tmp40559 ++ {
    _e = (*_tmp40556)[_tmp40559]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp41067 := _o;
  for _i = uint(0); _i < uint(len(_tmp41067)); _i ++ {
    _e = _tmp41067[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp41860 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp41860))); _i ++ {
    _x = (*_tmp41860)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp42772 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp42775 := uint(0); _tmp42775 < uint(len(_tmp42772)); _tmp42775 ++ {
    _k = _tmp42772[_tmp42775]
    if(_o._dic[_k] == nil){
  ...
  _tmp43240 := _c._arr;
  for _tmp43243 := uint(0); _tmp43243 < uint(len((*_tmp43240))); _tmp43243 ++ {
    _v = (*_tmp43240)[_tmp43243]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp43746 := _parentarr;
    for _tmp43749 := uint(0); _tmp43749 < uint(len((*_tmp43746))); _tmp43749 ++ {
      _e = (*_tmp43746)[_tmp43749]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp46115 := _o._arr;
  for _tmp46118 := uint(0); _tmp46118 < uint(len((*_tmp46115))); _tmp46118 ++ {
    _k = (*_tmp46115)[_tmp46118]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp46872 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp46872))); _i ++ {
      _argdef = (*_tmp46872)[_i]
    ...
    _tmp47228 := _args;
    for _tmp47231 := uint(0); _tmp47231 < uint(len((*_tmp47228))); _tmp47231 ++ {
      _arg = (*_tmp47228)[_tmp47231]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp47778 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp47778))); _i ++ {
      _argdef = (*_tmp47778)[_i]
      if(_i < uint(len((*_args)))){
    ...
    _tmp48070 := _args;
    for _tmp48073 := uint(0); _tmp48073 < uint(len((*_tmp48070))); _tmp48073 ++ {
      _arg = (*_tmp48070)[_tmp48073]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp54817 := _argtypes;
  for _tmp54820 := uint(0); _tmp54820 < uint(len((*_tmp54817))); _tmp54820 ++ {
    _v = (*_tmp54817)[_tmp54820]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp56677 := _x._arr;
  for _tmp56680 := uint(0); _tmp56680 < uint(len((*_tmp56677))); _tmp56680 ++ {
    _v = (*_tmp56677)[_tmp56680]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp57651 := _c._arr;
  for _tmp57654 := uint(0); _tmp57654 < uint(len((*_tmp57651))); _tmp57654 ++ {
    _v = (*_tmp57651)[_tmp57654]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp59437 := _types;
  for _tmp59440 := uint(0); _tmp59440 < uint(len((*_tmp59437))); _tmp59440 ++ {
    _v = (*_tmp59437)[_tmp59440]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp62562 := _arr;
    for _tmp62565 := uint(0); _tmp62565 < uint(len((*_tmp62562))); _tmp62565 ++ {
      _v = (*_tmp62562)[_tmp62565]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp65339 := _scope._arr;
  for _tmp65342 := uint(0); _tmp65342 < uint(len((*_tmp65339))); _tmp65342 ++ {
    _v = (*_tmp65339)[_tmp65342]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp66804 := _v._arr;
  for _tmp66807 := uint(0); _tmp66807 < uint(len((*_tmp66804))); _tmp66807 ++ {
    _vv = (*_tmp66804)[_tmp66807]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp67661 := _p;
  for _tmp67664 := uint(0); _tmp67664 < uint(len((*_tmp67661))); _tmp67664 ++ {
    _v = (*_tmp67661)[_tmp67664]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp70042 := _c._arr;
  for _tmp70045 := uint(0); _tmp70045 < uint(len((*_tmp70042))); _tmp70045 ++ {
    _v = (*_tmp70042)[_tmp70045]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp70652 := _o._arr;
  for _tmp70655 := uint(0); _tmp70655 < uint(len((*_tmp70652))); _tmp70655 ++ {
    _v = (*_tmp70652)[_tmp70655]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp85418 := _a;
    for _tmp85421 := uint(0); _tmp85421 < uint(len((*_tmp85418))); _tmp85421 ++ {
      _v = (*_tmp85418)[_tmp85421]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp85621 := _a;
    for _tmp85624 := uint(0); _tmp85624 < uint(len((*_tmp85621))); _tmp85624 ++ {
      _v = (*_tmp85621)[_tmp85624]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp85891 := _d;
  for _tmp85894 := uint(0); _tmp85894 < uint(len((*_tmp85891))); _tmp85894 ++ {
    _v = (*_tmp85891)[_tmp85894]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _tmp89184 := _args;
  for _i = uint(0); _i < uint(len((*_tmp89184))); _i ++ {
    _v = (*_tmp89184)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp91978 := _args;
    for _i = uint(0); _i < uint(len((*_tmp91978))); _i ++ {
      _arg = (*_tmp91978)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp93875 := _c._arr;
    for _tmp93878 := uint(0); _tmp93878 < uint(len((*_tmp93875))); _tmp93878 ++ {
      _v = (*_tmp93875)[_tmp93878]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp95308 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp95308))); _i ++ {
    _v = (*_tmp95308)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp100877 := _env._dic["envStack"]._arr;
  for _tmp100880 := uint(0); _tmp100880 < uint(len((*_tmp100877))); _tmp100880 ++ {
    _v = (*_tmp100877)[_tmp100880]
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp103795 := _args;
  for _tmp103798 := uint(0); _tmp103798 < uint(len(_tmp103795)); _tmp103798 ++ {
    _arg = _tmp103795[_tmp103798]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp107336 := _parents;
    for _tmp107339 := uint(0); _tmp107339 < uint(len(_tmp107336)); _tmp107339 ++ {
      _e = _tmp107336[_tmp107339]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp111018 := _arr;
  for _i = uint(0); _i < uint(len(_tmp111018)); _i ++ {
    _v = _tmp111018[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp132645 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp132645)); _i ++ {
    _e = _tmp132645[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp134251 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp134251)); _i ++ {
    _e = _tmp134251[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp135103 := _ast;
  for _i = uint(0); _i < uint(len(_tmp135103)); _i ++ {
    _e = _tmp135103[_i]
    _ee = _e.([]interface{})
  ...
  _tmp135427 := _ast;
  for _i = uint(0); _i < uint(len(_tmp135427)); _i ++ {
    _e = _tmp135427[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp136216 := _ast;
  for _tmp136219 := uint(0); _tmp136219 < uint(len(_tmp136216)); _tmp136219 ++ {
    _e = _tmp136216[_tmp136219]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp138202 := _asts;
  for _i = uint(0); _i < uint(len(_tmp138202)); _i ++ {
    _e = _tmp138202[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp138588 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp138588)); _i ++ {
      _v = _tmp138588[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp139475 := _asts;
  for _tmp139478 := uint(0); _tmp139478 < uint(len(_tmp139475)); _tmp139478 ++ {
    _eo = _tmp139475[_tmp139478]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func main(){
  ...
  funcDefx(_defmain, "send", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _tmp156067 := _arr;
    for _tmp156070 := uint(0); _tmp156070 < uint(len((*_tmp156067))); _tmp156070 ++ {
      _v = (*_tmp156067)[_tmp156070]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp169020 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp169023 := uint(0); _tmp169023 < uint(len(_tmp169020)); _tmp169023 ++ {
      _k = _tmp169020[_tmp169023]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp169893 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp169896 := uint(0); _tmp169896 < uint(len(_tmp169893)); _tmp169896 ++ {
      _k = _tmp169893[_tmp169896]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp175433 := _xx;
    for _tmp175436 := uint(0); _tmp175436 < uint(len((*_tmp175433))); _tmp175436 ++ {
      _v = (*_tmp175433)[_tmp175436]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp181396 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp181396))); _i ++ {
      _v = (*_tmp181396)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp191033 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp191033))); _i ++ {
        _v = (*_tmp191033)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp192764 := _c._arr;
    for _tmp192767 := uint(0); _tmp192767 < uint(len((*_tmp192764))); _tmp192767 ++ {
      _v = (*_tmp192764)[_tmp192767]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp195446 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp195446))); _i ++ {
        _v = (*_tmp195446)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp198859 := _da._arr;
      for _tmp198862 := uint(0); _tmp198862 < uint(len((*_tmp198859))); _tmp198862 ++ {
        _kc = (*_tmp198859)[_tmp198862]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
