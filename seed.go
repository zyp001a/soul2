...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp44622 := _o;
  for _tmp44625 := uint(0); _tmp44625 < uint(len((*_tmp44622))); _tmp44625 ++ {
    _e = (*_tmp44622)[_tmp44625]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp45167 := _o;
  for _i = uint(0); _i < uint(len(_tmp45167)); _i ++ {
    _e = _tmp45167[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp46099 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp46099))); _i ++ {
    _x = (*_tmp46099)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp47164 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp47167 := uint(0); _tmp47167 < uint(len(_tmp47164)); _tmp47167 ++ {
    _k = _tmp47164[_tmp47167]
    if(_o._dic[_k] == nil){
  ...
  _tmp47670 := _c._arr;
  for _tmp47673 := uint(0); _tmp47673 < uint(len((*_tmp47670))); _tmp47673 ++ {
    _v = (*_tmp47670)[_tmp47673]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp48277 := _parentarr;
    for _tmp48280 := uint(0); _tmp48280 < uint(len((*_tmp48277))); _tmp48280 ++ {
      _e = (*_tmp48277)[_tmp48280]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp52163 := _o._arr;
  for _tmp52166 := uint(0); _tmp52166 < uint(len((*_tmp52163))); _tmp52166 ++ {
    _k = (*_tmp52163)[_tmp52166]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(inClassx(classx(_f), _funcvarsc, nil)){
    ...
    _tmp53041 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp53041))); _i ++ {
      _argdef = (*_tmp53041)[_i]
    ...
    _tmp53444 := _args;
    for _tmp53447 := uint(0); _tmp53447 < uint(len((*_tmp53444))); _tmp53447 ++ {
      _arg = (*_tmp53444)[_tmp53447]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp61376 := _argtypes;
  for _tmp61379 := uint(0); _tmp61379 < uint(len((*_tmp61376))); _tmp61379 ++ {
    _v = (*_tmp61376)[_tmp61379]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp63612 := _x._arr;
  for _tmp63615 := uint(0); _tmp63615 < uint(len((*_tmp63612))); _tmp63615 ++ {
    _v = (*_tmp63612)[_tmp63615]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp64778 := _c._arr;
  for _tmp64781 := uint(0); _tmp64781 < uint(len((*_tmp64778))); _tmp64781 ++ {
    _v = (*_tmp64778)[_tmp64781]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp66946 := _types;
  for _tmp66949 := uint(0); _tmp66949 < uint(len((*_tmp66946))); _tmp66949 ++ {
    _v = (*_tmp66946)[_tmp66949]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp70507 := _arr;
    for _tmp70510 := uint(0); _tmp70510 < uint(len((*_tmp70507))); _tmp70510 ++ {
      _v = (*_tmp70507)[_tmp70510]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp73840 := _scope._arr;
  for _tmp73843 := uint(0); _tmp73843 < uint(len((*_tmp73840))); _tmp73843 ++ {
    _v = (*_tmp73840)[_tmp73843]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp75804 := _v._arr;
  for _tmp75807 := uint(0); _tmp75807 < uint(len((*_tmp75804))); _tmp75807 ++ {
    _vv = (*_tmp75804)[_tmp75807]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp76892 := _p;
  for _tmp76895 := uint(0); _tmp76895 < uint(len((*_tmp76892))); _tmp76895 ++ {
    _v = (*_tmp76892)[_tmp76895]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp79686 := _c._arr;
  for _tmp79689 := uint(0); _tmp79689 < uint(len((*_tmp79686))); _tmp79689 ++ {
    _v = (*_tmp79686)[_tmp79689]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp80409 := _o._arr;
  for _tmp80412 := uint(0); _tmp80412 < uint(len((*_tmp80409))); _tmp80412 ++ {
    _v = (*_tmp80409)[_tmp80412]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp98530 := _a;
    for _tmp98533 := uint(0); _tmp98533 < uint(len((*_tmp98530))); _tmp98533 ++ {
      _v = (*_tmp98530)[_tmp98533]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp98765 := _a;
    for _tmp98768 := uint(0); _tmp98768 < uint(len((*_tmp98765))); _tmp98768 ++ {
      _v = (*_tmp98765)[_tmp98768]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp99090 := _d;
  for _tmp99093 := uint(0); _tmp99093 < uint(len((*_tmp99090))); _tmp99093 ++ {
    _v = (*_tmp99090)[_tmp99093]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp109258 := _c._arr;
    for _tmp109261 := uint(0); _tmp109261 < uint(len((*_tmp109258))); _tmp109261 ++ {
      _v = (*_tmp109258)[_tmp109261]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp110948 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp110948))); _i ++ {
    _v = (*_tmp110948)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp117899 := _env._dic["envStack"]._arr;
  for _tmp117902 := uint(0); _tmp117902 < uint(len((*_tmp117899))); _tmp117902 ++ {
    _v = (*_tmp117899)[_tmp117902]
...
func id2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    ...
    if(_varts != nil){
      _tmp119173 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp119173))); _i ++ {
        _stro = (*_tmp119173)[_i]
        if(_id == _stro._str){
...
func idlocal2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    _varts = getx(_func, "funcVars")
    if(_varts != nil){
      _tmp122092 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp122092))); _i ++ {
        _stro = (*_tmp122092)[_i]
        if(_id == _stro._str){
          _r = idNewx(_local, _stro._str, _idargc)
          _r._int = int(_i)
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp125082 := _args;
  for _tmp125085 := uint(0); _tmp125085 < uint(len(_tmp125082)); _tmp125085 ++ {
    _arg = _tmp125082[_tmp125085]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    _arr = &[]*Cptx{}
    _tmp130901 := _parents;
    for _tmp130904 := uint(0); _tmp130904 < uint(len(_tmp130901)); _tmp130904 ++ {
      _e = _tmp130901[_tmp130904]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp135260 := _arr;
  for _i = uint(0); _i < uint(len(_tmp135260)); _i ++ {
    _v = _tmp135260[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp162294 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp162294)); _i ++ {
    _e = _tmp162294[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp164207 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp164207)); _i ++ {
    _e = _tmp164207[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp165280 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165280)); _i ++ {
    _e = _tmp165280[_i]
    _ee = _e.([]interface{})
  ...
  _tmp165665 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165665)); _i ++ {
    _e = _tmp165665[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp166050 := _ast;
  for _i = uint(0); _i < uint(len(_tmp166050)); _i ++ {
    _e = _tmp166050[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp166983 := _ast;
  for _tmp166986 := uint(0); _tmp166986 < uint(len(_tmp166983)); _tmp166986 ++ {
    _e = _tmp166983[_tmp166986]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp169174 := _asts;
  for _i = uint(0); _i < uint(len(_tmp169174)); _i ++ {
    _e = _tmp169174[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp169628 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp169628)); _i ++ {
      _v = _tmp169628[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp170673 := _asts;
  for _tmp170676 := uint(0); _tmp170676 < uint(len(_tmp170673)); _tmp170676 ++ {
    _eo = _tmp170673[_tmp170676]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp172281 := _asts;
  for _tmp172284 := uint(0); _tmp172284 < uint(len(_tmp172281)); _tmp172284 ++ {
    _eo = _tmp172281[_tmp172284]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func main(){
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp206506 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp206509 := uint(0); _tmp206509 < uint(len(_tmp206506)); _tmp206509 ++ {
      _k = _tmp206506[_tmp206509]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp207923 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp207926 := uint(0); _tmp207926 < uint(len(_tmp207923)); _tmp207926 ++ {
      _k = _tmp207923[_tmp207926]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp214511 := _xx;
    for _tmp214514 := uint(0); _tmp214514 < uint(len((*_tmp214511))); _tmp214514 ++ {
      _v = (*_tmp214511)[_tmp214514]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp221698 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp221698))); _i ++ {
      _v = (*_tmp221698)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp238493 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp238493))); _i ++ {
        _v = (*_tmp238493)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp240557 := _c._arr;
    for _tmp240560 := uint(0); _tmp240560 < uint(len((*_tmp240557))); _tmp240560 ++ {
      _v = (*_tmp240557)[_tmp240560]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp243269 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp243269))); _i ++ {
        _v = (*_tmp243269)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp248202 := _da._arr;
      for _tmp248205 := uint(0); _tmp248205 < uint(len((*_tmp248202))); _tmp248205 ++ {
        _kc = (*_tmp248202)[_tmp248205]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
