...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp42384 := _o;
  for _tmp42391 := uint(0); _tmp42391 < uint(len((*_tmp42384))); _tmp42391 ++ {
    _e = (*_tmp42384)[_tmp42391]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp43241 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp43241))); _i ++ {
    _x = (*_tmp43241)[_i]
    if(_i != 0 && _x != ""){
      _r += "\n"
      _r += __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp44943 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp44950 := uint(0); _tmp44950 < uint(len((*_tmp44943))); _tmp44950 ++ {
    _k = (*_tmp44943)[_tmp44950]
    if(_o._dic[_k] == nil){
  ...
  _tmp45425 := _c._arr;
  for _tmp45432 := uint(0); _tmp45432 < uint(len((*_tmp45425))); _tmp45432 ++ {
    _v = (*_tmp45425)[_tmp45432]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp46011 := _parentarr;
    for _tmp46018 := uint(0); _tmp46018 < uint(len((*_tmp46011))); _tmp46018 ++ {
      _e = (*_tmp46011)[_tmp46018]
      if(_e._id == ""){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp48771 := _o._arr;
  for _tmp48778 := uint(0); _tmp48778 < uint(len((*_tmp48771))); _tmp48778 ++ {
    _k = (*_tmp48771)[_tmp48778]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp49599 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp49599))); _i ++ {
      _argdef = (*_tmp49599)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp50049 := _args;
    for _tmp50056 := uint(0); _tmp50056 < uint(len((*_tmp50049))); _tmp50056 ++ {
      _arg = (*_tmp50049)[_tmp50056]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp50696 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp50696))); _i ++ {
      _argdef = (*_tmp50696)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp51040 := _args;
    for _tmp51047 := uint(0); _tmp51047 < uint(len((*_tmp51040))); _tmp51047 ++ {
      _arg = (*_tmp51040)[_tmp51047]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp57230 := _argtypes;
  for _tmp57237 := uint(0); _tmp57237 < uint(len((*_tmp57230))); _tmp57237 ++ {
    _v = (*_tmp57230)[_tmp57237]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp60440 := _types;
  for _tmp60447 := uint(0); _tmp60447 < uint(len((*_tmp60440))); _tmp60447 ++ {
    _v = (*_tmp60440)[_tmp60447]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_Path_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp63627 := _arr;
    for _tmp63634 := uint(0); _tmp63634 < uint(len((*_tmp63627))); _tmp63634 ++ {
      _v = (*_tmp63627)[_tmp63634]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp66233 := _scope._arr;
  for _tmp66240 := uint(0); _tmp66240 < uint(len((*_tmp66233))); _tmp66240 ++ {
    _v = (*_tmp66233)[_tmp66240]
    _k = _v._id
    if(_cache[_k] != nil){
      continue
    }
...
func subMethodGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp67818 := _v._arr;
  for _tmp67825 := uint(0); _tmp67825 < uint(len((*_tmp67818))); _tmp67825 ++ {
    _vv = (*_tmp67818)[_tmp67825]
...
func methodGetx(_scope *Cptx, _func *Cptx) *Cptx{
  ...
  _p = _o._arr
  _tmp68409 := _p;
  for _tmp68416 := uint(0); _tmp68416 < uint(len((*_tmp68409))); _tmp68416 ++ {
    _v = (*_tmp68409)[_tmp68416]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp71081 := _c._arr;
  for _tmp71088 := uint(0); _tmp71088 < uint(len((*_tmp71081))); _tmp71088 ++ {
    _v = (*_tmp71081)[_tmp71088]
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp71713 := _o._arr;
  for _tmp71720 := uint(0); _tmp71720 < uint(len((*_tmp71713))); _tmp71720 ++ {
    _v = (*_tmp71713)[_tmp71720]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(len((*_a)) > 1){
    _s += "\n"
    _tmp84375 := _a;
    for _tmp84382 := uint(0); _tmp84382 < uint(len((*_tmp84375))); _tmp84382 ++ {
      _v = (*_tmp84375)[_tmp84382]
      _s += indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp84583 := _a;
    for _tmp84590 := uint(0); _tmp84590 < uint(len((*_tmp84583))); _tmp84590 ++ {
      _v = (*_tmp84583)[_tmp84590]
      _s += strx(_v, _i + 1)
    }
  }
  return _s + "]"
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp84921 := _d;
  for _tmp84928 := uint(0); _tmp84928 < uint(len((*_tmp84921))); _tmp84928 ++ {
    _v = (*_tmp84921)[_tmp84928]
    if(_v._name != ""){
      _s += _v._name + " "
    }else{
      _s += "~" + _v._id + " "
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _nstate._int = 2
  _tmp87988 := _args;
  for _i = uint(0); _i < uint(len((*_tmp87988))); _i ++ {
    _v = (*_tmp87988)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp89993 := _args;
    for _i = uint(0); _i < uint(len((*_tmp89993))); _i ++ {
      _arg = (*_tmp89993)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp91954 := _c._arr;
    for _tmp91961 := uint(0); _tmp91961 < uint(len((*_tmp91954))); _tmp91961 ++ {
      _v = (*_tmp91954)[_tmp91961]
      if(_cache[_v._id] != nil){
        return nil
      }
      _cache[_v._id] = 1
...
func blockExecx(_o *Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _b = _o._dic["blockVal"]
  _tmp93289 := _b._arr;
  for _i = uint(0); _i < uint(len((*_tmp93289))); _i ++ {
    _v = (*_tmp93289)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp97862 := _args;
  for _tmp97869 := uint(0); _tmp97869 < uint(len(_tmp97862)); _tmp97869 ++ {
    _arg = _tmp97862[_tmp97869]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp101208 := _parents;
    for _tmp101215 := uint(0); _tmp101215 < uint(len(_tmp101208)); _tmp101215 ++ {
      _e = _tmp101208[_tmp101215]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp105208 := _arr;
  for _i = uint(0); _i < uint(len(_tmp105208)); _i ++ {
    _v = _tmp105208[_i]
...
func send2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  for _i = 0; _i < _l - 1; _i = _i + 1 {
    ...
    if(!inClassx(_fromt, _handlerc, nil)){
      _tomsgt = classGetx(_tot, "handlerMsgInType")
      ...
      (*_x._arr) = append((*_x._arr), callNewx(_fwrite, &[]*Cptx{_tot, _from}, nil))
      continue
    }
    if(!inClassx(_tot, _handlerc, nil)){
      if(!inClassx(_tot, _idc, nil)){
        fmt.Println("cannot assign to from handler");debug.PrintStack();os.Exit(1)
      }
      _msgt = classGetx(_fromt, "handlerMsgOutType")
      ...
      (*_x._arr) = append((*_x._arr), callNewx(classGetx(_tot, "assign"), &[]*Cptx{_to, callNewx(_fread, &[]*Cptx{_fromt}, nil)}, _callassignc))
      continue
    }
    _msgt = classGetx(_fromt, "handlerMsgOutType")
    _tomsgt = classGetx(_fromt, "handlerMsgInType")
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp134309 := _ast;
  for _i = uint(0); _i < uint(len(_tmp134309)); _i ++ {
    _e = _tmp134309[_i]
    _ee = _e.([]interface{})
  ...
  _tmp134653 := _ast;
  for _i = uint(0); _i < uint(len(_tmp134653)); _i ++ {
    _e = _tmp134653[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp135531 := _ast;
  for _tmp135538 := uint(0); _tmp135538 < uint(len(_tmp135531)); _tmp135538 ++ {
    _e = _tmp135531[_tmp135538]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp137463 := _asts;
  for _tmp137470 := uint(0); _tmp137470 < uint(len(_tmp137463)); _tmp137470 ++ {
    _e = _tmp137463[_tmp137470]
  ...
  if(!_callable){
    _tmp137874 := _arrx;
    for _i = uint(0); _i < uint(len((*_tmp137874))); _i ++ {
      _v = (*_tmp137874)[_i]
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp138848 := _asts;
  for _tmp138855 := uint(0); _tmp138855 < uint(len(_tmp138848)); _tmp138855 ++ {
    _eo = _tmp138848[_tmp138855]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func subAst2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string) *Cptx{
  ...
  if(_t == "env"){
    ...
    _x = strNewx(_ast[1].(string))
    _x._fast = true
    return _x
  }else if(_t == "float"){
    _x = floatNewx(_lf(strconv.ParseFloat(_ast[1].(string), 64)).(float64))
    _x._fast = true
    return _x
  }else if(_t == "int"){
    _x = intNewx(_lf(strconv.Atoi(_ast[1].(string))).(int))
    _x._fast = true
    return _x
  }else if(_t == "dic"){
    if(len(_ast) > 2){
...
func main(){
  ...
  _handlerc = classDefx(_defmain, "Handler", nil, map[string]*Cptx{
    "handlerOutMsgType": _classc,
    "handlerInMsgType": _classc,
  })
  ...
  _filexc = curryDefx(_defmain, "Filex", _handlerc, nil)
  _dirxc = curryDefx(_defmain, "Dirx", _routersubc, nil)
  ...
  funcDefx(_defmain, "osArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp148558 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp148558))); _i ++ {
        _v = (*_tmp148558)[_i]
        if(_i == 0){
          continue
        }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp168034 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp168041 := uint(0); _tmp168041 < uint(len((*_tmp168034))); _tmp168041 ++ {
      _k = (*_tmp168034)[_tmp168041]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp168553 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp168560 := uint(0); _tmp168560 < uint(len((*_tmp168553))); _tmp168560 ++ {
      _k = (*_tmp168553)[_tmp168560]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
    return dicNewx(_dicc, _o._dic, _arrx)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp170076 := _xx;
    for _tmp170083 := uint(0); _tmp170083 < uint(len((*_tmp170076))); _tmp170083 ++ {
      _v = (*_tmp170076)[_tmp170083]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp175947 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp175947))); _i ++ {
      _v = (*_tmp175947)[_i]
      if(_i != 0){
        _s += _sep._str
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp193375 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp193375))); _i ++ {
        _v = (*_tmp193375)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp197081 := _da._arr;
      for _tmp197088 := uint(0); _tmp197088 < uint(len((*_tmp197081))); _tmp197088 ++ {
        _kc = (*_tmp197081)[_tmp197088]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
      ...
      _tmp197917 := _da._arr;
      for _i = uint(0); _i < uint(len((*_tmp197917))); _i ++ {
        _v = (*_tmp197917)[_i]
        if(_key != ""){
