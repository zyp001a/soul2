...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp42208 := _o;
  for _tmp42215 := uint(0); _tmp42215 < uint(len((*_tmp42208))); _tmp42215 ++ {
    _e = (*_tmp42208)[_tmp42215]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp43065 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp43065))); _i ++ {
    _x = (*_tmp43065)[_i]
    if(_i != 0 && _x != ""){
      _r += "\n"
      _r += __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp44767 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp44774 := uint(0); _tmp44774 < uint(len((*_tmp44767))); _tmp44774 ++ {
    _k = (*_tmp44767)[_tmp44774]
    if(_o._dic[_k] == nil){
  ...
  _tmp45249 := _c._arr;
  for _tmp45256 := uint(0); _tmp45256 < uint(len((*_tmp45249))); _tmp45256 ++ {
    _v = (*_tmp45249)[_tmp45256]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp45835 := _parentarr;
    for _tmp45842 := uint(0); _tmp45842 < uint(len((*_tmp45835))); _tmp45842 ++ {
      _e = (*_tmp45835)[_tmp45842]
      if(_e._id == ""){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp48595 := _o._arr;
  for _tmp48602 := uint(0); _tmp48602 < uint(len((*_tmp48595))); _tmp48602 ++ {
    _k = (*_tmp48595)[_tmp48602]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp49423 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp49423))); _i ++ {
      _argdef = (*_tmp49423)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp49873 := _args;
    for _tmp49880 := uint(0); _tmp49880 < uint(len((*_tmp49873))); _tmp49880 ++ {
      _arg = (*_tmp49873)[_tmp49880]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp50520 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp50520))); _i ++ {
      _argdef = (*_tmp50520)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp50864 := _args;
    for _tmp50871 := uint(0); _tmp50871 < uint(len((*_tmp50864))); _tmp50871 ++ {
      _arg = (*_tmp50864)[_tmp50871]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp57054 := _argtypes;
  for _tmp57061 := uint(0); _tmp57061 < uint(len((*_tmp57054))); _tmp57061 ++ {
    _v = (*_tmp57054)[_tmp57061]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp60264 := _types;
  for _tmp60271 := uint(0); _tmp60271 < uint(len((*_tmp60264))); _tmp60271 ++ {
    _v = (*_tmp60264)[_tmp60271]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_Path_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp63451 := _arr;
    for _tmp63458 := uint(0); _tmp63458 < uint(len((*_tmp63451))); _tmp63458 ++ {
      _v = (*_tmp63451)[_tmp63458]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp66057 := _scope._arr;
  for _tmp66064 := uint(0); _tmp66064 < uint(len((*_tmp66057))); _tmp66064 ++ {
    _v = (*_tmp66057)[_tmp66064]
    _k = _v._id
    if(_cache[_k] != nil){
      continue
    }
...
func subMethodGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp67642 := _v._arr;
  for _tmp67649 := uint(0); _tmp67649 < uint(len((*_tmp67642))); _tmp67649 ++ {
    _vv = (*_tmp67642)[_tmp67649]
...
func methodGetx(_scope *Cptx, _func *Cptx) *Cptx{
  ...
  _p = _o._arr
  _tmp68233 := _p;
  for _tmp68240 := uint(0); _tmp68240 < uint(len((*_tmp68233))); _tmp68240 ++ {
    _v = (*_tmp68233)[_tmp68240]
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp71537 := _o._arr;
  for _tmp71544 := uint(0); _tmp71544 < uint(len((*_tmp71537))); _tmp71544 ++ {
    _v = (*_tmp71537)[_tmp71544]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(len((*_a)) > 1){
    _s += "\n"
    _tmp84199 := _a;
    for _tmp84206 := uint(0); _tmp84206 < uint(len((*_tmp84199))); _tmp84206 ++ {
      _v = (*_tmp84199)[_tmp84206]
      _s += indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp84407 := _a;
    for _tmp84414 := uint(0); _tmp84414 < uint(len((*_tmp84407))); _tmp84414 ++ {
      _v = (*_tmp84407)[_tmp84414]
      _s += strx(_v, _i + 1)
    }
  }
  return _s + "]"
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp84745 := _d;
  for _tmp84752 := uint(0); _tmp84752 < uint(len((*_tmp84745))); _tmp84752 ++ {
    _v = (*_tmp84745)[_tmp84752]
    if(_v._name != ""){
      _s += _v._name + " "
    }else{
      _s += "~" + _v._id + " "
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _nstate._int = 2
  _tmp87812 := _args;
  for _i = uint(0); _i < uint(len((*_tmp87812))); _i ++ {
    _v = (*_tmp87812)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp89817 := _args;
    for _i = uint(0); _i < uint(len((*_tmp89817))); _i ++ {
      _arg = (*_tmp89817)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp91778 := _c._arr;
    for _tmp91785 := uint(0); _tmp91785 < uint(len((*_tmp91778))); _tmp91785 ++ {
      _v = (*_tmp91778)[_tmp91785]
      if(_cache[_v._id] != nil){
        return nil
      }
      _cache[_v._id] = 1
...
func blockExecx(_o *Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _b = _o._dic["blockVal"]
  _tmp93113 := _b._arr;
  for _i = uint(0); _i < uint(len((*_tmp93113))); _i ++ {
    _v = (*_tmp93113)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp97686 := _args;
  for _tmp97693 := uint(0); _tmp97693 < uint(len(_tmp97686)); _tmp97693 ++ {
    _arg = _tmp97686[_tmp97693]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp101032 := _parents;
    for _tmp101039 := uint(0); _tmp101039 < uint(len(_tmp101032)); _tmp101039 ++ {
      _e = _tmp101032[_tmp101039]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp105032 := _arr;
  for _i = uint(0); _i < uint(len(_tmp105032)); _i ++ {
    _v = _tmp105032[_i]
...
func send2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  for _i = 0; _i < _l - 1; _i = _i + 1 {
    ...
    _fwrite = classGetx(_fromt, "write")
    if(_fread != nil && _fwrite != nil){
      ...
      (*_x._arr) = append((*_x._arr), callNewx(_fwrite, &[]*Cptx{_from, _tmpid}, nil))
      continue
    }
    fmt.Println(_arr)
    fmt.Println(_i)
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp132969 := _ast;
  for _i = uint(0); _i < uint(len(_tmp132969)); _i ++ {
    _e = _tmp132969[_i]
    _ee = _e.([]interface{})
  ...
  _tmp133313 := _ast;
  for _i = uint(0); _i < uint(len(_tmp133313)); _i ++ {
    _e = _tmp133313[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp134191 := _ast;
  for _tmp134198 := uint(0); _tmp134198 < uint(len(_tmp134191)); _tmp134198 ++ {
    _e = _tmp134191[_tmp134198]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp136123 := _asts;
  for _tmp136130 := uint(0); _tmp136130 < uint(len(_tmp136123)); _tmp136130 ++ {
    _e = _tmp136123[_tmp136130]
  ...
  if(!_callable){
    _tmp136534 := _arrx;
    for _i = uint(0); _i < uint(len((*_tmp136534))); _i ++ {
      _v = (*_tmp136534)[_i]
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp137508 := _asts;
  for _tmp137515 := uint(0); _tmp137515 < uint(len(_tmp137508)); _tmp137515 ++ {
    _eo = _tmp137508[_tmp137515]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func main(){
  ...
  funcDefx(_defmain, "osArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp147218 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp147218))); _i ++ {
        _v = (*_tmp147218)[_i]
        if(_i == 0){
          continue
        }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp166694 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp166701 := uint(0); _tmp166701 < uint(len((*_tmp166694))); _tmp166701 ++ {
      _k = (*_tmp166694)[_tmp166701]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp167213 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp167220 := uint(0); _tmp167220 < uint(len((*_tmp167213))); _tmp167220 ++ {
      _k = (*_tmp167213)[_tmp167220]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
    return dicNewx(_dicc, _o._dic, _arrx)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp168736 := _xx;
    for _tmp168743 := uint(0); _tmp168743 < uint(len((*_tmp168736))); _tmp168743 ++ {
      _v = (*_tmp168736)[_tmp168743]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp174607 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp174607))); _i ++ {
      _v = (*_tmp174607)[_i]
      if(_i != 0){
        _s += _sep._str
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp192035 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp192035))); _i ++ {
        _v = (*_tmp192035)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp195741 := _da._arr;
      for _tmp195748 := uint(0); _tmp195748 < uint(len((*_tmp195741))); _tmp195748 ++ {
        _kc = (*_tmp195741)[_tmp195748]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
      ...
      _tmp196577 := _da._arr;
      for _i = uint(0); _i < uint(len((*_tmp196577))); _i ++ {
        _v = (*_tmp196577)[_i]
        if(_key != ""){
