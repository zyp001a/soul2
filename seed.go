...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp41517 := _o;
  for _tmp41524 := uint(0); _tmp41524 < uint(len((*_tmp41517))); _tmp41524 ++ {
    _e = (*_tmp41517)[_tmp41524]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp42374 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp42374))); _i ++ {
    _x = (*_tmp42374)[_i]
    if(_i != 0 && _x != ""){
      _r += "\n"
      _r += __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp44076 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp44083 := uint(0); _tmp44083 < uint(len((*_tmp44076))); _tmp44083 ++ {
    _k = (*_tmp44076)[_tmp44083]
    if(_o._dic[_k] == nil){
  ...
  _tmp44558 := _c._arr;
  for _tmp44565 := uint(0); _tmp44565 < uint(len((*_tmp44558))); _tmp44565 ++ {
    _v = (*_tmp44558)[_tmp44565]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp45144 := _parentarr;
    for _tmp45151 := uint(0); _tmp45151 < uint(len((*_tmp45144))); _tmp45151 ++ {
      _e = (*_tmp45144)[_tmp45151]
      if(_e._id == ""){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp47904 := _o._arr;
  for _tmp47911 := uint(0); _tmp47911 < uint(len((*_tmp47904))); _tmp47911 ++ {
    _k = (*_tmp47904)[_tmp47911]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp48732 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp48732))); _i ++ {
      _argdef = (*_tmp48732)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp49182 := _args;
    for _tmp49189 := uint(0); _tmp49189 < uint(len((*_tmp49182))); _tmp49189 ++ {
      _arg = (*_tmp49182)[_tmp49189]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp49829 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp49829))); _i ++ {
      _argdef = (*_tmp49829)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp50173 := _args;
    for _tmp50180 := uint(0); _tmp50180 < uint(len((*_tmp50173))); _tmp50180 ++ {
      _arg = (*_tmp50173)[_tmp50180]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp56363 := _argtypes;
  for _tmp56370 := uint(0); _tmp56370 < uint(len((*_tmp56363))); _tmp56370 ++ {
    _v = (*_tmp56363)[_tmp56370]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp59573 := _types;
  for _tmp59580 := uint(0); _tmp59580 < uint(len((*_tmp59573))); _tmp59580 ++ {
    _v = (*_tmp59573)[_tmp59580]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_Path_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp62760 := _arr;
    for _tmp62767 := uint(0); _tmp62767 < uint(len((*_tmp62760))); _tmp62767 ++ {
      _v = (*_tmp62760)[_tmp62767]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp65366 := _scope._arr;
  for _tmp65373 := uint(0); _tmp65373 < uint(len((*_tmp65366))); _tmp65373 ++ {
    _v = (*_tmp65366)[_tmp65373]
    _k = _v._id
    if(_cache[_k] != nil){
      continue
    }
...
func subMethodGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp66951 := _v._arr;
  for _tmp66958 := uint(0); _tmp66958 < uint(len((*_tmp66951))); _tmp66958 ++ {
    _vv = (*_tmp66951)[_tmp66958]
...
func methodGetx(_scope *Cptx, _func *Cptx) *Cptx{
  ...
  _p = _o._arr
  _tmp67542 := _p;
  for _tmp67549 := uint(0); _tmp67549 < uint(len((*_tmp67542))); _tmp67549 ++ {
    _v = (*_tmp67542)[_tmp67549]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp70214 := _c._arr;
  for _tmp70221 := uint(0); _tmp70221 < uint(len((*_tmp70214))); _tmp70221 ++ {
    _v = (*_tmp70214)[_tmp70221]
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp70846 := _o._arr;
  for _tmp70853 := uint(0); _tmp70853 < uint(len((*_tmp70846))); _tmp70853 ++ {
    _v = (*_tmp70846)[_tmp70853]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(len((*_a)) > 1){
    _s += "\n"
    _tmp83508 := _a;
    for _tmp83515 := uint(0); _tmp83515 < uint(len((*_tmp83508))); _tmp83515 ++ {
      _v = (*_tmp83508)[_tmp83515]
      _s += indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp83716 := _a;
    for _tmp83723 := uint(0); _tmp83723 < uint(len((*_tmp83716))); _tmp83723 ++ {
      _v = (*_tmp83716)[_tmp83723]
      _s += strx(_v, _i + 1)
    }
  }
  return _s + "]"
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp84054 := _d;
  for _tmp84061 := uint(0); _tmp84061 < uint(len((*_tmp84054))); _tmp84061 ++ {
    _v = (*_tmp84054)[_tmp84061]
    if(_v._name != ""){
      _s += _v._name + " "
    }else{
      _s += "~" + _v._id + " "
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _nstate._int = 2
  _tmp87121 := _args;
  for _i = uint(0); _i < uint(len((*_tmp87121))); _i ++ {
    _v = (*_tmp87121)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp89126 := _args;
    for _i = uint(0); _i < uint(len((*_tmp89126))); _i ++ {
      _arg = (*_tmp89126)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp91087 := _c._arr;
    for _tmp91094 := uint(0); _tmp91094 < uint(len((*_tmp91087))); _tmp91094 ++ {
      _v = (*_tmp91087)[_tmp91094]
      if(_cache[_v._id] != nil){
        return nil
      }
      _cache[_v._id] = 1
...
func blockExecx(_o *Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _b = _o._dic["blockVal"]
  _tmp92422 := _b._arr;
  for _i = uint(0); _i < uint(len((*_tmp92422))); _i ++ {
    _v = (*_tmp92422)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp96995 := _args;
  for _tmp97002 := uint(0); _tmp97002 < uint(len(_tmp96995)); _tmp97002 ++ {
    _arg = _tmp96995[_tmp97002]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp100341 := _parents;
    for _tmp100348 := uint(0); _tmp100348 < uint(len(_tmp100341)); _tmp100348 ++ {
      _e = _tmp100341[_tmp100348]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp104341 := _arr;
  for _i = uint(0); _i < uint(len(_tmp104341)); _i ++ {
    _v = _tmp104341[_i]
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp129316 := _ast;
  for _i = uint(0); _i < uint(len(_tmp129316)); _i ++ {
    _e = _tmp129316[_i]
    _ee = _e.([]interface{})
  ...
  _tmp129660 := _ast;
  for _i = uint(0); _i < uint(len(_tmp129660)); _i ++ {
    _e = _tmp129660[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp130538 := _ast;
  for _tmp130545 := uint(0); _tmp130545 < uint(len(_tmp130538)); _tmp130545 ++ {
    _e = _tmp130538[_tmp130545]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp132259 := _asts;
  for _tmp132266 := uint(0); _tmp132266 < uint(len(_tmp132259)); _tmp132266 ++ {
    _e = _tmp132259[_tmp132266]
  ...
  if(!_callable){
    _tmp132670 := _arrx;
    for _i = uint(0); _i < uint(len((*_tmp132670))); _i ++ {
      _v = (*_tmp132670)[_i]
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp133644 := _asts;
  for _tmp133651 := uint(0); _tmp133651 < uint(len(_tmp133644)); _tmp133651 ++ {
    _eo = _tmp133644[_tmp133651]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func subAst2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string) *Cptx{
  ...
  if(_t == "env"){
    ...
    _x = send2cptx(_ast, _def, _local, _func)
    return _x
  }else{
...
func main(){
  ...
  _handlerc = classDefx(_defmain, "Handler", nil, nil)
  ...
  funcDefx(_defmain, "osArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp143421 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp143421))); _i ++ {
        _v = (*_tmp143421)[_i]
        if(_i == 0){
          continue
        }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp162897 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp162904 := uint(0); _tmp162904 < uint(len((*_tmp162897))); _tmp162904 ++ {
      _k = (*_tmp162897)[_tmp162904]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp163416 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp163423 := uint(0); _tmp163423 < uint(len((*_tmp163416))); _tmp163423 ++ {
      _k = (*_tmp163416)[_tmp163423]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
    return dicNewx(_dicc, _o._dic, _arrx)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp164939 := _xx;
    for _tmp164946 := uint(0); _tmp164946 < uint(len((*_tmp164939))); _tmp164946 ++ {
      _v = (*_tmp164939)[_tmp164946]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp170810 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp170810))); _i ++ {
      _v = (*_tmp170810)[_i]
      if(_i != 0){
        _s += _sep._str
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp188238 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp188238))); _i ++ {
        _v = (*_tmp188238)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp191944 := _da._arr;
      for _tmp191951 := uint(0); _tmp191951 < uint(len((*_tmp191944))); _tmp191951 ++ {
        _kc = (*_tmp191944)[_tmp191951]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
      ...
      _tmp192780 := _da._arr;
      for _i = uint(0); _i < uint(len((*_tmp192780))); _i ++ {
        _v = (*_tmp192780)[_i]
        if(_key != ""){
