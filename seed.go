...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp47493 := _o;
  for _tmp47494 := uint(0); _tmp47494 < uint(len((*_tmp47493))); _tmp47494 ++ {
    _e = (*_tmp47493)[_tmp47494]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp57397 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp57397))); _i ++ {
    _x = (*_tmp57397)[_i]
    if(_i != 0 && _x != ""){
      _r += "\n"
      _r += __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp74302 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp74303 := uint(0); _tmp74303 < uint(len((*_tmp74302))); _tmp74303 ++ {
    _k = (*_tmp74302)[_tmp74303]
    if(_o._dic[_k] == nil){
  ...
  _tmp79202 := _c._arr;
  for _tmp79203 := uint(0); _tmp79203 < uint(len((*_tmp79202))); _tmp79203 ++ {
    _v = (*_tmp79202)[_tmp79203]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp86930 := _parentarr;
    for _tmp86931 := uint(0); _tmp86931 < uint(len((*_tmp86930))); _tmp86931 ++ {
      _e = (*_tmp86930)[_tmp86931]
      if(_e._id == ""){
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_Path_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp168617 := _arr;
    for _tmp168618 := uint(0); _tmp168618 < uint(len((*_tmp168617))); _tmp168618 ++ {
      _v = (*_tmp168617)[_tmp168618]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp201590 := _scope._arr;
  for _tmp201591 := uint(0); _tmp201591 < uint(len((*_tmp201590))); _tmp201591 ++ {
    _v = (*_tmp201590)[_tmp201591]
    _k = _v._id
    if(_cache[_k] != nil){
      continue
    }
...
func subMethodGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp222147 := _v._arr;
  for _tmp222148 := uint(0); _tmp222148 < uint(len((*_tmp222147))); _tmp222148 ++ {
    _vv = (*_tmp222147)[_tmp222148]
...
func methodGetx(_scope *Cptx, _func *Cptx) *Cptx{
  ...
  _p = _o._arr
  _tmp229644 := _p;
  for _tmp229645 := uint(0); _tmp229645 < uint(len((*_tmp229644))); _tmp229645 ++ {
    _v = (*_tmp229644)[_tmp229645]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp324882 := _types;
  for _tmp324883 := uint(0); _tmp324883 < uint(len((*_tmp324882))); _tmp324883 ++ {
    _v = (*_tmp324882)[_tmp324883]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp457487 := _argtypes;
  for _tmp457488 := uint(0); _tmp457488 < uint(len((*_tmp457487))); _tmp457488 ++ {
    _v = (*_tmp457487)[_tmp457488]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp513841 := _c._arr;
  for _tmp513842 := uint(0); _tmp513842 < uint(len((*_tmp513841))); _tmp513842 ++ {
    _v = (*_tmp513841)[_tmp513842]
...
func getParentx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp595413 := _o._arr;
  for _tmp595414 := uint(0); _tmp595414 < uint(len((*_tmp595413))); _tmp595414 ++ {
    _v = (*_tmp595413)[_tmp595414]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(len((*_a)) > 1){
    _s += "\n"
    _tmp675601 := _a;
    for _tmp675602 := uint(0); _tmp675602 < uint(len((*_tmp675601))); _tmp675602 ++ {
      _v = (*_tmp675601)[_tmp675602]
      _s += indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp677833 := _a;
    for _tmp677834 := uint(0); _tmp677834 < uint(len((*_tmp677833))); _tmp677834 ++ {
      _v = (*_tmp677833)[_tmp677834]
      _s += strx(_v, _i + 1)
    }
  }
  return _s + "]"
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp682346 := _d;
  for _tmp682347 := uint(0); _tmp682347 < uint(len((*_tmp682346))); _tmp682347 ++ {
    _v = (*_tmp682346)[_tmp682347]
    if(_v._name != ""){
      _s += _v._name + " "
    }else{
      _s += "~" + _v._id + " "
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _tmp724255 := _args;
  for _i = uint(0); _i < uint(len((*_tmp724255))); _i ++ {
    _v = (*_tmp724255)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp752747 := _args;
    for _i = uint(0); _i < uint(len((*_tmp752747))); _i ++ {
      _arg = (*_tmp752747)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp778366 := _c._arr;
    for _tmp778367 := uint(0); _tmp778367 < uint(len((*_tmp778366))); _tmp778367 ++ {
      _v = (*_tmp778366)[_tmp778367]
      if(_cache[_v._id] != nil){
        return nil
      }
      _cache[_v._id] = 1
...
func blockExecx(_o *Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _b = _o._dic["blockVal"]
  _tmp795533 := _b._arr;
  for _i = uint(0); _i < uint(len((*_tmp795533))); _i ++ {
    _v = (*_tmp795533)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp862309 := _args;
  for _tmp862310 := uint(0); _tmp862310 < uint(len(_tmp862309)); _tmp862310 ++ {
    _arg = _tmp862309[_tmp862310]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp911269 := _parents;
    for _tmp911270 := uint(0); _tmp911270 < uint(len(_tmp911269)); _tmp911270 ++ {
      _e = _tmp911269[_tmp911270]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp964161 := _arr;
  for _i = uint(0); _i < uint(len(_tmp964161)); _i ++ {
    _v = _tmp964161[_i]
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp1307130 := _ast;
  for _i = uint(0); _i < uint(len(_tmp1307130)); _i ++ {
    _e = _tmp1307130[_i]
    _ee = _e.([]interface{})
  ...
  _tmp1312425 := _ast;
  for _i = uint(0); _i < uint(len(_tmp1312425)); _i ++ {
    _e = _tmp1312425[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _i = 0
  _tmp1324841 := _ast;
  for _tmp1324842 := uint(0); _tmp1324842 < uint(len(_tmp1324841)); _tmp1324842 ++ {
    _e = _tmp1324841[_tmp1324842]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp1350953 := _asts;
  for _tmp1350954 := uint(0); _tmp1350954 < uint(len(_tmp1350953)); _tmp1350954 ++ {
    _e = _tmp1350953[_tmp1350954]
  ...
  if(!_callable){
    _tmp1355888 := _arrx;
    for _i = uint(0); _i < uint(len((*_tmp1355888))); _i ++ {
      _v = (*_tmp1355888)[_i]
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp1369377 := _asts;
  for _tmp1369378 := uint(0); _tmp1369378 < uint(len(_tmp1369377)); _tmp1369378 ++ {
    _eo = _tmp1369377[_tmp1369378]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp1477039 := _o._arr;
  for _tmp1477040 := uint(0); _tmp1477040 < uint(len((*_tmp1477039))); _tmp1477040 ++ {
    _k = (*_tmp1477039)[_tmp1477040]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp2105286 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp2105286))); _i ++ {
      _argdef = (*_tmp2105286)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp2109752 := _args;
    for _tmp2109753 := uint(0); _tmp2109753 < uint(len((*_tmp2109752))); _tmp2109753 ++ {
      _arg = (*_tmp2109752)[_tmp2109753]
...
func main(){
  ...
  funcDefx(_defmain, "osArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp1497843 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp1497843))); _i ++ {
        _v = (*_tmp1497843)[_i]
        if(_i == 0){
          continue
        }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp1770828 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp1770829 := uint(0); _tmp1770829 < uint(len((*_tmp1770828))); _tmp1770829 ++ {
      _k = (*_tmp1770828)[_tmp1770829]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp1778329 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp1778330 := uint(0); _tmp1778330 < uint(len((*_tmp1778329))); _tmp1778330 ++ {
      _k = (*_tmp1778329)[_tmp1778330]
      (*_arrx) = append((*_arrx), strNewx(_k))
    }
    return dicNewx(_dicc, _o._dic, _arrx)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp1800885 := _xx;
    for _tmp1800886 := uint(0); _tmp1800886 < uint(len((*_tmp1800885))); _tmp1800886 ++ {
      _v = (*_tmp1800885)[_tmp1800886]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp1885559 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp1885559))); _i ++ {
      _v = (*_tmp1885559)[_i]
      if(_i != 0){
        _s += _sep._str
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp2151299 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp2151299))); _i ++ {
        _v = (*_tmp2151299)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp2201557 := _da._arr;
      for _tmp2201558 := uint(0); _tmp2201558 < uint(len((*_tmp2201557))); _tmp2201558 ++ {
        _kc = (*_tmp2201557)[_tmp2201558]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
      ...
      _tmp2211348 := _da._arr;
      for _i = uint(0); _i < uint(len((*_tmp2211348))); _i ++ {
        _v = (*_tmp2211348)[_i]
        if(_key != ""){
