...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp38214 := _o;
  for _tmp38217 := uint(0); _tmp38217 < uint(len((*_tmp38214))); _tmp38217 ++ {
    _e = (*_tmp38214)[_tmp38217]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp38695 := _o;
  for _i = uint(0); _i < uint(len(_tmp38695)); _i ++ {
    _e = _tmp38695[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp39463 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp39463))); _i ++ {
    _x = (*_tmp39463)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp40349 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp40352 := uint(0); _tmp40352 < uint(len(_tmp40349)); _tmp40352 ++ {
    _k = _tmp40349[_tmp40352]
    if(_o._dic[_k] == nil){
  ...
  _tmp40788 := _c._arr;
  for _tmp40791 := uint(0); _tmp40791 < uint(len((*_tmp40788))); _tmp40791 ++ {
    _v = (*_tmp40788)[_tmp40791]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp41295 := _parentarr;
    for _tmp41298 := uint(0); _tmp41298 < uint(len((*_tmp41295))); _tmp41298 ++ {
      _e = (*_tmp41295)[_tmp41298]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp43631 := _o._arr;
  for _tmp43634 := uint(0); _tmp43634 < uint(len((*_tmp43631))); _tmp43634 ++ {
    _k = (*_tmp43631)[_tmp43634]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp44383 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp44383))); _i ++ {
      _argdef = (*_tmp44383)[_i]
    ...
    _tmp44732 := _args;
    for _tmp44735 := uint(0); _tmp44735 < uint(len((*_tmp44732))); _tmp44735 ++ {
      _arg = (*_tmp44732)[_tmp44735]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp45282 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp45282))); _i ++ {
      _argdef = (*_tmp45282)[_i]
      if(_i < uint(len((*_args)))){
    ...
    _tmp45574 := _args;
    for _tmp45577 := uint(0); _tmp45577 < uint(len((*_tmp45574))); _tmp45577 ++ {
      _arg = (*_tmp45574)[_tmp45577]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp52182 := _argtypes;
  for _tmp52185 := uint(0); _tmp52185 < uint(len((*_tmp52182))); _tmp52185 ++ {
    _v = (*_tmp52182)[_tmp52185]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp54079 := _x._arr;
  for _tmp54082 := uint(0); _tmp54082 < uint(len((*_tmp54079))); _tmp54082 ++ {
    _v = (*_tmp54079)[_tmp54082]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp55053 := _c._arr;
  for _tmp55056 := uint(0); _tmp55056 < uint(len((*_tmp55053))); _tmp55056 ++ {
    _v = (*_tmp55053)[_tmp55056]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp56838 := _types;
  for _tmp56841 := uint(0); _tmp56841 < uint(len((*_tmp56838))); _tmp56841 ++ {
    _v = (*_tmp56838)[_tmp56841]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp59909 := _arr;
    for _tmp59912 := uint(0); _tmp59912 < uint(len((*_tmp59909))); _tmp59912 ++ {
      _v = (*_tmp59909)[_tmp59912]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp62615 := _scope._arr;
  for _tmp62618 := uint(0); _tmp62618 < uint(len((*_tmp62615))); _tmp62618 ++ {
    _v = (*_tmp62615)[_tmp62618]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp64282 := _v._arr;
  for _tmp64285 := uint(0); _tmp64285 < uint(len((*_tmp64282))); _tmp64285 ++ {
    _vv = (*_tmp64282)[_tmp64285]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp65211 := _p;
  for _tmp65214 := uint(0); _tmp65214 < uint(len((*_tmp65211))); _tmp65214 ++ {
    _v = (*_tmp65211)[_tmp65214]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp67592 := _c._arr;
  for _tmp67595 := uint(0); _tmp67595 < uint(len((*_tmp67592))); _tmp67595 ++ {
    _v = (*_tmp67592)[_tmp67595]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp68202 := _o._arr;
  for _tmp68205 := uint(0); _tmp68205 < uint(len((*_tmp68202))); _tmp68205 ++ {
    _v = (*_tmp68202)[_tmp68205]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp83032 := _a;
    for _tmp83035 := uint(0); _tmp83035 < uint(len((*_tmp83032))); _tmp83035 ++ {
      _v = (*_tmp83032)[_tmp83035]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp83235 := _a;
    for _tmp83238 := uint(0); _tmp83238 < uint(len((*_tmp83235))); _tmp83238 ++ {
      _v = (*_tmp83235)[_tmp83238]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp83505 := _d;
  for _tmp83508 := uint(0); _tmp83508 < uint(len((*_tmp83505))); _tmp83508 ++ {
    _v = (*_tmp83505)[_tmp83508]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _tmp86808 := _args;
  for _i = uint(0); _i < uint(len((*_tmp86808))); _i ++ {
    _v = (*_tmp86808)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp89569 := _args;
    for _i = uint(0); _i < uint(len((*_tmp89569))); _i ++ {
      _arg = (*_tmp89569)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp91466 := _c._arr;
    for _tmp91469 := uint(0); _tmp91469 < uint(len((*_tmp91466))); _tmp91469 ++ {
      _v = (*_tmp91466)[_tmp91469]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp92899 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp92899))); _i ++ {
    _v = (*_tmp92899)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp98583 := _env._dic["envStack"]._arr;
  for _tmp98586 := uint(0); _tmp98586 < uint(len((*_tmp98583))); _tmp98586 ++ {
    _v = (*_tmp98583)[_tmp98586]
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp101532 := _args;
  for _tmp101535 := uint(0); _tmp101535 < uint(len(_tmp101532)); _tmp101535 ++ {
    _arg = _tmp101532[_tmp101535]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp105073 := _parents;
    for _tmp105076 := uint(0); _tmp105076 < uint(len(_tmp105073)); _tmp105076 ++ {
      _e = _tmp105073[_tmp105076]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp108758 := _arr;
  for _i = uint(0); _i < uint(len(_tmp108758)); _i ++ {
    _v = _tmp108758[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp130549 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp130549)); _i ++ {
    _e = _tmp130549[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp132155 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp132155)); _i ++ {
    _e = _tmp132155[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp133060 := _ast;
  for _i = uint(0); _i < uint(len(_tmp133060)); _i ++ {
    _e = _tmp133060[_i]
    _ee = _e.([]interface{})
  ...
  _tmp133384 := _ast;
  for _i = uint(0); _i < uint(len(_tmp133384)); _i ++ {
    _e = _tmp133384[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp134172 := _ast;
  for _tmp134175 := uint(0); _tmp134175 < uint(len(_tmp134172)); _tmp134175 ++ {
    _e = _tmp134172[_tmp134175]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp136158 := _asts;
  for _i = uint(0); _i < uint(len(_tmp136158)); _i ++ {
    _e = _tmp136158[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp136544 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp136544)); _i ++ {
      _v = _tmp136544[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp137431 := _asts;
  for _tmp137434 := uint(0); _tmp137434 < uint(len(_tmp137431)); _tmp137434 ++ {
    _eo = _tmp137431[_tmp137434]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func main(){
  ...
  funcDefx(_defmain, "send", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _tmp154098 := _arr;
    for _tmp154101 := uint(0); _tmp154101 < uint(len((*_tmp154098))); _tmp154101 ++ {
      _v = (*_tmp154098)[_tmp154101]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp166733 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp166736 := uint(0); _tmp166736 < uint(len(_tmp166733)); _tmp166736 ++ {
      _k = _tmp166733[_tmp166736]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp167910 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp167913 := uint(0); _tmp167913 < uint(len(_tmp167910)); _tmp167913 ++ {
      _k = _tmp167910[_tmp167913]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp173415 := _xx;
    for _tmp173418 := uint(0); _tmp173418 < uint(len((*_tmp173415))); _tmp173418 ++ {
      _v = (*_tmp173415)[_tmp173418]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp179378 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp179378))); _i ++ {
      _v = (*_tmp179378)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp191649 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp191649))); _i ++ {
        _v = (*_tmp191649)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp193380 := _c._arr;
    for _tmp193383 := uint(0); _tmp193383 < uint(len((*_tmp193380))); _tmp193383 ++ {
      _v = (*_tmp193380)[_tmp193383]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp196062 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp196062))); _i ++ {
        _v = (*_tmp196062)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp199475 := _da._arr;
      for _tmp199478 := uint(0); _tmp199478 < uint(len((*_tmp199475))); _tmp199478 ++ {
        _kc = (*_tmp199475)[_tmp199478]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
