...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp40993 := _o;
  for _tmp41000 := uint(0); _tmp41000 < uint(len((*_tmp40993))); _tmp41000 ++ {
    _e = (*_tmp40993)[_tmp41000]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp41874 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp41874))); _i ++ {
    _x = (*_tmp41874)[_i]
    if(_i != 0 && _x != ""){
      _r += "\n"
      _r += __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp43599 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp43606 := uint(0); _tmp43606 < uint(len((*_tmp43599))); _tmp43606 ++ {
    _k = (*_tmp43599)[_tmp43606]
    if(_o._dic[_k] == nil){
  ...
  _tmp44088 := _c._arr;
  for _tmp44095 := uint(0); _tmp44095 < uint(len((*_tmp44088))); _tmp44095 ++ {
    _v = (*_tmp44088)[_tmp44095]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp44712 := _parentarr;
    for _tmp44719 := uint(0); _tmp44719 < uint(len((*_tmp44712))); _tmp44719 ++ {
      _e = (*_tmp44712)[_tmp44719]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp47548 := _o._arr;
  for _tmp47555 := uint(0); _tmp47555 < uint(len((*_tmp47548))); _tmp47555 ++ {
    _k = (*_tmp47548)[_tmp47555]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp48408 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp48408))); _i ++ {
      _argdef = (*_tmp48408)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp48863 := _args;
    for _tmp48870 := uint(0); _tmp48870 < uint(len((*_tmp48863))); _tmp48870 ++ {
      _arg = (*_tmp48863)[_tmp48870]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp49530 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp49530))); _i ++ {
      _argdef = (*_tmp49530)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp49889 := _args;
    for _tmp49896 := uint(0); _tmp49896 < uint(len((*_tmp49889))); _tmp49896 ++ {
      _arg = (*_tmp49889)[_tmp49896]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp56499 := _argtypes;
  for _tmp56506 := uint(0); _tmp56506 < uint(len((*_tmp56499))); _tmp56506 ++ {
    _v = (*_tmp56499)[_tmp56506]
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp59031 := _c._arr;
  for _tmp59038 := uint(0); _tmp59038 < uint(len((*_tmp59031))); _tmp59038 ++ {
    _v = (*_tmp59031)[_tmp59038]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp60400 := _types;
  for _tmp60407 := uint(0); _tmp60407 < uint(len((*_tmp60400))); _tmp60407 ++ {
    _v = (*_tmp60400)[_tmp60407]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_Path_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp63661 := _arr;
    for _tmp63668 := uint(0); _tmp63668 < uint(len((*_tmp63661))); _tmp63668 ++ {
      _v = (*_tmp63661)[_tmp63668]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp66322 := _scope._arr;
  for _tmp66329 := uint(0); _tmp66329 < uint(len((*_tmp66322))); _tmp66329 ++ {
    _v = (*_tmp66322)[_tmp66329]
...
func subMethodGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp68010 := _v._arr;
  for _tmp68017 := uint(0); _tmp68017 < uint(len((*_tmp68010))); _tmp68017 ++ {
    _vv = (*_tmp68010)[_tmp68017]
...
func methodGetx(_scope *Cptx, _func *Cptx) *Cptx{
  ...
  _p = _o._arr
  _tmp68631 := _p;
  for _tmp68638 := uint(0); _tmp68638 < uint(len((*_tmp68631))); _tmp68638 ++ {
    _v = (*_tmp68631)[_tmp68638]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp71367 := _c._arr;
  for _tmp71374 := uint(0); _tmp71374 < uint(len((*_tmp71367))); _tmp71374 ++ {
    _v = (*_tmp71367)[_tmp71374]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp72072 := _o._arr;
  for _tmp72079 := uint(0); _tmp72079 < uint(len((*_tmp72072))); _tmp72079 ++ {
    _v = (*_tmp72072)[_tmp72079]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(len((*_a)) > 1){
    _s += "\n"
    _tmp86107 := _a;
    for _tmp86114 := uint(0); _tmp86114 < uint(len((*_tmp86107))); _tmp86114 ++ {
      _v = (*_tmp86107)[_tmp86114]
      _s += indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp86321 := _a;
    for _tmp86328 := uint(0); _tmp86328 < uint(len((*_tmp86321))); _tmp86328 ++ {
      _v = (*_tmp86321)[_tmp86328]
      _s += strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp86656 := _d;
  for _tmp86663 := uint(0); _tmp86663 < uint(len((*_tmp86656))); _tmp86663 ++ {
    _v = (*_tmp86656)[_tmp86663]
    if(_v._name != ""){
      _s += _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _nstate._int = 2
  _tmp89999 := _args;
  for _i = uint(0); _i < uint(len((*_tmp89999))); _i ++ {
    _v = (*_tmp89999)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp92042 := _args;
    for _i = uint(0); _i < uint(len((*_tmp92042))); _i ++ {
      _arg = (*_tmp92042)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp94082 := _c._arr;
    for _tmp94089 := uint(0); _tmp94089 < uint(len((*_tmp94082))); _tmp94089 ++ {
      _v = (*_tmp94082)[_tmp94089]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  var _v *Cptx
  _tmp95704 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp95704))); _i ++ {
    _v = (*_tmp95704)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp102988 := _args;
  for _tmp102995 := uint(0); _tmp102995 < uint(len(_tmp102988)); _tmp102995 ++ {
    _arg = _tmp102988[_tmp102995]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp106442 := _parents;
    for _tmp106449 := uint(0); _tmp106449 < uint(len(_tmp106442)); _tmp106449 ++ {
      _e = _tmp106442[_tmp106449]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp110592 := _arr;
  for _i = uint(0); _i < uint(len(_tmp110592)); _i ++ {
    _v = _tmp110592[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp138460 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp138460)); _i ++ {
    _e = _tmp138460[_i]
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp140393 := _ast;
  for _i = uint(0); _i < uint(len(_tmp140393)); _i ++ {
    _e = _tmp140393[_i]
    _ee = _e.([]interface{})
  ...
  _tmp140753 := _ast;
  for _i = uint(0); _i < uint(len(_tmp140753)); _i ++ {
    _e = _tmp140753[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp141673 := _ast;
  for _tmp141680 := uint(0); _tmp141680 < uint(len(_tmp141673)); _tmp141680 ++ {
    _e = _tmp141673[_tmp141680]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp143669 := _asts;
  for _tmp143676 := uint(0); _tmp143676 < uint(len(_tmp143669)); _tmp143676 ++ {
    _e = _tmp143669[_tmp143676]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
    }
  ...
  if(!_callable){
    _tmp144098 := _arrx;
    for _i = uint(0); _i < uint(len((*_tmp144098))); _i ++ {
      _v = (*_tmp144098)[_i]
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp145172 := _asts;
  for _tmp145179 := uint(0); _tmp145179 < uint(len(_tmp145172)); _tmp145179 ++ {
    _eo = _tmp145172[_tmp145179]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func main(){
  ...
  funcDefx(_defmain, "osArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp155482 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp155482))); _i ++ {
        _v = (*_tmp155482)[_i]
        if(_i == 0){
          continue
        }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp176069 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp176076 := uint(0); _tmp176076 < uint(len((*_tmp176069))); _tmp176076 ++ {
      _k = (*_tmp176069)[_tmp176076]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp176615 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp176622 := uint(0); _tmp176622 < uint(len((*_tmp176615))); _tmp176622 ++ {
      _k = (*_tmp176615)[_tmp176622]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_dicc, _o._dic, _arrx)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp178208 := _xx;
    for _tmp178215 := uint(0); _tmp178215 < uint(len((*_tmp178208))); _tmp178215 ++ {
      _v = (*_tmp178208)[_tmp178215]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp185934 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp185934))); _i ++ {
      _v = (*_tmp185934)[_i]
      if(_i != 0){
        _s += _sep._str
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp204208 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp204208))); _i ++ {
        _v = (*_tmp204208)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp208035 := _da._arr;
      for _tmp208042 := uint(0); _tmp208042 < uint(len((*_tmp208035))); _tmp208042 ++ {
        _kc = (*_tmp208035)[_tmp208042]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
      ...
      _tmp208912 := _da._arr;
      for _i = uint(0); _i < uint(len((*_tmp208912))); _i ++ {
        _v = (*_tmp208912)[_i]
        if(_key != ""){
