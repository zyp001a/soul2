...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp44428 := _o;
  for _tmp44431 := uint(0); _tmp44431 < uint(len((*_tmp44428))); _tmp44431 ++ {
    _e = (*_tmp44428)[_tmp44431]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp44976 := _o;
  for _i = uint(0); _i < uint(len(_tmp44976)); _i ++ {
    _e = _tmp44976[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp45909 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp45909))); _i ++ {
    _x = (*_tmp45909)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp46974 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp46977 := uint(0); _tmp46977 < uint(len(_tmp46974)); _tmp46977 ++ {
    _k = _tmp46974[_tmp46977]
    if(_o._dic[_k] == nil){
  ...
  _tmp47481 := _c._arr;
  for _tmp47484 := uint(0); _tmp47484 < uint(len((*_tmp47481))); _tmp47484 ++ {
    _v = (*_tmp47481)[_tmp47484]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp48088 := _parentarr;
    for _tmp48091 := uint(0); _tmp48091 < uint(len((*_tmp48088))); _tmp48091 ++ {
      _e = (*_tmp48088)[_tmp48091]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp51975 := _o._arr;
  for _tmp51978 := uint(0); _tmp51978 < uint(len((*_tmp51975))); _tmp51978 ++ {
    _k = (*_tmp51975)[_tmp51978]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(inClassx(classx(_f), _funcvarsc, nil)){
    ...
    _tmp52853 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp52853))); _i ++ {
      _argdef = (*_tmp52853)[_i]
    ...
    _tmp53256 := _args;
    for _tmp53259 := uint(0); _tmp53259 < uint(len((*_tmp53256))); _tmp53259 ++ {
      _arg = (*_tmp53256)[_tmp53259]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp61095 := _argtypes;
  for _tmp61098 := uint(0); _tmp61098 < uint(len((*_tmp61095))); _tmp61098 ++ {
    _v = (*_tmp61095)[_tmp61098]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp63331 := _x._arr;
  for _tmp63334 := uint(0); _tmp63334 < uint(len((*_tmp63331))); _tmp63334 ++ {
    _v = (*_tmp63331)[_tmp63334]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp64497 := _c._arr;
  for _tmp64500 := uint(0); _tmp64500 < uint(len((*_tmp64497))); _tmp64500 ++ {
    _v = (*_tmp64497)[_tmp64500]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp66605 := _types;
  for _tmp66608 := uint(0); _tmp66608 < uint(len((*_tmp66605))); _tmp66608 ++ {
    _v = (*_tmp66605)[_tmp66608]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp70171 := _arr;
    for _tmp70174 := uint(0); _tmp70174 < uint(len((*_tmp70171))); _tmp70174 ++ {
      _v = (*_tmp70171)[_tmp70174]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp73436 := _scope._arr;
  for _tmp73439 := uint(0); _tmp73439 < uint(len((*_tmp73436))); _tmp73439 ++ {
    _v = (*_tmp73436)[_tmp73439]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp75400 := _v._arr;
  for _tmp75403 := uint(0); _tmp75403 < uint(len((*_tmp75400))); _tmp75403 ++ {
    _vv = (*_tmp75400)[_tmp75403]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp76488 := _p;
  for _tmp76491 := uint(0); _tmp76491 < uint(len((*_tmp76488))); _tmp76491 ++ {
    _v = (*_tmp76488)[_tmp76491]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp79282 := _c._arr;
  for _tmp79285 := uint(0); _tmp79285 < uint(len((*_tmp79282))); _tmp79285 ++ {
    _v = (*_tmp79282)[_tmp79285]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp80005 := _o._arr;
  for _tmp80008 := uint(0); _tmp80008 < uint(len((*_tmp80005))); _tmp80008 ++ {
    _v = (*_tmp80005)[_tmp80008]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp98126 := _a;
    for _tmp98129 := uint(0); _tmp98129 < uint(len((*_tmp98126))); _tmp98129 ++ {
      _v = (*_tmp98126)[_tmp98129]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp98361 := _a;
    for _tmp98364 := uint(0); _tmp98364 < uint(len((*_tmp98361))); _tmp98364 ++ {
      _v = (*_tmp98361)[_tmp98364]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp98686 := _d;
  for _tmp98689 := uint(0); _tmp98689 < uint(len((*_tmp98686))); _tmp98689 ++ {
    _v = (*_tmp98686)[_tmp98689]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp108855 := _c._arr;
    for _tmp108858 := uint(0); _tmp108858 < uint(len((*_tmp108855))); _tmp108858 ++ {
      _v = (*_tmp108855)[_tmp108858]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp110545 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp110545))); _i ++ {
    _v = (*_tmp110545)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp117497 := _env._dic["envStack"]._arr;
  for _tmp117500 := uint(0); _tmp117500 < uint(len((*_tmp117497))); _tmp117500 ++ {
    _v = (*_tmp117497)[_tmp117500]
...
func id2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    ...
    if(_varts != nil){
      _tmp118771 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp118771))); _i ++ {
        _stro = (*_tmp118771)[_i]
        if(_id == _stro._str){
...
func idlocal2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    _varts = getx(_func, "funcVars")
    if(_varts != nil){
      _tmp121691 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp121691))); _i ++ {
        _stro = (*_tmp121691)[_i]
        if(_id == _stro._str){
          _r = idNewx(_local, _stro._str, _idargc)
          _r._int = int(_i)
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp124681 := _args;
  for _tmp124684 := uint(0); _tmp124684 < uint(len(_tmp124681)); _tmp124684 ++ {
    _arg = _tmp124681[_tmp124684]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    _arr = &[]*Cptx{}
    _tmp130500 := _parents;
    for _tmp130503 := uint(0); _tmp130503 < uint(len(_tmp130500)); _tmp130503 ++ {
      _e = _tmp130500[_tmp130503]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp134859 := _arr;
  for _i = uint(0); _i < uint(len(_tmp134859)); _i ++ {
    _v = _tmp134859[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp161938 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp161938)); _i ++ {
    _e = _tmp161938[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp163851 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp163851)); _i ++ {
    _e = _tmp163851[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp164924 := _ast;
  for _i = uint(0); _i < uint(len(_tmp164924)); _i ++ {
    _e = _tmp164924[_i]
    _ee = _e.([]interface{})
  ...
  _tmp165309 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165309)); _i ++ {
    _e = _tmp165309[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp165694 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165694)); _i ++ {
    _e = _tmp165694[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp166627 := _ast;
  for _tmp166630 := uint(0); _tmp166630 < uint(len(_tmp166627)); _tmp166630 ++ {
    _e = _tmp166627[_tmp166630]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp168818 := _asts;
  for _i = uint(0); _i < uint(len(_tmp168818)); _i ++ {
    _e = _tmp168818[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp169272 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp169272)); _i ++ {
      _v = _tmp169272[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp170317 := _asts;
  for _tmp170320 := uint(0); _tmp170320 < uint(len(_tmp170317)); _tmp170320 ++ {
    _eo = _tmp170317[_tmp170320]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp171925 := _asts;
  for _tmp171928 := uint(0); _tmp171928 < uint(len(_tmp171925)); _tmp171928 ++ {
    _eo = _tmp171925[_tmp171928]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func main(){
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp206115 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp206118 := uint(0); _tmp206118 < uint(len(_tmp206115)); _tmp206118 ++ {
      _k = _tmp206115[_tmp206118]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp207532 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp207535 := uint(0); _tmp207535 < uint(len(_tmp207532)); _tmp207535 ++ {
      _k = _tmp207532[_tmp207535]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp214120 := _xx;
    for _tmp214123 := uint(0); _tmp214123 < uint(len((*_tmp214120))); _tmp214123 ++ {
      _v = (*_tmp214120)[_tmp214123]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp221307 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp221307))); _i ++ {
      _v = (*_tmp221307)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp237975 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp237975))); _i ++ {
        _v = (*_tmp237975)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp240039 := _c._arr;
    for _tmp240042 := uint(0); _tmp240042 < uint(len((*_tmp240039))); _tmp240042 ++ {
      _v = (*_tmp240039)[_tmp240042]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp242751 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp242751))); _i ++ {
        _v = (*_tmp242751)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp247684 := _da._arr;
      for _tmp247687 := uint(0); _tmp247687 < uint(len((*_tmp247684))); _tmp247687 ++ {
        _kc = (*_tmp247684)[_tmp247687]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
