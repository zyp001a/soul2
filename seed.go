...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp44316 := _o;
  for _tmp44319 := uint(0); _tmp44319 < uint(len((*_tmp44316))); _tmp44319 ++ {
    _e = (*_tmp44316)[_tmp44319]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp44864 := _o;
  for _i = uint(0); _i < uint(len(_tmp44864)); _i ++ {
    _e = _tmp44864[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp45797 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp45797))); _i ++ {
    _x = (*_tmp45797)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp46862 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp46865 := uint(0); _tmp46865 < uint(len(_tmp46862)); _tmp46865 ++ {
    _k = _tmp46862[_tmp46865]
    if(_o._dic[_k] == nil){
  ...
  _tmp47369 := _c._arr;
  for _tmp47372 := uint(0); _tmp47372 < uint(len((*_tmp47369))); _tmp47372 ++ {
    _v = (*_tmp47369)[_tmp47372]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp47976 := _parentarr;
    for _tmp47979 := uint(0); _tmp47979 < uint(len((*_tmp47976))); _tmp47979 ++ {
      _e = (*_tmp47976)[_tmp47979]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp51863 := _o._arr;
  for _tmp51866 := uint(0); _tmp51866 < uint(len((*_tmp51863))); _tmp51866 ++ {
    _k = (*_tmp51863)[_tmp51866]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(inClassx(classx(_f), _funcvarsc, nil)){
    ...
    _tmp52741 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp52741))); _i ++ {
      _argdef = (*_tmp52741)[_i]
    ...
    _tmp53144 := _args;
    for _tmp53147 := uint(0); _tmp53147 < uint(len((*_tmp53144))); _tmp53147 ++ {
      _arg = (*_tmp53144)[_tmp53147]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp60932 := _argtypes;
  for _tmp60935 := uint(0); _tmp60935 < uint(len((*_tmp60932))); _tmp60935 ++ {
    _v = (*_tmp60932)[_tmp60935]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp63168 := _x._arr;
  for _tmp63171 := uint(0); _tmp63171 < uint(len((*_tmp63168))); _tmp63171 ++ {
    _v = (*_tmp63168)[_tmp63171]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp64334 := _c._arr;
  for _tmp64337 := uint(0); _tmp64337 < uint(len((*_tmp64334))); _tmp64337 ++ {
    _v = (*_tmp64334)[_tmp64337]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp66442 := _types;
  for _tmp66445 := uint(0); _tmp66445 < uint(len((*_tmp66442))); _tmp66445 ++ {
    _v = (*_tmp66442)[_tmp66445]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp70008 := _arr;
    for _tmp70011 := uint(0); _tmp70011 < uint(len((*_tmp70008))); _tmp70011 ++ {
      _v = (*_tmp70008)[_tmp70011]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp73273 := _scope._arr;
  for _tmp73276 := uint(0); _tmp73276 < uint(len((*_tmp73273))); _tmp73276 ++ {
    _v = (*_tmp73273)[_tmp73276]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp75237 := _v._arr;
  for _tmp75240 := uint(0); _tmp75240 < uint(len((*_tmp75237))); _tmp75240 ++ {
    _vv = (*_tmp75237)[_tmp75240]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp76325 := _p;
  for _tmp76328 := uint(0); _tmp76328 < uint(len((*_tmp76325))); _tmp76328 ++ {
    _v = (*_tmp76325)[_tmp76328]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp79119 := _c._arr;
  for _tmp79122 := uint(0); _tmp79122 < uint(len((*_tmp79119))); _tmp79122 ++ {
    _v = (*_tmp79119)[_tmp79122]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp79842 := _o._arr;
  for _tmp79845 := uint(0); _tmp79845 < uint(len((*_tmp79842))); _tmp79845 ++ {
    _v = (*_tmp79842)[_tmp79845]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp97945 := _a;
    for _tmp97948 := uint(0); _tmp97948 < uint(len((*_tmp97945))); _tmp97948 ++ {
      _v = (*_tmp97945)[_tmp97948]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp98180 := _a;
    for _tmp98183 := uint(0); _tmp98183 < uint(len((*_tmp98180))); _tmp98183 ++ {
      _v = (*_tmp98180)[_tmp98183]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp98505 := _d;
  for _tmp98508 := uint(0); _tmp98508 < uint(len((*_tmp98505))); _tmp98508 ++ {
    _v = (*_tmp98505)[_tmp98508]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp108606 := _c._arr;
    for _tmp108609 := uint(0); _tmp108609 < uint(len((*_tmp108606))); _tmp108609 ++ {
      _v = (*_tmp108606)[_tmp108609]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp110296 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp110296))); _i ++ {
    _v = (*_tmp110296)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp117248 := _env._dic["envStack"]._arr;
  for _tmp117251 := uint(0); _tmp117251 < uint(len((*_tmp117248))); _tmp117251 ++ {
    _v = (*_tmp117248)[_tmp117251]
...
func id2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    ...
    if(_varts != nil){
      _tmp118522 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp118522))); _i ++ {
        _stro = (*_tmp118522)[_i]
        if(_id == _stro._str){
...
func idlocal2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    _varts = getx(_func, "funcVars")
    if(_varts != nil){
      _tmp121442 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp121442))); _i ++ {
        _stro = (*_tmp121442)[_i]
        if(_id == _stro._str){
          _r = idNewx(_local, _stro._str, _idargc)
          _r._int = int(_i)
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp124432 := _args;
  for _tmp124435 := uint(0); _tmp124435 < uint(len(_tmp124432)); _tmp124435 ++ {
    _arg = _tmp124432[_tmp124435]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    _arr = &[]*Cptx{}
    _tmp130251 := _parents;
    for _tmp130254 := uint(0); _tmp130254 < uint(len(_tmp130251)); _tmp130254 ++ {
      _e = _tmp130251[_tmp130254]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp134610 := _arr;
  for _i = uint(0); _i < uint(len(_tmp134610)); _i ++ {
    _v = _tmp134610[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp161671 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp161671)); _i ++ {
    _e = _tmp161671[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp163584 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp163584)); _i ++ {
    _e = _tmp163584[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp164657 := _ast;
  for _i = uint(0); _i < uint(len(_tmp164657)); _i ++ {
    _e = _tmp164657[_i]
    _ee = _e.([]interface{})
  ...
  _tmp165042 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165042)); _i ++ {
    _e = _tmp165042[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp165427 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165427)); _i ++ {
    _e = _tmp165427[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp166360 := _ast;
  for _tmp166363 := uint(0); _tmp166363 < uint(len(_tmp166360)); _tmp166363 ++ {
    _e = _tmp166360[_tmp166363]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp168551 := _asts;
  for _i = uint(0); _i < uint(len(_tmp168551)); _i ++ {
    _e = _tmp168551[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp169005 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp169005)); _i ++ {
      _v = _tmp169005[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp170050 := _asts;
  for _tmp170053 := uint(0); _tmp170053 < uint(len(_tmp170050)); _tmp170053 ++ {
    _eo = _tmp170050[_tmp170053]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp171658 := _asts;
  for _tmp171661 := uint(0); _tmp171661 < uint(len(_tmp171658)); _tmp171661 ++ {
    _eo = _tmp171658[_tmp171661]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func main(){
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp206002 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp206005 := uint(0); _tmp206005 < uint(len(_tmp206002)); _tmp206005 ++ {
      _k = _tmp206002[_tmp206005]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp207419 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp207422 := uint(0); _tmp207422 < uint(len(_tmp207419)); _tmp207422 ++ {
      _k = _tmp207419[_tmp207422]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp214007 := _xx;
    for _tmp214010 := uint(0); _tmp214010 < uint(len((*_tmp214007))); _tmp214010 ++ {
      _v = (*_tmp214007)[_tmp214010]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp221194 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp221194))); _i ++ {
      _v = (*_tmp221194)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp236801 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp236801))); _i ++ {
        _v = (*_tmp236801)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp238865 := _c._arr;
    for _tmp238868 := uint(0); _tmp238868 < uint(len((*_tmp238865))); _tmp238868 ++ {
      _v = (*_tmp238865)[_tmp238868]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp241577 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp241577))); _i ++ {
        _v = (*_tmp241577)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp246510 := _da._arr;
      for _tmp246513 := uint(0); _tmp246513 < uint(len((*_tmp246510))); _tmp246513 ++ {
        _kc = (*_tmp246510)[_tmp246513]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
