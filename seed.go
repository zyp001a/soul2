...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp44642 := _o;
  for _tmp44645 := uint(0); _tmp44645 < uint(len((*_tmp44642))); _tmp44645 ++ {
    _e = (*_tmp44642)[_tmp44645]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp45187 := _o;
  for _i = uint(0); _i < uint(len(_tmp45187)); _i ++ {
    _e = _tmp45187[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp46119 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp46119))); _i ++ {
    _x = (*_tmp46119)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp47184 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp47187 := uint(0); _tmp47187 < uint(len(_tmp47184)); _tmp47187 ++ {
    _k = _tmp47184[_tmp47187]
    if(_o._dic[_k] == nil){
  ...
  _tmp47690 := _c._arr;
  for _tmp47693 := uint(0); _tmp47693 < uint(len((*_tmp47690))); _tmp47693 ++ {
    _v = (*_tmp47690)[_tmp47693]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp48297 := _parentarr;
    for _tmp48300 := uint(0); _tmp48300 < uint(len((*_tmp48297))); _tmp48300 ++ {
      _e = (*_tmp48297)[_tmp48300]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp52183 := _o._arr;
  for _tmp52186 := uint(0); _tmp52186 < uint(len((*_tmp52183))); _tmp52186 ++ {
    _k = (*_tmp52183)[_tmp52186]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(inClassx(classx(_f), _funcvarsc, nil)){
    ...
    _tmp53061 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp53061))); _i ++ {
      _argdef = (*_tmp53061)[_i]
    ...
    _tmp53464 := _args;
    for _tmp53467 := uint(0); _tmp53467 < uint(len((*_tmp53464))); _tmp53467 ++ {
      _arg = (*_tmp53464)[_tmp53467]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp61396 := _argtypes;
  for _tmp61399 := uint(0); _tmp61399 < uint(len((*_tmp61396))); _tmp61399 ++ {
    _v = (*_tmp61396)[_tmp61399]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp63632 := _x._arr;
  for _tmp63635 := uint(0); _tmp63635 < uint(len((*_tmp63632))); _tmp63635 ++ {
    _v = (*_tmp63632)[_tmp63635]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp64798 := _c._arr;
  for _tmp64801 := uint(0); _tmp64801 < uint(len((*_tmp64798))); _tmp64801 ++ {
    _v = (*_tmp64798)[_tmp64801]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp66966 := _types;
  for _tmp66969 := uint(0); _tmp66969 < uint(len((*_tmp66966))); _tmp66969 ++ {
    _v = (*_tmp66966)[_tmp66969]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp70527 := _arr;
    for _tmp70530 := uint(0); _tmp70530 < uint(len((*_tmp70527))); _tmp70530 ++ {
      _v = (*_tmp70527)[_tmp70530]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp73860 := _scope._arr;
  for _tmp73863 := uint(0); _tmp73863 < uint(len((*_tmp73860))); _tmp73863 ++ {
    _v = (*_tmp73860)[_tmp73863]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp75824 := _v._arr;
  for _tmp75827 := uint(0); _tmp75827 < uint(len((*_tmp75824))); _tmp75827 ++ {
    _vv = (*_tmp75824)[_tmp75827]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp76912 := _p;
  for _tmp76915 := uint(0); _tmp76915 < uint(len((*_tmp76912))); _tmp76915 ++ {
    _v = (*_tmp76912)[_tmp76915]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp79706 := _c._arr;
  for _tmp79709 := uint(0); _tmp79709 < uint(len((*_tmp79706))); _tmp79709 ++ {
    _v = (*_tmp79706)[_tmp79709]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp80429 := _o._arr;
  for _tmp80432 := uint(0); _tmp80432 < uint(len((*_tmp80429))); _tmp80432 ++ {
    _v = (*_tmp80429)[_tmp80432]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp98550 := _a;
    for _tmp98553 := uint(0); _tmp98553 < uint(len((*_tmp98550))); _tmp98553 ++ {
      _v = (*_tmp98550)[_tmp98553]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp98785 := _a;
    for _tmp98788 := uint(0); _tmp98788 < uint(len((*_tmp98785))); _tmp98788 ++ {
      _v = (*_tmp98785)[_tmp98788]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp99110 := _d;
  for _tmp99113 := uint(0); _tmp99113 < uint(len((*_tmp99110))); _tmp99113 ++ {
    _v = (*_tmp99110)[_tmp99113]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp109278 := _c._arr;
    for _tmp109281 := uint(0); _tmp109281 < uint(len((*_tmp109278))); _tmp109281 ++ {
      _v = (*_tmp109278)[_tmp109281]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp110968 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp110968))); _i ++ {
    _v = (*_tmp110968)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp117919 := _env._dic["envStack"]._arr;
  for _tmp117922 := uint(0); _tmp117922 < uint(len((*_tmp117919))); _tmp117922 ++ {
    _v = (*_tmp117919)[_tmp117922]
...
func id2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    ...
    if(_varts != nil){
      _tmp119193 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp119193))); _i ++ {
        _stro = (*_tmp119193)[_i]
        if(_id == _stro._str){
...
func idlocal2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  if(_func != nil){
    _varts = getx(_func, "funcVars")
    if(_varts != nil){
      _tmp122112 := _varts._arr;
      for _i = uint(0); _i < uint(len((*_tmp122112))); _i ++ {
        _stro = (*_tmp122112)[_i]
        if(_id == _stro._str){
          _r = idNewx(_local, _stro._str, _idargc)
          _r._int = int(_i)
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp125102 := _args;
  for _tmp125105 := uint(0); _tmp125105 < uint(len(_tmp125102)); _tmp125105 ++ {
    _arg = _tmp125102[_tmp125105]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    _arr = &[]*Cptx{}
    _tmp130921 := _parents;
    for _tmp130924 := uint(0); _tmp130924 < uint(len(_tmp130921)); _tmp130924 ++ {
      _e = _tmp130921[_tmp130924]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp135280 := _arr;
  for _i = uint(0); _i < uint(len(_tmp135280)); _i ++ {
    _v = _tmp135280[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _tmp162535 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp162535)); _i ++ {
    _e = _tmp162535[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp164448 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp164448)); _i ++ {
    _e = _tmp164448[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp165521 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165521)); _i ++ {
    _e = _tmp165521[_i]
    _ee = _e.([]interface{})
  ...
  _tmp165906 := _ast;
  for _i = uint(0); _i < uint(len(_tmp165906)); _i ++ {
    _e = _tmp165906[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp166291 := _ast;
  for _i = uint(0); _i < uint(len(_tmp166291)); _i ++ {
    _e = _tmp166291[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp167224 := _ast;
  for _tmp167227 := uint(0); _tmp167227 < uint(len(_tmp167224)); _tmp167227 ++ {
    _e = _tmp167224[_tmp167227]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp169415 := _asts;
  for _i = uint(0); _i < uint(len(_tmp169415)); _i ++ {
    _e = _tmp169415[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp169869 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp169869)); _i ++ {
      _v = _tmp169869[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp170914 := _asts;
  for _tmp170917 := uint(0); _tmp170917 < uint(len(_tmp170914)); _tmp170917 ++ {
    _eo = _tmp170914[_tmp170917]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp172522 := _asts;
  for _tmp172525 := uint(0); _tmp172525 < uint(len(_tmp172522)); _tmp172525 ++ {
    _eo = _tmp172522[_tmp172525]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func main(){
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp206747 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp206750 := uint(0); _tmp206750 < uint(len(_tmp206747)); _tmp206750 ++ {
      _k = _tmp206747[_tmp206750]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp208164 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp208167 := uint(0); _tmp208167 < uint(len(_tmp208164)); _tmp208167 ++ {
      _k = _tmp208164[_tmp208167]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp214752 := _xx;
    for _tmp214755 := uint(0); _tmp214755 < uint(len((*_tmp214752))); _tmp214755 ++ {
      _v = (*_tmp214752)[_tmp214755]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp221939 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp221939))); _i ++ {
      _v = (*_tmp221939)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp238734 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp238734))); _i ++ {
        _v = (*_tmp238734)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp240798 := _c._arr;
    for _tmp240801 := uint(0); _tmp240801 < uint(len((*_tmp240798))); _tmp240801 ++ {
      _v = (*_tmp240798)[_tmp240801]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp243510 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp243510))); _i ++ {
        _v = (*_tmp243510)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp248443 := _da._arr;
      for _tmp248446 := uint(0); _tmp248446 < uint(len((*_tmp248443))); _tmp248446 ++ {
        _kc = (*_tmp248443)[_tmp248446]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
