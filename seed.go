...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp40553 := _o;
  for _tmp40560 := uint(0); _tmp40560 < uint(len((*_tmp40553))); _tmp40560 ++ {
    _e = (*_tmp40553)[_tmp40560]
    (*_n) = append((*_n), _e)
  }
  return _n
}
...
func indx(_s string, _first int) string{
  ...
  _tmp41415 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp41415))); _i ++ {
    _x = (*_tmp41415)[_i]
    if(_i != 0 && _x != ""){
      _r += "\n"
      _r += __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp43116 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp43123 := uint(0); _tmp43123 < uint(len(_tmp43116)); _tmp43123 ++ {
    _k = _tmp43116[_tmp43123]
    if(_o._dic[_k] == nil){
  ...
  _tmp43580 := _c._arr;
  for _tmp43587 := uint(0); _tmp43587 < uint(len((*_tmp43580))); _tmp43587 ++ {
    _v = (*_tmp43580)[_tmp43587]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp44190 := _parentarr;
    for _tmp44197 := uint(0); _tmp44197 < uint(len((*_tmp44190))); _tmp44197 ++ {
      _e = (*_tmp44190)[_tmp44197]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp46965 := _o._arr;
  for _tmp46972 := uint(0); _tmp46972 < uint(len((*_tmp46965))); _tmp46972 ++ {
    _k = (*_tmp46965)[_tmp46972]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    ...
    _tmp48244 := _args;
    for _tmp48251 := uint(0); _tmp48251 < uint(len((*_tmp48244))); _tmp48251 ++ {
      _arg = (*_tmp48244)[_tmp48251]
...
func prepareArgsRefx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(!inClassx(classx(_f), _functplc, nil)){
    _vartypes = getx(_f, "funcVarTypes")._arr
    _tmp48899 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp48899))); _i ++ {
      _argdef = (*_tmp48899)[_i]
      if(int(_i) < len((*_args))){
    ...
    _tmp49247 := _args;
    for _tmp49254 := uint(0); _tmp49254 < uint(len((*_tmp49247))); _tmp49254 ++ {
      _arg = (*_tmp49247)[_tmp49254]
      _x = passx(execx(_arg, _env, 0))
      (*_argsx) = append((*_argsx), _x)
    }
  }
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp56360 := _argtypes;
  for _tmp56367 := uint(0); _tmp56367 < uint(len((*_tmp56360))); _tmp56367 ++ {
    _v = (*_tmp56360)[_tmp56367]
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp58837 := _c._arr;
  for _tmp58844 := uint(0); _tmp58844 < uint(len((*_tmp58837))); _tmp58844 ++ {
    _v = (*_tmp58837)[_tmp58844]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp60170 := _types;
  for _tmp60177 := uint(0); _tmp60177 < uint(len((*_tmp60170))); _tmp60177 ++ {
    _v = (*_tmp60170)[_tmp60177]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_Path_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp63344 := _arr;
    for _tmp63351 := uint(0); _tmp63351 < uint(len((*_tmp63344))); _tmp63351 ++ {
      _v = (*_tmp63344)[_tmp63351]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp65941 := _scope._arr;
  for _tmp65948 := uint(0); _tmp65948 < uint(len((*_tmp65941))); _tmp65948 ++ {
    _v = (*_tmp65941)[_tmp65948]
...
func subMethodGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp67583 := _v._arr;
  for _tmp67590 := uint(0); _tmp67590 < uint(len((*_tmp67583))); _tmp67590 ++ {
    _vv = (*_tmp67583)[_tmp67590]
...
func methodGetx(_scope *Cptx, _func *Cptx) *Cptx{
  ...
  _p = _o._arr
  _tmp68183 := _p;
  for _tmp68190 := uint(0); _tmp68190 < uint(len((*_tmp68183))); _tmp68190 ++ {
    _v = (*_tmp68183)[_tmp68190]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp70909 := _c._arr;
  for _tmp70916 := uint(0); _tmp70916 < uint(len((*_tmp70909))); _tmp70916 ++ {
    _v = (*_tmp70909)[_tmp70916]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp71595 := _o._arr;
  for _tmp71602 := uint(0); _tmp71602 < uint(len((*_tmp71595))); _tmp71602 ++ {
    _v = (*_tmp71595)[_tmp71602]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(len((*_a)) > 1){
    _s += "\n"
    _tmp85639 := _a;
    for _tmp85646 := uint(0); _tmp85646 < uint(len((*_tmp85639))); _tmp85646 ++ {
      _v = (*_tmp85639)[_tmp85646]
      _s += indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp85849 := _a;
    for _tmp85856 := uint(0); _tmp85856 < uint(len((*_tmp85849))); _tmp85856 ++ {
      _v = (*_tmp85849)[_tmp85856]
      _s += strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp86178 := _d;
  for _tmp86185 := uint(0); _tmp86185 < uint(len((*_tmp86178))); _tmp86185 ++ {
    _v = (*_tmp86178)[_tmp86185]
    if(_v._name != ""){
      _s += _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _nstate._int = 2
  _tmp89537 := _args;
  for _i = uint(0); _i < uint(len((*_tmp89537))); _i ++ {
    _v = (*_tmp89537)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    _tmp91529 := _args;
    for _i = uint(0); _i < uint(len((*_tmp91529))); _i ++ {
      _arg = (*_tmp91529)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp93524 := _c._arr;
    for _tmp93531 := uint(0); _tmp93531 < uint(len((*_tmp93524))); _tmp93531 ++ {
      _v = (*_tmp93524)[_tmp93531]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  var _v *Cptx
  _tmp95107 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp95107))); _i ++ {
    _v = (*_tmp95107)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp101977 := _args;
  for _tmp101984 := uint(0); _tmp101984 < uint(len(_tmp101977)); _tmp101984 ++ {
    _arg = _tmp101977[_tmp101984]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    ...
    _arr = &[]*Cptx{}
    _tmp105342 := _parents;
    for _tmp105349 := uint(0); _tmp105349 < uint(len(_tmp105342)); _tmp105349 ++ {
      _e = _tmp105342[_tmp105349]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp109388 := _arr;
  for _i = uint(0); _i < uint(len(_tmp109388)); _i ++ {
    _v = _tmp109388[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp136192 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp136192)); _i ++ {
    _e = _tmp136192[_i]
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp138077 := _ast;
  for _i = uint(0); _i < uint(len(_tmp138077)); _i ++ {
    _e = _tmp138077[_i]
    _ee = _e.([]interface{})
  ...
  _tmp138425 := _ast;
  for _i = uint(0); _i < uint(len(_tmp138425)); _i ++ {
    _e = _tmp138425[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp139323 := _ast;
  for _tmp139330 := uint(0); _tmp139330 < uint(len(_tmp139323)); _tmp139330 ++ {
    _e = _tmp139323[_tmp139330]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp141258 := _asts;
  for _tmp141265 := uint(0); _tmp141265 < uint(len(_tmp141258)); _tmp141265 ++ {
    _e = _tmp141258[_tmp141265]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
    }
  ...
  if(!_callable){
    _tmp141673 := _arrx;
    for _i = uint(0); _i < uint(len((*_tmp141673))); _i ++ {
      _v = (*_tmp141673)[_i]
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp142720 := _asts;
  for _tmp142727 := uint(0); _tmp142727 < uint(len(_tmp142720)); _tmp142727 ++ {
    _eo = _tmp142720[_tmp142727]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func main(){
  ...
  funcDefx(_defmain, "osArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp152657 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp152657))); _i ++ {
        _v = (*_tmp152657)[_i]
        if(_i == 0){
          continue
        }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp173580 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp173587 := uint(0); _tmp173587 < uint(len(_tmp173580)); _tmp173587 ++ {
      _k = _tmp173580[_tmp173587]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp174101 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp174108 := uint(0); _tmp174108 < uint(len(_tmp174101)); _tmp174108 ++ {
      _k = _tmp174101[_tmp174108]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_dicc, _o._dic, _arrx)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp175646 := _xx;
    for _tmp175653 := uint(0); _tmp175653 < uint(len((*_tmp175646))); _tmp175653 ++ {
      _v = (*_tmp175646)[_tmp175653]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp183195 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp183195))); _i ++ {
      _v = (*_tmp183195)[_i]
      if(_i != 0){
        _s += _sep._str
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp200941 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp200941))); _i ++ {
        _v = (*_tmp200941)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp204684 := _da._arr;
      for _tmp204691 := uint(0); _tmp204691 < uint(len((*_tmp204684))); _tmp204691 ++ {
        _kc = (*_tmp204684)[_tmp204691]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
      ...
      _tmp205532 := _da._arr;
      for _i = uint(0); _i < uint(len((*_tmp205532))); _i ++ {
        _v = (*_tmp205532)[_i]
        if(_key != ""){
