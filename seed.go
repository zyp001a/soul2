...
func arrCopyx(_o *[]*Cptx) *[]*Cptx{
  ...
  _n = &[]*Cptx{}
  _tmp40380 := _o;
  for _tmp40383 := uint(0); _tmp40383 < uint(len((*_tmp40380))); _tmp40383 ++ {
    _e = (*_tmp40380)[_tmp40383]
    (*_n) = append((*_n), _e)
  }
  return _n
}
func byteCopyx(_o []byte) []byte{
  ...
  _tmp40875 := _o;
  for _i = uint(0); _i < uint(len(_tmp40875)); _i ++ {
    _e = _tmp40875[_i]
    _n[_i] = _e
  }
  return _n
...
func indx(_s string, _first int) string{
  ...
  _tmp41680 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp41680))); _i ++ {
    _x = (*_tmp41680)[_i]
    if(_i != 0 && _x != ""){
      _r = _r + "\n"
      _r = _r + __indentx
...
func appendClassx(_o *Cptx, _c *Cptx) {
  var _k string
  var _v *Cptx
  _tmp42608 := _Arr_Str_sort(_keys(_c._dic));
  for _tmp42611 := uint(0); _tmp42611 < uint(len(_tmp42608)); _tmp42611 ++ {
    _k = _tmp42608[_tmp42611]
    if(_o._dic[_k] == nil){
  ...
  _tmp43049 := _c._arr;
  for _tmp43052 := uint(0); _tmp43052 < uint(len((*_tmp43049))); _tmp43052 ++ {
    _v = (*_tmp43049)[_tmp43052]
    appendClassx(_o, _v)
  }
}
...
func parentMakex(_o *Cptx, _parentarr *[]*Cptx) {
  ...
  if(_parentarr != nil){
    _ctype = _o._ctype
    _tmp43580 := _parentarr;
    for _tmp43583 := uint(0); _tmp43583 < uint(len((*_tmp43580))); _tmp43583 ++ {
      _e = (*_tmp43580)[_tmp43583]
      if(_e._id == 0){
...
func valuesx(_o *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp47052 := _o._arr;
  for _tmp47055 := uint(0); _tmp47055 < uint(len((*_tmp47052))); _tmp47055 ++ {
    _k = (*_tmp47052)[_tmp47055]
    _v = _o._dic[_k._str]
    (*_arr) = append((*_arr), _v)
  }
...
func prepareArgsx(_args *[]*Cptx, _f *Cptx, _env *Cptx) *[]*Cptx{
  ...
  if(inClassx(classx(_f), _funcvarsc, nil)){
    ...
    _tmp47800 := _vartypes;
    for _i = uint(0); _i < uint(len((*_tmp47800))); _i ++ {
      _argdef = (*_tmp47800)[_i]
    ...
    _tmp48149 := _args;
    for _tmp48152 := uint(0); _tmp48152 < uint(len((*_tmp48149))); _tmp48152 ++ {
      _arg = (*_tmp48149)[_tmp48152]
...
func funcNewx(_val func(*[]*Cptx, *Cptx) *Cptx, _argtypes *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _arr = &[]*Cptx{}
  _tmp54997 := _argtypes;
  for _tmp55000 := uint(0); _tmp55000 < uint(len((*_tmp54997))); _tmp55000 ++ {
    _v = (*_tmp54997)[_tmp55000]
...
func getNamex(_x *Cptx) string{
  ...
  _tmp57000 := _x._arr;
  for _tmp57003 := uint(0); _tmp57003 < uint(len((*_tmp57000))); _tmp57003 ++ {
    _v = (*_tmp57000)[_tmp57003]
    _r = getNamex(_v)
    if(_r != ""){
      return _r
    }
...
func itemsGetBasicx(_c *Cptx) *Cptx{
  ...
  _tmp58010 := _c._arr;
  for _tmp58013 := uint(0); _tmp58013 < uint(len((*_tmp58010))); _tmp58013 ++ {
    _v = (*_tmp58010)[_tmp58013]
...
func fpDefx(_types *[]*Cptx, _return *Cptx) *Cptx{
  ...
  _n = "FuncProto"
  _tmp59835 := _types;
  for _tmp59838 := uint(0); _tmp59838 < uint(len((*_tmp59835))); _tmp59838 ++ {
    _v = (*_tmp59835)[_tmp59838]
...
func nsGetx(_ns *Cptx, _key string) *Cptx{
  ...
  if(_exists(_f)){
    ...
    _arr = _Str_split(_fc, " ")
    _tmp63083 := _arr;
    for _tmp63086 := uint(0); _tmp63086 < uint(len((*_tmp63083))); _tmp63086 ++ {
      _v = (*_tmp63083)[_tmp63086]
...
func subClassGetx(_scope *Cptx, _key string, _cache map[string]interface{}) *Cptx{
  ...
  _tmp65889 := _scope._arr;
  for _tmp65892 := uint(0); _tmp65892 < uint(len((*_tmp65889))); _tmp65892 ++ {
    _v = (*_tmp65889)[_tmp65892]
...
func subPropGetx(_scope *Cptx, _v *Cptx, _key string) *Cptx{
  ...
  _tmp67614 := _v._arr;
  for _tmp67617 := uint(0); _tmp67617 < uint(len((*_tmp67614))); _tmp67617 ++ {
    _vv = (*_tmp67614)[_tmp67617]
...
func propGetx(_scope *Cptx, _o *Cptx, _key string) *Cptx{
  ...
  _p = _o._arr
  _tmp68583 := _p;
  for _tmp68586 := uint(0); _tmp68586 < uint(len((*_tmp68583))); _tmp68586 ++ {
    _v = (*_tmp68583)[_tmp68586]
...
func inClassx(_c *Cptx, _t *Cptx, _cache map[string]interface{}) bool{
  ...
  _tmp70996 := _c._arr;
  for _tmp70999 := uint(0); _tmp70999 < uint(len((*_tmp70996))); _tmp70999 ++ {
    _v = (*_tmp70996)[_tmp70999]
    _k = strconv.FormatUint(uint64(_v._id), 10)
    if(_cache[_k] != nil){
      continue
    }
...
func parentClassGetx(_o *Cptx, _key string) *Cptx{
  ...
  _tmp71636 := _o._arr;
  for _tmp71639 := uint(0); _tmp71639 < uint(len((*_tmp71636))); _tmp71639 ++ {
    _v = (*_tmp71636)[_tmp71639]
    _d = _v._dic
    _r = _d[_key]
    if(_r != nil){
      return _v
...
func arr2strx(_a *[]*Cptx, _i int) string{
  ...
  if(uint(len((*_a))) > 1){
    _s = _s + "\n"
    _tmp86716 := _a;
    for _tmp86719 := uint(0); _tmp86719 < uint(len((*_tmp86716))); _tmp86719 ++ {
      _v = (*_tmp86716)[_tmp86719]
      _s = _s + indx(strx(_v, _i + 1), 0) + "\n"
    }
  }else{
    _tmp86919 := _a;
    for _tmp86922 := uint(0); _tmp86922 < uint(len((*_tmp86919))); _tmp86922 ++ {
      _v = (*_tmp86919)[_tmp86922]
      _s = _s + strx(_v, _i + 1)
    }
  }
  return _s
...
func parent2strx(_d *[]*Cptx) string{
  ...
  _s = ""
  _tmp87207 := _d;
  for _tmp87210 := uint(0); _tmp87210 < uint(len((*_tmp87207))); _tmp87210 ++ {
    _v = (*_tmp87207)[_tmp87210]
    if(_v._name != ""){
      _s = _s + _v._name + " "
    }else{
...
func tplCallx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  _tmp90549 := _args;
  for _i = uint(0); _i < uint(len((*_tmp90549))); _i ++ {
    _v = (*_tmp90549)[_i]
...
func callx(_func *Cptx, _args *[]*Cptx, _env *Cptx) *Cptx{
  ...
  if(inClassx(_func._obj, _funcblockc, nil)){
    ...
    if(inClassx(_func._obj, _handlerc, nil)){
      _tmp93368 := _args;
      for _i = uint(0); _i < uint(len((*_tmp93368))); _i ++ {
        _arg = (*_tmp93368)[_i]
      ...
      _tmp93562 := _args;
      for _i = uint(0); _i < uint(len((*_tmp93562))); _i ++ {
        _arg = (*_tmp93562)[_i]
...
func classExecGetx(_c *Cptx, _execsp *Cptx, _cache map[string]interface{}) *Cptx{
  ...
  if(_c._arr != nil){
    _tmp96147 := _c._arr;
    for _tmp96150 := uint(0); _tmp96150 < uint(len((*_tmp96147))); _tmp96150 ++ {
      _v = (*_tmp96147)[_tmp96150]
      _k = strconv.FormatUint(uint64(_v._id), 10)
      if(_cache[_k] != nil){
        return nil
      }
...
func subBlockExecx(_arr *[]*Cptx, _env *Cptx, _stt uint) *Cptx{
  ...
  _tmp97646 := _arr;
  for _i = uint(0); _i < uint(len((*_tmp97646))); _i ++ {
    _v = (*_tmp97646)[_i]
    if(_stt != 0 && _stt < _i){
      continue
    }
...
func diex(_str string, _env *Cptx) {
  var _l *Cptx
  var _v *Cptx
  _tmp103653 := _env._dic["envStack"]._arr;
  for _tmp103656 := uint(0); _tmp103656 < uint(len((*_tmp103653))); _tmp103656 ++ {
    _v = (*_tmp103653)[_tmp103656]
...
func subFunc2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _isproto int) *Cptx{
  ...
  _tmp108464 := _args;
  for _tmp108467 := uint(0); _tmp108467 < uint(len(_tmp108464)); _tmp108467 ++ {
    _arg = _tmp108464[_tmp108467]
...
func class2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _name string, _pre int) *Cptx{
  ...
  if(_pre == 1 || _pre == 0){
    _arr = &[]*Cptx{}
    _tmp115085 := _parents;
    for _tmp115088 := uint(0); _tmp115088 < uint(len(_tmp115085)); _tmp115088 ++ {
      _e = _tmp115085[_tmp115088]
      _s = _e.(string)
...
func enum2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _name string) *Cptx{
  ...
  _tmp118902 := _arr;
  for _i = uint(0); _i < uint(len(_tmp118902)); _i ++ {
    _v = _tmp118902[_i]
...
func call2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx = &[]*Cptx{}
  _tmp142766 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp142766)); _i ++ {
    _e = _tmp142766[_i]
...
func callmethod2cptx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _arrx[0] = _oo
  _tmp144422 := _astarr;
  for _i = uint(0); _i < uint(len(_tmp144422)); _i ++ {
    _e = _tmp144422[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_vt != nil){
...
func preAst2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) {
  ...
  var _idpre string
  _tmp145381 := _ast;
  for _i = uint(0); _i < uint(len(_tmp145381)); _i ++ {
    _e = _tmp145381[_i]
    _ee = _e.([]interface{})
  ...
  _tmp145705 := _ast;
  for _i = uint(0); _i < uint(len(_tmp145705)); _i ++ {
    _e = _tmp145705[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
  ...
  _tmp146029 := _ast;
  for _i = uint(0); _i < uint(len(_tmp146029)); _i ++ {
    _e = _tmp146029[_i]
    _ee = _e.([]interface{})
    _eee = _ee[0].([]interface{})
    _idpre = _eee[0].(string)
...
func ast2blockx(_ast []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _block *Cptx) *Cptx{
  ...
  _i = 0
  _tmp146855 := _ast;
  for _tmp146858 := uint(0); _tmp146858 < uint(len(_tmp146855)); _tmp146858 ++ {
    _e = _tmp146855[_tmp146858]
    _ee = _e.([]interface{})
...
func ast2arrx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp148751 := _asts;
  for _i = uint(0); _i < uint(len(_tmp148751)); _i ++ {
    _e = _tmp148751[_i]
    _ee = ast2cptx(_e.([]interface{}), _def, _local, _func, "")
    if(_ee._fmid){
      _callable = true
  ...
  if(!_callable){
    _tmp149137 := _arrx;
    for _i = uint(0); _i < uint(len(_tmp149137)); _i ++ {
      _v = _tmp149137[_i]
      if(_v != nil){
...
func ast2dicx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx, _it *Cptx, _il int) *Cptx{
  ...
  _callable = false
  _tmp150086 := _asts;
  for _tmp150089 := uint(0); _tmp150089 < uint(len(_tmp150086)); _tmp150089 ++ {
    _eo = _tmp150086[_tmp150089]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
...
func ast2jsonx(_asts []interface{}, _def *Cptx, _local *Cptx, _func *Cptx) *Cptx{
  ...
  _callable = false
  _tmp151508 := _asts;
  for _tmp151511 := uint(0); _tmp151511 < uint(len(_tmp151508)); _tmp151511 ++ {
    _eo = _tmp151508[_tmp151511]
    _e = _eo.([]interface{})
    _k = _e[1].(string)
    _vv = _e[0].([]interface{})
    _key = _vv[0].(string)
...
func main(){
  ...
  methodDefx(_classc, "schema", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp181151 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp181154 := uint(0); _tmp181154 < uint(len(_tmp181151)); _tmp181154 ++ {
      _k = _tmp181151[_tmp181154]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
  ...
  methodDefx(_objc, "toDic", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _o = (*_x)[0]
    _arrx = &[]*Cptx{}
    _tmp182396 := _Arr_Str_sort(_keys(_o._dic));
    for _tmp182399 := uint(0); _tmp182399 < uint(len(_tmp182396)); _tmp182399 ++ {
      _k = _tmp182396[_tmp182399]
      (*_arrx) = append((*_arrx), strNewx(_k, nil))
    }
    return dicNewx(_o._dic, _arrx, nil)
  }, nil, _dicc)
  ...
  methodDefx(_strc, "split", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _y = &[]*Cptx{}
    _tmp188166 := _xx;
    for _tmp188169 := uint(0); _tmp188169 < uint(len((*_tmp188166))); _tmp188169 ++ {
      _v = (*_tmp188166)[_tmp188169]
  ...
  methodDefx(_arrstrc, "join", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _s = ""
    _tmp194461 := _o._arr;
    for _i = uint(0); _i < uint(len((*_tmp194461))); _i ++ {
      _v = (*_tmp194461)[_i]
      if(_i != 0){
        _s = _s + _sep._str
      }
  ...
  methodDefx(_soulc, "getCmdArgs", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(__osArgs == nil){
      ...
      _aa = &os.Args
      _tmp207509 := _aa;
      for _i = uint(0); _i < uint(len((*_tmp207509))); _i ++ {
        _v = (*_tmp207509)[_i]
        if(_i == 0){
          continue
        }
  ...
  execDefx("Arr_Call", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    _c = (*_x)[0]
    _tmp209312 := _c._arr;
    for _tmp209315 := uint(0); _tmp209315 < uint(len((*_tmp209312))); _tmp209315 ++ {
      _v = (*_tmp209312)[_tmp209315]
      _r = execx(_v, _env, 0)
      if(inClassx(classx(_r), _signalc, nil)){
        return _r
      }
  ...
  execDefx("Arr", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(inClassx(classx(_o), _midc, nil)){
      ...
      _a = &[]*Cptx{}
      _tmp211726 := _o._arr;
      for _i = uint(0); _i < uint(len((*_tmp211726))); _i ++ {
        _v = (*_tmp211726)[_i]
  ...
  execDefx("CtrlEach", func(_x *[]*Cptx, _env *Cptx) *Cptx{
    ...
    if(_da._type == TDIC){
      _tmp216019 := _da._arr;
      for _tmp216022 := uint(0); _tmp216022 < uint(len((*_tmp216019))); _tmp216022 ++ {
        _kc = (*_tmp216019)[_tmp216022]
        _k = _kc._str
        _v = _da._dic[_k]
        if(_key != ""){
